...
<body>
    ...
    <div class="header">
        <div class="header-text-box">
             <h2 class="header-text">Custom Field Data</h2>
        </div>
    ...
    <div class="container my-5 rounded">
        ...
        <table class="table  table-striped table-hover overflow-hidden rounded-3   ">
            <thead class="table-dark">
                <tr >
                
                    <th style="width:9%">Lead Id</th>
                    <th style="width:9%">Ph. Number</th>
                    <th style="width:9%">Quotozone</th>
                    <th style="width:9%">User Contact</th>
                ...
                <tr class="hide-row" style="display:none;">
                    <td colspan="10" style="padding:10px;" >
                        <table class="table table-success table-striped  my-0">
                            <tr>
                                <td class="table-danger">Vehicle model</td>
                                <td class="table-info"><?php echo $vehicle_model ?></td>
