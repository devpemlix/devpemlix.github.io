...
echo "<TABLE class='col_table' CELLSPACING=3 class='block-flat spacer' valign='TOP'><TR><TD VALIGN=TOP class='size no-border col-lg-2'> <div class='col-lg-12 size no-padding'>"._QXZ("Dates").":</div><BR>";
...
echo "<INPUT TYPE=HIDDEN NAME=print_calls VALUE=\"$print_calls\"></div>\n";
echo "<div class='col-lg-12 no-padding'><div class='col-lg-8 no-padding'><INPUT TYPE=TEXT NAME=query_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$query_date\"></div><div class='col-md-1'>";
...
echo "</div></div></br>";
echo "</br><div class='col-lg-12 size no-padding'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"._QXZ("to")."</div></br>";
echo "<div class='col-lg-12 no-padding'><div class='col-lg-8 no-padding'><INPUT TYPE=TEXT NAME=end_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$end_date\"></div><div class='col-md-1 '>";
...
echo "</div></div></TD><TD class='no-border size col-lg-2' valign='TOP'><div class='col-lg-10 size no-padding'> "._QXZ("Campaigns").":</div><BR>";
echo "<div class='col-lg-10  no-padding'><SELECT multiple SIZE=5 class=form-control NAME=group[] id='group' $JS_events>\n";
if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
echo "</SELECT></div>\n";
echo "</TD><TD class='col-lg-3' valign='TOP'><div class='col-lg-10 size no-padding'>";
echo _QXZ("Lists").": <font size=1>("._QXZ("optional, possibly slow").")</font></div>\n";
echo "<div class='col-lg-10 no-padding'>$list_options</div>";
echo "</TD><td class='col-lg-2 no-border no-padding' valign=top>";
echo "<div class='col-lg-12 no-padding size spacer'>"._QXZ("Include Drop")." &nbsp; "._QXZ("Rollover").":</div>";
echo "<div class='col-lg-10 no-padding'><SELECT SIZE=1 class=form-control NAME=include_rollover>\n";
...
echo "</SELECT></div>\n";
echo "<br/><div class='col-lg-12 no-padding size'>"._QXZ("Bottom Graph").":</div>";
echo "<div class='col-lg-10 no-padding'><SELECT SIZE=1 class=form-control NAME=bottom_graph>\n";
...
if ($carrier_logging_active > 0)
	{
	echo "</TD><TD valign=top class='col-lg-1 no-border no-padding'><div class='col-lg-12 no-padding size spacer'>"._QXZ("Carrier Stats").":</div>";
	echo "<div class='col-lg-10 no-padding'><SELECT SIZE=1 class=form-control NAME=carrier_stats>\n";
...
echo "<div class='col-lg-12 no-padding size'>"._QXZ("Display as").":</div>";
echo "<div class='col-lg-10 no-padding'><select name='report_display_type' class='form-control'>";
if ($report_display_type) 
{
	echo "<option value='$report_display_type' selected>$report_display_type</option>";
}
echo "<option value='TEXT'>TEXT</option><option value='HTML'>HTML</option></select></div>\n<BR>";
echo "<div class='col-lg-12 no-padding size'>"._QXZ("Shift").":</div>";
echo "<div class='col-lg-10 no-padding'><SELECT SIZE=1 NAME=shift class='form-control'>\n";
...
if (strlen($group[0]) > 1)
	{
	echo "<div class='col-lg-10 no-padding'> <a href=\"./admin.php?ADD=34&campaign_id=$group[0]\">"._QXZ("MODIFY")."</a> | \n";
	echo " <a href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a> </FONT></div>\n";
	}
else
	{
	echo " <div class='col-lg-4 no-padding'><a href=\"./admin.php?ADD=10\">"._QXZ("CAMPAIGNS")."</a>&nbsp;|&nbsp;<a href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a> </FONT></div> \n";
	
	}
echo "</div></td></tr><tr class='no-border'><td class='no-border' colspan=7 align=center><p style='text-align:center;'><INPUT class='btn btn-bdr-sucess' type=submit NAME=SUBMIT VALUE=SUBMIT class='btn btn-success'>\n";
echo "</TD></TR></TABLE>";
echo "</FORM>\n\n";
...
if (strlen($group[0]) < 1)
	...
	######## GRAPHING #########
	$GRAPH="<BR><BR><table border='0' cellpadding='0' cellspacing='2' width='800'>";
