...
$MAIN.="<TABLE class='table1 col_table' BORDER=0 cellspacing=5 cellpadding=5 class='col-lg-12 spacer'><TR><TD VALIGN=TOP align=center class='no-border col-lg-3 spacer'>\n";
$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">";
$MAIN.="<div class='col-lg-2 size'>"._QXZ("Date").":</div>";
$MAIN.="<div class='col-lg-7'><INPUT TYPE=TEXT NAME=query_date SIZE=10 class='form-control' MAXLENGTH=10 VALUE=\"$query_date\">";
...
$MAIN.="<TD VALIGN=TOP align=center class='no-border col-lg-3 spacer'><div class='col-lg-5 no-padding'><INPUT TYPE=TEXT class='form-control' NAME=query_date_D SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_D\"></div>";

$MAIN.="<div class='col-md-1 no-padding size'> "._QXZ("to")."</div><div class='col-lg-5 no-padding'> <INPUT TYPE=TEXT NAME=query_date_T SIZE=9 class='form-control' MAXLENGTH=8 VALUE=\"$query_date_T\"></div>";

$MAIN.="</TD><TD VALIGN=middle align=center class='no-border size'>\n";
$MAIN.="<div class='col-lg-3 size'>"._QXZ("Display as").":</div>";
$MAIN.="<div class='col-lg-4'><select name='report_display_type' class='form-control'>";
