...
if ($did > 0)
	{$MAIN.=_QXZ("DID Call Stats for")." $user";}
else
	{$MAIN.=_QXZ("User Stats for")." $user";}
...
//$MAIN.="</TD><TD ><FONT FACE=\"ARIAL,HELVETICA\" SIZE=2> &nbsp; </TD></TR>\n";

$MAIN.="<TR ><TD ALIGN=LEFT COLSPAN=2><FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2><B> &nbsp; \n";
...
$MAIN.="<div class='col-md-2 '><input class='form-control' type=text name=begin_date value=\"$begin_date\" size=10 maxsize=10></div><div class='col-sm-1 spacer'>";
...
$MAIN.="</div><div class='col-sm-1' style='margin-top:9px;'> "._QXZ("to")."</div> <div class='col-md-2'> <input class=\"form-control\" type=text name=end_date value=\"$end_date\" size=20 maxsize=20></div><div class='col-sm-1 spacer'>";
...
if (strlen($user)>1)
	...
	{$MAIN.="<div class='col-md-2'><input class='form-control' type=text name=user size=12 maxlength=10></div>\n";}
$MAIN.="<input class=\"btn btn-bdr-sucess\" type=submit name=submit value='"._QXZ("Submit")."'>\n";
...
if ($pause_code_rpt >= 1)
	...
	if ($did < 1)
		...
		$MAIN.="<center><TABLE class='hover centerline' width=300 cellspacing=0 cellpadding=1>\n";
		...
		while ($o < $p)
			...
			$MAIN.="<td > $counts[$o]</td>\n";
			$MAIN.="<td > $call_hours_minutes</td></tr>\n";
		...
		$MAIN.="<TABLE class='hover centerline' width=550 cellspacing=0 cellpadding=1>\n";
		...
		$MAIN.="<TABLE class='hover centerline' width=670 cellspacing=0 cellpadding=1>\n";
		...
		$MAIN.="<TABLE class='hover centerline' width=700 cellspacing=0 cellpadding=1>\n";
		...
		if ($allow_emails>0) 
			...
			$MAIN.="<TABLE class='hover centerline' width=670 cellspacing=0 cellpadding=3>\n";
	...
	$MAIN.="<TABLE class='hover centerline' width=750 cellspacing=0 cellpadding=1>\n";
	if ($firstlastname_display_user_stats > 0)
		{
	...
	if ($did < 1)
		...
		$MAIN.="<TABLE class='hover centerline' width=750 cellspacing=0 cellpadding=1>\n";
		//$MAIN.="<tr><td colspan=2> &nbsp; </td><td colspan=6 align=center bgcolor=white>"._QXZ("these fields are in seconds")." </td><td colspan=4> &nbsp; </td></tr>\n";
		$MAIN.="<thead><tr><th># </th><th>"._QXZ("DATE/TIME")." </th><th>"._QXZ("PAUSE")."</th><th> "._QXZ("WAIT")."</th><th> "._QXZ("TALK")."</th><th> "._QXZ("DISPO")."</th><th> "._QXZ("DEAD")."</th><th> "._QXZ("CUSTOMER")."</th><th> "._QXZ("STATUS")."</th><th> "._QXZ("LEAD")."</th><th> "._QXZ("CAMPAIGN")."</th><th> "._QXZ("PAUSE CODE")."</th></tr></thead>\n";
		...
		while ($logs_to_print > $u) 
			...
			$MAIN.="<td > $campaign_id </td>\n";
			$MAIN.="<td > $pause_code </td></tr>\n";
	...
	$MAIN.="<TABLE class='hover centerline' width=750 cellspacing=0 cellpadding=1>\n";
	$MAIN.="<thead><tr><th># </th><th> "._QXZ("LEAD")."</th><th>"._QXZ("DATE/TIME")." </th><th>"._QXZ("SECONDS")." </th><th> &nbsp; "._QXZ("RECID")."</th><th>"._QXZ("FILENAME")."</th><th>"._QXZ("LOCATION")." &nbsp; </th></tr></thead>\n";
