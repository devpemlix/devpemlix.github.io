...
$MAIN.="<div class='col-lg-12'><div class='col-lg-4 no-padding'><INPUT TYPE=TEXT NAME=query_date class='form-control' SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\">";

$MAIN.="</div><div class='col-md-2 no-padding'><script language=\"JavaScript\">\n";
...
$MAIN.=" &nbsp;"._QXZ("to")."</div><div class='col-lg-4 no-padding'> <INPUT TYPE=TEXT class='form-control' NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div>";
...
$MAIN.="</div></TD><TD VALIGN=TOP class='col-lg-3 no-border size'>"._QXZ("Email groups").":<BR>\n";
...
$MAIN.="</SELECT>\n";
$MAIN.="</FONT></TD>";
$MAIN.="<TD class='no-border size' VALIGN=TOP>";
$MAIN.=""._QXZ("Select date criteria").":&nbsp;<BR>";
...
$MAIN.="<input type='radio' class='ace' name='date_type' value='email_date' $emailed><label class='lbl'>"._QXZ("Date email received")."</label><BR>\n";
$MAIN.="<input type='radio' class='ace' name='date_type' value='call_date' $called><label class='lbl'>"._QXZ("Date email viewed")."</label><BR>\n";
$MAIN.="<input type='radio' class='ace' name='date_type' value='date_answered' $answrd><label class='lbl'>"._QXZ("Date email answered")."</label><BR>\n";
$MAIN.="</FONT></TD><TD class='no-border size' VALIGN=TOP>\n";
$MAIN.=""._QXZ("Select report type to display").":&nbsp;<BR>";
...
$MAIN.="<input type='radio' class='ace' name='email_type' value='received' $rcvd><label class='lbl'>"._QXZ("Emails received")."</label><BR>\n";
$MAIN.="<input type='radio' class='ace' name='email_type' value='viewed' $view><label class='lbl'>"._QXZ("Emails viewed")."</label><BR>\n";
$MAIN.="<input type='radio' class='ace' name='email_type' value='answered' $answ><label class='lbl'>"._QXZ("Emails answered")."</label><BR>\n";
$MAIN.="</FONT></TD></TR>";
...
if ($DID!='Y')
	{
	$MAIN.="<br><a href=\"./admin.php?ADD=3111&group_id=$group[0]\">"._QXZ("MODIFY")."</a> | ";
...
$MAIN.="<tr><td align='center' colspan='4'>";
