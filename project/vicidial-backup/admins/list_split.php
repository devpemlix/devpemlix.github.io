...
if ($submit == "submit" )
	...
	echo "<input CLASS='btn btn-bdr-sucess' type=submit name=confirm value=confirm>\n";
	echo "</form></center>\n";
	echo "<p><a href='$PHP_SELF'>"._QXZ("Click here to start over.")."</a></p>\n";
	echo "</body>\n</html>\n";
...
if (($submit != "submit" ) && ($confirm != "confirm"))
	...
	echo "<tr><td colspan=2 align=center><font><b>"._QXZ("List Split")."</b></font></td></tr>\n";
	...
	# Submit
	echo "<tr><td colspan=2 align=center><input class='btn btn-bdr-sucess' type=submit name=submit value=submit></td></tr>\n";
	echo "</table></center>\n";
	echo "</form>\n";
