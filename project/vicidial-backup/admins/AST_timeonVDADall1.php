...
##### NOT INBOUND ONLY ###
	...
	echo "<div class='table_name' ALIGN=RIGHT><B>"._QXZ("Gear Level")." :</B><TD class='table_data' ALIGN=LEFT>&nbsp;&nbsp; $DIALlev&nbsp; &nbsp;</div>";
	echo "<div class='table_name' ALIGN=RIGHT><B>"._QXZ("Leads Available")." :</B><TD class='table_data' ALIGN=LEFT>&nbsp;&nbsp;$DAleads &nbsp; &nbsp; </div>";
	echo "<div class='table_name' ALIGN=RIGHT><B>"._QXZ("Dropped %")." :</B><TD class='table_data' ALIGN=LEFT>&nbsp;&nbsp;$drpctTODAY% &nbsp;&nbsp;</div>";
	echo "<div class='table_name' ALIGN=RIGHT><B>"._QXZ("Hopper")." <font size=1>( "._QXZ()." )</font> :</B><TD class='table_data' ALIGN=LEFT>&nbsp;&nbsp; $HOPlev / $AHOPlev &nbsp; &nbsp; </div>";
...
if ($realtime_block_user_info > 0)
    ...
    <div class='head-data'>STATUS PAUSE</div>
    <div class='head-data'>MM:SS</div>
    <div class='head-data'>CAMPAIGN</div>
    <div class='head-data'>CALLS</div>
    <div class='head-data'><?= $product ?></div>
...
#				{$G='<SPAN class="orange"><B>'; $EG='</B></SPAN>';}
		...
		#	$Aecho .= "<div class='realtime-record'> $G$extension$EG$Aring_note[$i]|$phoneD<a href=\"./user_status.php?user=$Luser\" target=\"_blank\">$G$user$EG</a> <a href=\"javascript:ingroup_info('$Luser','$j');\">+</a> |$UGD $G$sessionid$EG$L$R | $G"._QXZ("$status",6)."$EG $CM $pausecode|$CP$SVD$G$call_time_MS$EG | $G$campaign_id$EG | $G$calls_today$EG |$INGRP\n</div>";
			...
			$Aecho .= "<div class='realtime-record'><div class='realtime-record-box'> $G$extension$EG$Aring_note[$i]</div><div class='realtime-record-box-user'><a href=\"./user_status.php?user=$Luser\" target=\"_blank\">$G$user$EG</a></div><div class='realtime-record-box'> $UGD $G$sessionid$EG$L$R</div><div class='realtime-record-box'>  $G"._QXZ("$status",6)."$EG $CM $pausecode</div><div class='realtime-record-box'> $CP$SVD$G$call_time_MS$EG</div><div class='realtime-record-box'> $G$campaign_id$EG</div> <div class='realtime-record-box'> $G$calls_today$EG</div> <div class='realtime-record-box'>$INGRP</div>\n</div>";
	...
	/*	$Aecho .= "  <SPAN class=\"orange\"><B>          </SPAN> - "._QXZ("Balanced call")."</B>\n";
		...
		echo "$Cecho";
		echo "$Aecho";
		echo "<div id='cr7' style='width:100%;max-width:300px; height:400px;border:1px solid black;'>hello</div>";
