...
$HTML_text.="<div id=\"pcont\" class=\"container-fluid\">
		<div class=\"cl-mcont\">
        <div class=\"row\">
		<div class=\"col-md-12 no-padding\"><div class=\"block-flat\"><div class='header'><h3>"._QXZ("$report_name")."</h3></div><br><br><br>";
...
$HTML_text.="<TABLE class='col_table' CELLSPACING=3><TR><TD class='col-lg-1' VALIGN=TOP> "._QXZ("Dates").":<BR>";
$HTML_text.="<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
$HTML_text.="<div class='col-lg-8 no-padding'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"></div><div class='col-lg-2'>";
...
$HTML_text.="<BR> <div class='col-lg-12'>"._QXZ("to")." </div><BR><div class='col-lg-8 no-padding'><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div><div class='col-lg-2'>";
...
$HTML_text.="</TD><TD class='col-lg-1' VALIGN=TOP> "._QXZ("Campaigns").":<BR>";
...
$HTML_text.="<TD class='col-lg-1' VALIGN=TOP>"._QXZ("Inbound Groups").":<BR>";
$HTML_text.="<SELECT class='form-control' SIZE=5 NAME=inbound_group[] multiple>\n";
...
$HTML_text.="<TD class='col-lg-1' VALIGN=TOP>"._QXZ("User Groups").":<BR>";
...
$HTML_text.="</SELECT>\n";
$HTML_text.="</TD><TD class='col-lg-1' VALIGN=TOP>"._QXZ("Users").": <BR>";
...
$HTML_text.="</SELECT>\n";
$HTML_text.="</TD>\n";
$HTML_text.="<TD class='col-lg-1' VALIGN=TOP>";
$HTML_text.=_QXZ("Chat text").":<BR>";
$HTML_text.="<textarea class='form-control' name='text_search' rows='3' cols='20'>$text_search</textarea><BR>";

$HTML_text.="</TD><TD class='col-lg-1' VALIGN=TOP> &nbsp; &nbsp; &nbsp; &nbsp; ";
$HTML_text.=_QXZ("Chat type").": <BR>";
$HTML_text.="<SELECT class='form-control' NAME='chat_log_type'>\n";
if ($chat_log_type) {
...
$HTML_text.="<p style='text-align:center'><INPUT class='btn btn-bdr-sucess' TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'><!--$NWB#agent_performance_detail$NWE--></p>";
