...
//$HTML_text.="<TABLE CELLPADDING=4 CELLSPACING=0><TR><TD class='no-border'>";
...
$HTML_text.="<TR class='no-border col-lg-12' style=''><TD class='no-border col-lg-1'>&nbsp;<BR>";
$HTML_text.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
$HTML_text.="<INPUT TYPE=HIDDEN NAME=type VALUE=\"$type\">\n";
$HTML_text.="</TD><TD class='no-border size col-lg-3'>"._QXZ("Teams/User Groups").":<BR>";
...
$HTML_text.="<TD class='no-border col-lg-1'>\n";
...
$HTML_text.="</TD><TD class='no-border col-lg-3'> &nbsp; &nbsp; &nbsp; &nbsp; ";
...
$HTML_text.="</FORM></tr></td><tr class='no-border'><td class='no-border'><pre class='pretag'><div style='width:140%;'>";
