...
if ($move_submit == "move" )
	...
	if ( $to_list_lead_count + $move_lead_count > $list_lead_limit )
		...
		echo "<input class='btn btn-bdr-sucess' type=submit name=confirm_move value=confirm>\n";
		echo "</form></center>\n";
				echo "<p><a href='$PHP_SELF'>"._QXZ("Click here to start over").".</a></p>\n";
		echo "</body>\n</html>\n";
		}
...
if ($update_submit == "update" )
	...
	echo "<input class='btn btn-bdr-sucess' type=submit name=confirm_update value=confirm>\n";
	echo "</form></center>\n";
	echo "<p><a href='$PHP_SELF'>"._QXZ("Click here to start over").".</a></p>\n";
	echo "</body>\n</html>\n";
