...
$MAIN.='<div id="pcont" class="container-fluid">
		...
		<div class="header" style="1px solid #5BC0DE;"><h3>'._QXZ("$report_name").'</h3></div>
...
$MAIN.="<div id='cl-wrapper' class='sb-collapsed' style='position:relative;margin-bottom:10px;'>";

$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report style='padding-top:10px;'>\n";
$MAIN.="<div class='col-lg-1 no-padding spacer'><INPUT TYPE=TEXT NAME=query_date SIZE=10  MAXLENGTH=10 class=form-control VALUE=\"$query_date\"></div><div class='col-lg-1  spacer' >";
...
$MAIN.=_QXZ("to")."</div><div class='col-lg-1 no-padding spacer'>  <INPUT TYPE=TEXT NAME=end_date SIZE=10 style='width:107px !important;' class=form-control MAXLENGTH=10 VALUE=\"$end_date\"></div><div class='col-lg-1 spacer'>";
...
$MAIN.="<div class='col-lg-1 no-padding spacer'><SELECT SIZE=1 NAME=group class=form-control>\n";
	$o=0;
...
$MAIN.="</SELECT></div>\n";
$MAIN.="&nbsp;";
$MAIN.="<div class='col-lg-2 spacer' style=''><select name='report_display_type' class=form-control size=1>";
if ($report_display_type) {$MAIN.="<option value='$report_display_type' selected>$report_display_type</option>";}
$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select>\n";
$MAIN.=" &nbsp;</div><div class='col-lg-1 spacer'> ";
...
$MAIN.="</SELECT></div>";
$MAIN.=" <div class='col-lg-1 spacer'><INPUT TYPE=submit align=center NAME=SUBMIT class='btn btn-bdr-sucess' VALUE=SUBMIT></div>";
$MAIN.=" <div class='col-lg-3 spacer'><a href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date&group=$group&shift=$shift&SUBMIT=$SUBMIT&file_download=1\">"._QXZ("DOWNLOAD")."</a> | <a href=\"./admin.php?ADD=3111&group_id=$group\">"._QXZ("MODIFY")."</a> | <a href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a>";
$MAIN.="&nbsp;";
...
$GRAPH="<BR><BR><p name='inbound_graph'/><table border='0' cellpadding='0' cellspacing='2' width='800' style='font-size:12px'>";
...
$max_calls=1;
$graph_stats=array();
$GRAPH="<BR><BR><p name='holdcalldropgraph'/><table border='0' cellpadding='0' cellspacing='2' width='800'>";
