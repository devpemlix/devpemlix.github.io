...
if ($file_download < 1)
	...
	echo "<div class='header' style='border-bottom:1px solid #5BC0DE;'><h3> "._QXZ("$report_name")."</h3></div>";	
	echo '<div class="col-md-12"><div class="content">';
	
	echo "<span class=col-md-12  id=agent_status_stats>\n";
	//echo "<PRE class=''>";
	}
...
echo "</pre><FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";



echo "<TABLE CELLSPACING=3 class='col-lg-12 spacer'><TR  class='no-border' style=''><TD class='col-lg-3 no-border size' valign=top><div class='col-lg-12' valign=top> "._QXZ("Dates").":</div>";
echo "<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
echo "<div class='col-lg-12'><div class='col-lg-7 no-padding'><INPUT TYPE=TEXT NAME=query_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$query_date\"></div><div class='col-lg-1 no-padding'>";
...
<?php
echo "</div></div><div class='col-lg-12'><div class='col-sm-6' align='center'> "._QXZ("to")."  </div></div><div class='col-lg-12'><div class='col-lg-7 no-padding'><INPUT TYPE=TEXT NAME=end_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$end_date\"></div><div class='col-lg-1 no-padding'>";
...
<?php
echo "</div></div></TD><TD  class='no-border size' valign=top>"._QXZ("Campaigns").":<BR>";
echo "<SELECT SIZE=5 class=form-control NAME=group[] multiple>\n";
if  (preg_match('/--ALL--/',$group_string))
...
echo "</SELECT>\n";
echo "</TD><TD  class='no-border size' valign=top>"._QXZ("User Groups").":<BR>";
echo "<SELECT SIZE=5 class=form-control NAME=user_group[] multiple>\n";
...
echo "</SELECT>\n";
echo "</TD><TD class='no-border spacer size'>"._QXZ("Shift").":<BR>";
...
echo "</SELECT><BR>\n";
echo "<input class='ace' type='checkbox' name='show_parks' value='checked' $show_parks><label class='lbl'>"._QXZ("Show parks-holds")."</label><BR>";
echo "<input class='ace' type='checkbox' name='time_in_sec' value='checked' $time_in_sec><label class='lbl'>"._QXZ("Time in seconds")."</label><BR>";

echo "</TD><TD class='no-border spacer size' valign=\"top\"> ";
echo _QXZ("Display as").":<BR>";
echo "<div class='col-lg-8 no-padding'><select name='report_display_type' class=form-control>";
if ($report_display_type) {echo "<option value='$report_display_type' selected>$report_display_type</option>";}

echo "<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select></div>\n<BR><BR>";
echo " <a href=\"$LINKbase&stage=$stage&file_download=1\">"._QXZ("DOWNLOAD")."</a> | \n";
echo " <a href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a> </FONT>\n";
echo "</TD></TR><tr><td class='no-border' align=center colspan=5><INPUT TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'  class='btn btn-BDR-sucess'><!--$NWB#agent_time_detail$NWE-->\n";
echo "";
echo "</TD></TR></TABLE>";
echo "</FORM>";
echo "&nbsp;<pre class='pretag'><div style='width:130%;'>$db_source";
...
echo "</span>\n";
echo "<span id=agent_status_bars>\n";
