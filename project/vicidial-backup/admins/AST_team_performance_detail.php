...
$HTML_text.="<div class='header'><h3> "._QXZ("$report_name")."</h3></div>";
$HTML_text.="<TABLE class='no-border' CELLPADDING=4 CELLSPACING=0><TR><TD>";

$HTML_text.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";


$HTML_text.="<TABLE CELLSPACING=3 class='col-lg-12 spacer'>";
//$HTML_text.="<b>"._QXZ("$report_name")."</b> $NWB#team_performance_detail$NWE\n";
$HTML_text.="<TR class='no-border' style=''><TD class='col-lg-4 no-border size'><div class='col-lg-12'> </div>";
$HTML_text.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
$HTML_text.="<INPUT TYPE=HIDDEN NAME=type VALUE=\"$type\">\n";
$HTML_text.="<div class='col-lg-12'> Date Range:</div>";
...
$HTML_text.="<div class='col-lg-12'><div class='col-lg-5 no-padding'><INPUT TYPE=TEXT NAME=query_date_D SIZE=11 class=form-control MAXLENGTH=10 VALUE=\"$query_date_D\"></div><div class='col-lg-1 no-padding'>";
...
$HTML_text.=" </div><div class='col-lg-5 no-padding'> <INPUT TYPE=TEXT NAME=query_date_T SIZE=9 class=form-control MAXLENGTH=8 VALUE=\"$query_date_T\">";

$HTML_text.="</div></div><div class='col-lg-12'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; "._QXZ("to")." </div><div class='col-lg-12'><div class='col-lg-5 no-padding'><INPUT TYPE=TEXT NAME=end_date_D SIZE=11 class=form-control MAXLENGTH=10 VALUE=\"$end_date_D\"></div><div class='col-lg-1 no-padding'>";
...
$HTML_text.=" </div><div class='col-lg-5 no-padding'> <INPUT TYPE=TEXT NAME=end_date_T SIZE=9 class=form-control MAXLENGTH=8 VALUE=\"$end_date_T\">";

$HTML_text.="</div></div></TD><TD  class='no-border size'>"._QXZ("Campaigns").":<BR>";
...
$HTML_text.="</TD><TD  class='no-border size'>"._QXZ("Teams/User Groups").":<BR>";
...
$HTML_text.="<TD  class='no-border size'> "._QXZ("Show additional statuses").":<BR>";
$HTML_text.="<SELECT SIZE=5 class=form-control NAME=call_status[] multiple>\n";
...
$HTML_text.="<select name='report_display_type' class=form-control>";
...
$HTML_text.="";
$HTML_text.="<a href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date&query_date_D=$query_date_D&query_date_T=$query_date_T&end_date_D=$end_date_D&end_date_T=$end_date_T$groupQS$user_groupQS$call_statusQS&file_download=1&SUBMIT=$SUBMIT\">"._QXZ("DOWNLOAD")."</a>&nbsp;|&nbsp;<a href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a>";
//$HTML_text.=" &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"./admin.php?ADD=999999\">REPORTS</a> </FONT>\n";
$HTML_text.="</TD></TR><tr><td class='no-border' align=center colspan=4><INPUT TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'>";
...
if ( ($SUBMIT=="SUBMIT") or ($SUBMIT==_QXZ("SUBMIT")) )
	...
	$ASCII_text.="+------------------------------------------+------------+-------+-------+----------+---------------+---------------+-------------+-----------+-------+------------------------+----------------------+-------------------------+----------------+------------------+-----------------+-----------+-----------------------+-------------------+----------------------+$HTMLborderheader\n";
	$ASCII_text.="</FONT></PRE>";
	$ASCII_text.="</div></div></div></div></div></div></div>";
	$ASCII_text.="</BODY>\n";
	$ASCII_text.="</HTML>\n";
	...
	$GRAPH_text.="</FONT></PRE>";
	$GRAPH_text.="</div></div></div></div></div></div></div>";
	$GRAPH_text.="</BODY>\n";
	$GRAPH_text.="</HTML>\n";
