...
function click_cell(temp_cell)
	...
	document.querySelector(".bg-green")?.classList.remove("bg-green"); /* this line add   */
	document.getElementById(temp_cell).classList.add("bg-green");      /* this line add  */
...
if ($soundboard_layout == 'columns01')
	...
	echo "<center><table style='width:100%; background-color:white;position:fixed;top:0px;' cellspacing=0 >\n";
	echo "<tr  height=30px bgcolor=\"white\">";
	echo "<td bgcolor=#0099DD width=50% rowspan=2 align=center colspan=2><b><font color=white face=\"Arial,Helvetica\">$avatar_name</font></b></td>";
	if (preg_match("/STOP/",$audio_functions))
		{echo "<td height=20px  align=center id=\"stop_td\" onMouseOver=\"this.bgColor='#FF0000'\" onMouseOut=\"this.bgColor='#FF9999'\" bgColor=\"#FF9999\" onClick=\"stop_audio()\"><b><font face=\"Arial,Helvetica\" color=white>"._QXZ("Stop Audio")." &nbsp; &nbsp; &nbsp; &nbsp; </font><span id=countdown_audio></span></b></td>";}
	else
		{echo "<td height=20px align=center id=\"stop_td\" bgColor=\"white\" > &nbsp; <span id=countdown_audio></span></td>";}
	echo "</tr><tr><td height=0px  align=center id=\"stop_td\" bgColor=\"\" ><span id=stop_progress></span></td>";
	echo "</tr></table>\n";
	echo "<table style='width:99%;margin-top:40px;background-color:white'   cellspacing=3 >\n";
	echo "<tr valign=top>\n";
	...
	while ($soundboardfiles_to_print > $o)
		...
		$tr_begin='';
		$tr_end='';
        $font_size_convert= $Afont_size[$o]*6;    ######  This line is ADD ###### 
		while($rc < $ranks)
			{
			if ($Arank[$o] == $Uranks[$rc])
				{
		...
		if ( ($Abutton_type[$o] == 'header') or ($Abutton_type[$o] == 'head2r') )
			{
			echo "$tr_begin<td   style= 'width:200px; border-radius:5px' id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"center\" bgColor=\"#8C1F28\" colspan=$Rcolspan nowrap><div class='header-head2r' style='font-size:$font_size_convert; color:#ffffff'>$Abold_start[$o]$Aitalic_start[$o] &nbsp; $count_display$Aaudio_name[$o] &nbsp; $Aitalic_end[$o]$Abold_end[$o]</div></td>";
			echo "$tr_end\n";
			}
		else
			{
			if ($Abutton_type[$o] == 'space')
                ...
                {  
					switch ($Ah_ord[$o]) {
						case 1:
							echo "$tr_begin<td class='voice-row'  style= 'width:200px; border-radius:5px'  onClick=\"click_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\"   id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"left\" bgColor=\"#B3ECF2\"  colspan=$Rcolspan  nowrap><div  style='font-size:$font_size_convert;font-family:sans-serif;'  >$Abold_start[$o]$Aitalic_start[$o] &nbsp; $count_display$display_button &nbsp; $Aitalic_end[$o]$Abold_end[$o]</div></td>";
							echo "$tr_end\n";
							break;
						case 2:
							echo "$tr_begin<td class='voice-row'  style= 'width:200px; border-radius:5px'  onClick=\"click_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\"  id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"left\" bgColor=\"#FACFCE\"  colspan=$Rcolspan  nowrap><div  style='font-size:$font_size_convert;font-family:sans-serif;'  >$Abold_start[$o]$Aitalic_start[$o] &nbsp; $count_display$display_button &nbsp; $Aitalic_end[$o]$Abold_end[$o]</div></td>";
							echo "$tr_end\n";
							break;
						case 3:
							echo "$tr_begin<td class='voice-row'  style= 'width:200px; border-radius:5px'  onClick=\"click_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\"  id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"left\" bgColor=\"#D9D4CC\"  colspan=$Rcolspan nowrap ><div  style='font-size:$font_size_convert;font-family:sans-serif;'  >$Abold_start[$o]$Aitalic_start[$o] &nbsp; $count_display$display_button &nbsp; $Aitalic_end[$o]$Abold_end[$o]</div></td>";
							echo "$tr_end\n";
							break;
						case 4:
							echo "$tr_begin<td class='voice-row'  style= 'width:200px; border-radius:5px'  onClick=\"click_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\"  id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"left\" bgColor=\"#a8a8e9\"  colspan=$Rcolspan  nowrap><div  style='font-size:$font_size_convert;font-family:sans-serif;'  >$Abold_start[$o]$Aitalic_start[$o] &nbsp; $count_display$display_button &nbsp; $Aitalic_end[$o]$Abold_end[$o]</div></td>";
							echo "$tr_end\n";
							break;
						case 5:
							echo "$tr_begin<td class='voice-row'  style= 'width:200px; border-radius:5px'  onClick=\"click_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\"  id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"left\" bgColor=\"orange\"  colspan=$Rcolspan  nowrap><div  style='font-size:$font_size_convert;font-family:sans-serif;'  >$Abold_start[$o]$Aitalic_start[$o] &nbsp; $count_display$display_button &nbsp; $Aitalic_end[$o]$Abold_end[$o]</div></td>";
							echo "$tr_end\n";
							break;
						default:
						echo "$tr_begin<td class='voice-row' style= 'width:200px; border-radius:5px'  onClick=\"click_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\"  id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"left\" bgColor=\"$colors[$m]\"  colspan=$Rcolspan  nowrap><div  style='font-size:$font_size_convert;font-family:sans-serif;'  >$Abold_start[$o]$Aitalic_start[$o] &nbsp; $count_display$display_button &nbsp; $Aitalic_end[$o]$Abold_end[$o]</div></td>";
						echo "$tr_end\n";
					}
	...
	echo "<td  width=50% bgcolor=#0099DD rowspan=2 align=center colspan=2><b><font face=\"Arial,Helvetica\">$avatar_name</font></b></td>";
	if (preg_match("/STOP/",$audio_functions))
		{echo "<td width=400 align=center id=\"stop_td\"  onMouseOver=\"this.bgColor='#FF0000'\" onMouseOut=\"this.bgColor='#FF9999'\" bgColor=\"#FF9999\" onClick=\"stop_audio()\"><b><font face=\"Arial,Helvetica\">"._QXZ("stop audio")." &nbsp; &nbsp; &nbsp; &nbsp; </font><span id=countdown_audio></span></b></td>";}
	else
		{echo "<td width=400 align=center id=\"stop_td\"  bgColor=\"white\" > &nbsp; <span id=countdown_audio></span></td>";}
	echo "</tr><tr><td width=400 height=5 align=center id=\"stop_td\" bgColor=\"white\" ><span id=stop_progress></span></td>";
	echo "</tr></table>\n";
	echo "<table width=99% cellspacing=3 bgcolor=white style='padding-top:14px;'>\n";
	...
	while ($soundboardfiles_to_print > $o)
		...
		if ( ($Abutton_type[$o] == 'header') or ($Abutton_type[$o] == 'head2r') )
			{
			echo "$tr_begin<td id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"center\" bgColor=\"#8C1F28\" colspan=$Rcolspan nowrap><font size=\"$Afont_size[$o]\" color=\"white\" face=\"Arial,Helvetica\">$Abold_start[$o]$Aitalic_start[$o]$count_display$Aaudio_name[$o]$Aitalic_end[$o]$Abold_end[$o]</font></td>";
			echo "$tr_end\n";
			}
		else
			{
			if ($Abutton_type[$o] == 'space')
				...
				{
				echo "$tr_begin<td onClick=\"click_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\" onMouseOver=\"over_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\" onMouseOut=\"out_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\" id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"left\" bgcolor=\"#C0E6F5\" colspan=$Rcolspan nowrap><font   size=\"$Afont_size[$o]\" face=\"Arial,Helvetica\">$Abold_start[$o]$Aitalic_start[$o]$count_display$display_button$Aitalic_end[$o]$Abold_end[$o]</font></td>";
				echo "$tr_end\n";
				}
			}
