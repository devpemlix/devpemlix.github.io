...
if ($soundboard_layout == 'columns01')
	...
	echo "<tr  height=25px bgcolor=white>";
	...
	if (preg_match("/STOP/",$audio_functions))
		{echo "<td  width=300 align=center id=\"stop_td\" onMouseOver=\"this.bgColor='#FF0000'\" onMouseOut=\"this.bgColor='#FF9999'\" bgColor=\"#FF9999\" position=\"sticky\" onClick=\"stop_audio()\"><b><font face=\"Arial,Helvetica\" color=white>"._QXZ("Stop Audio")." &nbsp; &nbsp; &nbsp; &nbsp; </font><span id=countdown_audio></span></b></td>";}
	else
		{echo "<td  width=300 align=center id=\"stop_td\" bgColor=\"white\" > &nbsp; <span id=countdown_audio></span></td>";}
	echo "</tr><tr><td  width=300  align=center id=\"stop_td\" bgColor=\"white\" ><span id=stop_progress></span></td>";
	echo "</tr></table>\n";
	...
	while ($soundboardfiles_to_print > $o)
		...
		if ( ($Abutton_type[$o] == 'header') or ($Abutton_type[$o] == 'head2r') )
			{
			echo "$tr_begin<td id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"center\" bgColor=\"#FF9933\" colspan=$Rcolspan nowrap><font class=\"header-head2r\"  size=\"$Afont_size[$o]\" color=\"#1E232E\" face=\"Arial,Helvetica\">$Abold_start[$o]$Aitalic_start[$o] &nbsp; $count_display$Aaudio_name[$o] &nbsp; $Aitalic_end[$o]$Abold_end[$o]</font></td>";
			echo "$tr_end\n";
			}
		else
			{
			if ($Abutton_type[$o] == 'space')
				...
				{
				echo "$tr_begin<td class=\"voice-row\"  style= 'border-radius: 10px;' onClick=\"click_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\" onMouseOver=\"over_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\" onMouseOut=\"out_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\" id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"left\" bgColor=\"#FABEEF\"  colspan=$Rcolspan  nowrap><font  class=\"voice-file\"    size=\"$Afont_size[$o]\" font-family= \"cursive\" >$Abold_start[$o]$Aitalic_start[$o] &nbsp; $count_display$display_button &nbsp; $Aitalic_end[$o]$Abold_end[$o]</font></td>";
				echo "$tr_end\n";
				}
			}
	...
	while ($soundboardfiles_to_print > $o)
		...
		if ( ($Abutton_type[$o] == 'header') or ($Abutton_type[$o] == 'head2r') )
			{
			echo "$tr_begin<td id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"center\" bgColor=\"#FF9933\" colspan=$Rcolspan nowrap><font size=\"$Afont_size[$o]\" color=\"white\" face=\"Arial,Helvetica\">$Abold_start[$o]$Aitalic_start[$o]$count_display$Aaudio_name[$o]$Aitalic_end[$o]$Abold_end[$o]</font></td>";
			echo "$tr_end\n";
			}
		else
			{
			if ($Abutton_type[$o] == 'space')
				...
				{
				echo "$tr_begin<td onClick=\"click_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\" onMouseOver=\"over_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\" onMouseOut=\"out_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\" id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"left\" bgcolor=\"#FABEEF\" colspan=$Rcolspan nowrap><font size=\"$Afont_size[$o]\" face=\"Arial,Helvetica\">$Abold_start[$o]$Aitalic_start[$o]$count_display$display_button$Aitalic_end[$o]$Abold_end[$o]</font></td>";
				echo "$tr_end\n";
				}
			}
