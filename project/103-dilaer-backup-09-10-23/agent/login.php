...
$BROWSER_HEIGHT			= 800;	# set to the minimum browser height, default=500
$BROWSER_WIDTH			= 870;	# set to the minimum browser width, default=770
$webphone_width			= 660;	# set the webphone frame width
...
$MAIN_COLOR				= '#CCCCFF';	# old default is E0C2D6
$SCRIPT_COLOR			= '#CCCCFF';	# old default is FFE7D0
$REC_COLOR			    = '#CCCCFF'; ## change by deepu
$FORM_COLOR				= '#CCCCFF';
$SIDEBAR_COLOR			= '#CCCCFF';
...
<head>
	...
	<link href="newfont/netdna.css" rel='stylesheet'>
	<!--<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,400italic,700,800' rel='stylesheet' type='text/css'>-->
	<link href="newfont/googleapis.css" rel='stylesheet' type='text/css'>
	<!--<link href='http://fonts.googleapis.com/css?family=Raleway:300,200,100' rel='stylesheet' type='text/css'>-->
	<link href="newfont/googleapis1.css" rel='stylesheet' type='text/css'>
...
if ($campaign_login_list > 0)
	...
	if ($relogin == 'YES')
		...
		if ($cl_user_ct > 0)
			...
			{
			echo "<select class=\"form-control\" size=1 name=VD_campaign id=VD_campaign onFocus=\"login_allowable_campaigns()\">\n";
	...
	{
    $camp_form_code = "<input class=\"form-control\" type=\"text\" name=\"vd_campaign\" size=\"10\" maxlength=\"20\" value=\"$VD_campaign\" />\n";
	}
...
<link rel="stylesheet" type="text/css" href="css/jquery.dataTables.css">
 ...
 <script src="newfont/ajax1.js"></script>
  <!--<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>-->
  <script src="newfont/ajax2.js"></script>
			...
			if (xmlhttp) 
				...
				xmlhttp.onreadystatechange = function() 
					...
					//	alert(xmlhttp.responseText);
                        ...
                        document.getElementById("LogiNReseT").innerHTML = "<input type=\"button\" class='btn btn-primary' value=\"Refresh Campaign List\" onclick=\"login_allowable_campaigns()\" />";
...
if ($relogin == 'YES')
    ...
    echo "<br /><br /><br /><center><table width=\"860px\" cellpadding=\"0\" cellspacing=\"0\" bgcolor=\"#CCCCFF\"><tr bgcolor=\"#CCCCFF\">";
    ...
    echo "<tr><td align=\"right\">"._QXZ("Phone:")." </td>";
    echo "<td align=\"left\"><input type=\"text\" name=\"phone_login\" size=\"20\" maxlength=\"40\" value=\"$phone_login\" /></td></tr>\n";
...
//	echo "<!-- INTERNATIONALIZATION-LINKS-PLACEHOLDER-VICIDIAL -->\n";
 //   echo "</tr></table>\n";
    ...
    echo "<img src=\"./images/"._QXZ("vtc_tab_vicidial.png")."\" border=\"0\" alt=\"VICIdial\" style=\"height:45px;\"/>\n";
    echo "</h3>";
    echo "</div>\n";
    echo "<div>\n";
    ...
    echo "<input type=\"hidden\" name=\"JS_browser_width\" id=\"JS_browser_width\" value=\"\" />\n";
    echo "<input type=\"hidden\" name=\"admin_test\" id=\"admin_test\" value=\"$admin_test\" />\n";
//    echo "<br /><br /><br /><center><table width=\"460px\" cellpadding=\"0\" cellspacing=\"0\" bgcolor=\"#CCCCFF\"><tr bgcolor=\"white\">";
  //  echo "<td align=\"left\" valign=\"bottom\"><img src=\"./images/"._QXZ("vdc_tab_vicidial.gif")."\" border=\"0\" alt=\"VICIdial\" /></td>";
    
    echo "<div class=\"content\">\n";
    echo "<div class=\"col-sm-12 no-padding\">\n"; 
    echo "<h4 class=\"title\"> "._QXZ("Re-Login")." </h4>";
    echo "</div>\n\n";
    echo "<div class=\"form-group\">\n";
    echo "<div class=\"col-sm-6\">\n";
    echo "<div class=\"input-group\">\n";
    echo "<input class=\"form-control\" placeholder=\"Phone Login\" type=\"text\" name=\"phone_login\" size=\"10\" maxlength=\"20\" value=\"$phone_login\" />\n";
    echo "</div>\n";
    echo "</div>\n";
  ...
  //  echo "<td align=\"left\"><input type=\"text\" name=\"phone_login\" size=\"10\" maxlength=\"20\" value=\"$phone_login\" /></td></tr>\n";
    ...
    echo "<div class=\"col-sm-6\">\n";
    echo "<div class=\"input-group\">\n";
    echo "<input class=\"form-control\" placeholder=\"Phone Password\" type=\"password\" name=\"phone_pass\" size=\"10\" maxlength=\"20\" value=\"$phone_pass\" />\n";
    echo "</div>\n";
    echo "</div>\n";
    echo "</div>\n";
 ...
 //   echo "<td align=\"left\"><input type=\"password\" name=\"phone_pass\" size=\"10\" maxlength=\"20\" value=\"$phone_pass\" /></td></tr>\n";
    ...
    echo "<div class=\"col-sm-6\">\n";
    echo "<div class=\"input-group\">\n";
    echo "<input class=\"form-control\" placeholder=\"User Login\" type=\"text\" name=\"VD_login\" size=\"10\" maxlength=\"20\" value=\"$VD_login\" />\n";
    echo "</div>\n";
    echo "</div>\n";
  ...
  //  echo "<td align=\"left\"><input type=\"text\" name=\"VD_login\" size=\"10\" maxlength=\"20\" value=\"$VD_login\" /></td></tr>\n";
    ...
    echo "<div class=\"col-sm-6\">\n";
    echo "<div class=\"input-group\">\n";
    echo "<input class=\"form-control\" placeholder=\"User Password\" type=\"password\" name=\"VD_pass\" size=\"10\" maxlength=\"20\" value=\"$VD_pass\" />\n";
    echo "</div>\n";
    echo "</div>\n";
    echo "</div>\n";
  ...
  //  echo "<tr><td align=\"right\" valign=\"top\">"._QXZ("Campaign:")."  </td>";
   // echo "<td align=\"left\"><span id=\"LogiNCamPaigns\">$camp_form_code</span></td></tr>\n";
    ...
    echo "<div class=\"foot\">\n";
    echo "<input class=\"btn btn-default\" type=\"submit\" name=\"SUBMIT\" value=\""._QXZ("SUBMIT")."\" />\n";
    echo "<span id=\"LogiNReseT\"><input class=\"btn btn-primary \" type=\"button\" value=\""._QXZ("Refresh Campaign List")."\" onclick=\"login_allowable_campaigns()\"></span>\n";
    echo "</div>\n";
...
if ($user_login_first == 1)
	...
	if ( (strlen($VD_login)<1) or (strlen($VD_pass)<1) or (strlen($VD_campaign)<1) )
        ...
        echo "<table width=\"460px\" cellpadding=\"0\" cellspacing=\"0\" bgcolor=\"$MAIN_COLOR\"><tr bgcolor=\"#CCCCFF\">";
        echo "<td align=\"left\" valign=\"bottom\"><img src=\"./images/"._QXZ("vtc_tab_vicidial.png")."\" border=\"0\" alt=\"VICIdial\" style=\"height:45px;\" /></td>";
		...
		if ( (strlen($phone_login)<2) or (strlen($phone_pass)<2) )
			...
			if ( (strlen($phone_login) < 1) or (strlen($phone_pass) < 1) )
                ...
                echo "<input type=\"hidden\" name=\"JS_browser_height\" id=\"JS_browser_height\" value=\"\" />\n";
                echo "<input type=\"hidden\" name=\"JS_browser_width\" id=\"JS_browser_width\" value=\"\" />\n";
                echo "<br /><br /><br /><center><table width=\"460px\" cellpadding=\"0\" cellspacing=\"0\" bgcolor=\"$MAIN_COLOR\"><tr bgcolor=\"#CCCCFF\">";
                echo "<td align=\"left\" valign=\"bottom\"><img src=\"./images/"._QXZ("vtc_tab_vicidial.png")."\" border=\"0\" alt=\"VICIdial\" style=\"height:45px;\"/></td>";
...
//	echo "<!-- INTERNATIONALIZATION-LINKS-PLACEHOLDER-VICIDIAL -->\n";
  //  echo "</tr></table>\n";
    ...
    echo "<div class=\"header\">\n";
    echo "<h3 class=\"text-center\">\n";
    echo "<img class=\"logo-img\" alt=\"logo\" src=\"./images/"._QXZ("vtc_tab_vicidial.png")."\">\n";
    echo "</h3>\n";
    echo "</div>\n";
    echo "<div>\n";
    echo "<form class=\"form-horizontal\" name=\"vicidial_form\" id=\"vicidial_form\" action=\"$agcPAGE\" method=\"post\">\n";
  ...
  //  echo "</tr>\n";
   // echo "<tr><td align=\"left\" colspan=\"2\"><font size=\"1\"> &nbsp; </font></td></tr>\n";
    ...
    echo "<div class=\"col-sm-6\">\n";
    echo "<div class=\"input-group\">\n";
    echo "<input id=\"phonelogin\" class=\"form-control\" type=\"text\" placeholder=\"Phone Login\" name=\"phone_login\" size=\"10\" maxlength=\"20\" value=\"\" />\n";
    echo "</div>\n\n";
    echo "</div>\n\n";
     echo "<div class=\"col-sm-6\">\n";
    echo "<div class=\"input-group\">\n";
    echo "<input id=\"phonepassword\" class=\"form-control\" type=\"password\" placeholder=\"Phone Password\" name=\"phone_pass\" size=\"10\" maxlength=\"20\" value=\"\" />\n";
    echo "</div>\n\n";
    echo "</div>\n\n";
    echo "</div>\n\n";
  ...
  //  echo "<tr><td align=\"right\">"._QXZ("User Password:")."  </td>";
   // echo "<td align=\"left\"><input type=\"password\" name=\"VD_pass\" size=\"10\" maxlength=\"20\" value=\"$VD_pass\" /></td></tr>\n";
    ...
    echo "<div class=\"foot no-padding\"><div class=\"form-group\"><div class=\"col-sm-12\"><input class=\"btn btn-default\" type=\"submit\" name=\"SUBMIT\" value=\""._QXZ("Submit")."\" />\n";
    echo "<span id=\"LogiNReseT\"></span></div></div>\n";
   // echo "<h4 class=\"title\" align=\"left\" colspan=\"2\"><font size=\"1\"><br/>"._QXZ("VERSION:")." $version &nbsp; &nbsp; &nbsp; "._QXZ("BUILD:")." $build</font></h4>\n";
    echo "</div></div>\n\n";
    echo "</form>\n\n";
	echo "</div>\n\n";
	echo "</div>\n\n";
			...
			if ( ( (preg_match("/START|ALL/",$shift_enforcement)) and (!preg_match("/OFF/",$VU_agent_shift_enforcement_override)) ) or (preg_match("/START|ALL/",$VU_agent_shift_enforcement_override)) )
				...
				if ( ($shift_ok < 1) and ($VU_shift_override_flag < 1) and ($VDloginDISPLAY > 0) )
                    ...
                    $VDdisplayMESSAGE.= "<div class='form-group'>
                    					<div class='col-sm-6'>
                    					<div class='input-group'>
                    					<input class='form-control' placeholder='Manager Password' type=\"password\" name=\"MGR_pass$loginDATE\" size=\"10\" maxlength=\"20\" />
                    					</div></div></div>
                    					<br />\n";
                    $VDdisplayMESSAGE.= "<div class='foot no-padding'>
                    					<div class='form-group'>
                    					<div class='input-group'>
                    					<input class='btn btn-default' type=\"submit\" name=\"SUBMIT\" value=\""._QXZ("SUBMIT")."\" />
                    					</div></div></div>
                    					</form>\n";
					}
				}
	...
	echo "<div>\n";
       ...
       // echo "<input type=\"hidden\" name=\"phone_login\" value=\"$phone_login\" />\n";
      //  echo "<input type=\"hidden\" name=\"phone_pass\" value=\"$phone_pass\" />\n";
        echo "<center><b>$VDdisplayMESSAGE</b></center>";
       // echo "<table width=\"460px\" cellpadding=\"0\" cellspacing=\"0\" bgcolor=\"$MAIN_COLOR\"><tr bgcolor=\"#CCCCFF\">";
        //echo "<td align=\"left\" valign=\"bottom\"><img src=\"./images/"._QXZ("vdc_tab_vicidial.gif")."\" border=\"0\" alt=\"VICIdial\" /></td>";

	echo "<div class=\"content\">\n";
	echo "<div class=\"col-sm-12 no-padding\">\n";  
        echo "<h4 class=\"title\"> "._QXZ("Campaign Login")." </h4>";
	echo "</div>\n\n";

	echo "<div class=\"form-group\">\n";
	echo "<div class=\"col-sm-6\">\n";
	echo "<div class=\"input-group\">\n";
	echo "<input placeholder=\"Phone Login\" class=\"form-control\" type=\"text\" name=\"phone_login\" size=\"10\" maxlength=\"20\" value=\"$phone_login\">\n";
	echo "</div>\n";
	echo "</div>\n";
//	echo "</div>\n";
...
//        echo "<span id=\"LogiNReseT\"></span></td></tr>\n";
  ...
  //      echo "<input type=\"hidden\" name=\"VD_login\" value=\"$VD_login\" />\n";
     ...
     //   echo "<input type=\"hidden\" name=\"VD_campaign\" value=\"$VD_campaign\" />\n";
       // echo "<center><table width=\"460px\" cellpadding=\"0\" cellspacing=\"0\" bgcolor=\"$MAIN_COLOR\"><tr bgcolor=\"#CCCCFF\">";
       // echo "<td align=\"left\" valign=\"bottom\"><img src=\"./images/"._QXZ("vdc_tab_vicidial.gif")."\" border=\"0\" alt=\"VICIdial\" /></td>";
	echo "<div class=\"content\">\n";
	...
	echo "<b><h4 class=\"title\">"._QXZ("Sorry, there are no leads in the hopper for this campaign")."</h4></b>\n";
	 echo "</div>\n\n";
    	...
    	echo "<div class=\"input-group\">\n";
            ...
            echo " <input class=\"form-control\" placeholder='Login' type=\"text\" name=\"VD_login\" size=\"10\" maxlength=\"20\" value=\"$VD_login\" />\n<br />";
	echo "</div>\n";
    	echo "</div>\n";
			
	echo "<div class=\"col-sm-6\">\n";
    echo "<div class=\"input-group\">\n";
            echo " <input class=\"form-control\" placeholder='Password' type=\"password\" name=\"VD_pass\" size=\"10\" maxlength=\"20\" value=\"$VD_pass\" /><br />\n";
	echo "</div>\n";
    	echo "</div>\n";
...
while ($CINC < 12)
	...
	$CCAL_OUT .= "<table border=\"1\" cellpadding=\"1\" bordercolor=\"#CCCCFF\" cellspacing=\"0\" bgcolor=\"#CCCCFF\">";
	$CCAL_OUT .= "<tr>";
	$CCAL_OUT .= "<td colspan=\"7\" bordercolor=\"#CCCCFF\" bgcolor=\"#CCCCFF\">";
	$CCAL_OUT .= "<div align=\"center\"><font color=\"#CCCCFF\"><b><font face=\"Arial, Helvetica, sans-serif\" size=\"2\">";
	...
	foreach($Cdays as $Cday)
		{
		$CDCLR="#ffffff";
		$CCAL_OUT .= "<td bordercolor=\"#CCCCFF\">";
		$CCAL_OUT .= "<div align=\"center\"><font color=\"#CCCCFF\"><b><font face=\"Arial, Helvetica, sans-serif\" size=\"1\">";
		$CCAL_OUT .= "$Cday";
		$CCAL_OUT .= "</font></b></font></div>";
		$CCAL_OUT .= "</td>";
		}
	...
	for( $Ccount=0;$Ccount<(6*7);$Ccount++)
		...
		if($Ccount < $CfirstdayARY['wday'] || $Cdayarray['mon'] != $Cmonth)
			{
			$CCAL_OUT .= "<td bordercolor=\"#CCCCFF\"><font color=\"#CCCCFF\"><b><font face=\"Arial, Helvetica, sans-serif\" size=\"1\">&nbsp;</font></b></font></td>";
			}
		else
			{
			if( ($Cdayarray['mday'] == $CTODAYmday) and ($CPRNTDAY == $CTODAY) )
				...
				$CCAL_OUT .= "<td bgcolor=\"#CCCCFF\" bordercolor=\"#FFCCCC\" $CB_date_onclick>";
...
?>
	...
	var DiaLControl_auto_HTML = "<a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADready');\"><img class=\"img\" src=\"./images/<?php echo _QXZ("vdc_LB_paused.gif") ?>\" border=\"0\" alt=\"You are paused\" /></a>";
 	var DiaLControl_auto_HTML_ready = "<a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADpause');\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_active.gif") ?>\" border=\"0\" alt=\"You are active\" /></a>";
	var DiaLControl_auto_HTML_OFF = "<img src=\"./images/<?php echo _QXZ("vdc_LB_blank_OFF.gif") ?>\" border=\"0\" alt=\"pause button disabled\" />";
    var DiaLControl_manual_HTML = "<a href=\"#\" onclick=\"ManualDialNext('','','','','','0');\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_dialnextnumber.gif") ?>\" border=\"0\" alt=\"Dial Next Number\" /></a>";
...
// Send alert control command for agent
	function alert_control(taskalert) 
		...
		if (taskalert=='ON')
			{
			alert_enabled = 'ON';
			document.getElementById("AgentAlertSpan").innerHTML = "<a class=\"enjoy-css\" href=\"#\" onclick=\"alert_control('OFF');return false;\"><?php echo _QXZ("Alert is ON") ?></a>";
			}
		else
			{
			alert_enabled = 'OFF';
			document.getElementById("AgentAlertSpan").innerHTML = "<a class=\"enjoy-css_yellow\" href=\"#\" onclick=\"alert_control('ON');return false;\"><?php echo _QXZ("Alert is OFF") ?></a>";
			}
...
// filter manual dialstring and pass on to originate call
	function SendManualDial(taskFromConf)
		...
		if (taskFromConf == 'YES')
            ...
            document.getElementById("DialWithCustomer").innerHTML ="<img style='width:210px;height:35px;' class='imagesize' src=\"./images/<?php echo _QXZ("vdc_XB_dialwithcustomer_OFF.gif") ?>\" border=\"0\" alt=\"Dial With Customer\" style=\"vertical-align:middle\" /></a>";

            document.getElementById("ParkCustomerDial").innerHTML ="<img style='width:210px;height:35px;' class='imagesize' src=\"./images/<?php echo _QXZ("vdc_XB_parkcustomerdial_OFF.gif") ?>\" border=\"0\" alt=\"Park Customer Dial\" style=\"vertical-align:middle\" /></a>";
				...
				xmlhttprequestcheckconf.onreadystatechange = function() 
					...
					//	alert(xmlhttprequestcheckconf.responseText);
						...
						if (APIManualDialQueue != APIManualDialQueue_last)
                            ...
                            document.getElementById("ManualQueueNotice").innerHTML = "<b><font color=\"#CCCCFF\" size=\"3\"><?php echo _QXZ("Manual Queue:"); ?> " + APIManualDialQueue + "</font></b><br />";
							}
		...
		if (xmlhttp) 
			...
			//	filename = filedate + "_" + user_abb;
				...
				var channelrec = "Local/" + conf_silent_prefix + '' + taskconfrec + "@" + ext_context;
                 var conf_rec_start_html = "<a href=\"#\" onclick=\"conf_send_recording('StopMonitorConf','" + taskconfrec + "','" + filename + "');return false;\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_stoprecording.gif") ?>\" border=\"0\" alt=\"Stop Recording\" /></a>";

				if (LIVE_campaign_recording == 'ALLFORCE')
					{
                    document.getElementById("RecorDControl").innerHTML = "<img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_startrecording_OFF.gif") ?>\" border=\"0\" alt=\"Start Recording\" />";
					}
				else
					{
			...
			if (taskconfrectype == 'StopMonitorConf')
				...
				var channelrec = "Local/" + conf_silent_prefix + '' + taskconfrec + "@" + ext_context;
                var conf_rec_start_html = "<a href=\"#\" onclick=\"conf_send_recording('MonitorConf','" + taskconfrec + "','','','','');return false;\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_startrecording.gif") ?>\" border=\"0\" alt=\"Start Recording\" /></a>";
				if (LIVE_campaign_recording == 'ALLFORCE')
					{
                    document.getElementById("RecorDControl").innerHTML = "<img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_startrecording_OFF.gif") ?>\" border=\"0\" alt=\"Start Recording\" />";
					}
			...
			//	conf_dialed=1;
				...
				if (xmlhttpXF) 
					...
					if (taskvar == 'ParK')
						...
						document.getElementById("ParkControl").innerHTML ="<a href=\"#\" onclick=\"mainxfer_send_redirect('FROMParK','" + redirectdestination + "','" + redirectdestserverip + "');return false;\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_grabparkedcall.gif") ?>\" border=\"0\" alt=\"Grab Parked Call\" /></a>";
					...
					if (taskvar == 'FROMParK')
						...
						document.getElementById("ParkControl").innerHTML ="<a href=\"#\" onclick=\"mainxfer_send_redirect('ParK','" + redirectdestination + "','" + redirectdestserverip + "');return false;\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_parkcall.gif") ?>\" border=\"0\" alt=\"Park Call\" /></a>";
						if ( (ivr_park_call=='ENABLED') || (ivr_park_call=='ENABLED_PARK_ONLY') )
							{
							document.getElementById("ivrParkControl").innerHTML ="<a href=\"#\" onclick=\"mainxfer_send_redirect('ParKivr','" + redirectdestination + "','" + redirectdestserverip + "');return false;\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_ivrparkcall.gif") ?>\" border=\"0\" alt=\"IVR Park Call\" /></a>";
							}
						customerparked=0;
						customerparkedcounter=0;
						}
					if (taskvar == 'ParKivr')
						...
						document.getElementById("ParkControl").innerHTML ="<img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_parkcall_OFF.gif") ?>\" border=\"0\" alt=\"Grab Parked Call\" />";
						...
						if (ivr_park_call=='ENABLED')
							{
							document.getElementById("ivrParkControl").innerHTML ="<a href=\"#\" onclick=\"mainxfer_send_redirect('FROMParKivr','" + redirectdestination + "','" + redirectdestserverip + "');return false;\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_grabivrparkcall.gif") ?>\" border=\"0\" alt=\"Grab IVR Parked Call\" /></a>";
							}
						customerparked=1;
						customerparkedcounter=0;
						}
		...
		if (taskMDstage == "start") 
			...
			if (alt_phone_dialing == 1)
				...
				if (document.vicidial_form.DiaLAltPhonE.checked==true)
					...
					var man_status = "<?php echo _QXZ("Dial Alt Phone Number:"); ?> <a href=\"#\" onclick=\"ManualDialOnly('MaiNPhonE')\"><font class=\"preview_text\"><?php echo _QXZ("MAIN PHONE"); ?></font></a> <?php echo _QXZ("or"); ?> <a href=\"#\" onclick=\"ManualDialOnly('ALTPhonE')\"><font class=\"preview_text\"><?php echo _QXZ("ALT PHONE"); ?></font></a> <?php echo _QXZ("or"); ?> </br><a href=\"#\" onclick=\"ManualDialOnly('AddresS3')\"><font class=\"preview_text\"><?php echo _QXZ("ADDRESS3"); ?></font></a> <?php echo _QXZ("or"); ?> <a href=\"#\" onclick=\"ManualDialAltDonE()\"><font class=\"preview_text_red\"><?php echo _QXZ("FINISH LEAD"); ?></font></a>" + status_display_content; 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//		alert("VICIDIAL Call log entered:\n" + document.vicidial_form.uniqueid.value);
						if ( (taskMDstage != "start") && (VDstop_rec_after_each_call == 1) )
							{
                            var conf_rec_start_html = "<a href=\"#\" onclick=\"conf_send_recording('MonitorConf','" + session_id + "','','','','');return false;\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_startrecording.gif") ?>\" border=\"0\" alt=\"Start Recording\" /></a>";
		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	alert(xmlhttp.responseText);
					...
					CBlinkCONTENT ="<a class=\"enjoy-css_yellow\" href=\"#\" onclick=\"CalLBacKsLisTCheck();return false;\">" + CBpre + '' + CBprint + '' + " <?php echo _QXZ("ACTIVE CALLBACKS"); ?>" + CBpost + "</a>";	
						...
						//	alert(xmlhttprequestselectupdate.responseText);
							...
							if (change_array[0] == '1')
								...
								if ( (quick_transfer_button == 'IN_GROUP') || (quick_transfer_button == 'LOCKED_IN_GROUP') )
									...
									document.getElementById("QuickXfer").innerHTML = "<a href=\"#\" onclick=\"mainxfer_send_redirect('XfeRLOCAL','" + lastcustchannel + "','" + lastcustserverip + "','','','" + quick_transfer_button_locked + "');return false;\"><img class='image' src=\"./images/<?php echo _QXZ("vdc_LB_quickxfer.gif"); ?>\" border=\"0\" alt=\"QUICK TRANSFER\" /></a>";
									}
								...
								document.getElementById("XfeRGrouPLisT").innerHTML = "<div class='col-md-8'><select size=\"1\" name=\"XfeRGrouP\" class=\"form-control\" id=\"XfeRGrouP\" onChange=\"XferAgentSelectLink();return false;\">" + live_XfeR_HTML + "</select></div>";
								...
								document.getElementById("WebFormSpan").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address + "\" target=\"" + web_form_target + "\" onclick=\"openRequestedSinglePopup(this.href); return false;\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform.gif"); ?>\" border=\"0\" alt=\"Web Form\" /></a>\n";

								if (enable_second_webform > 0)
									{
									document.getElementById("WebFormSpanTwo").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address_two + "\" target=\"" + web_form_target + "\" onMouseOver=\"WebFormTwoRefresH();\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform_two.gif"); ?>\" border=\"0\" alt=\"Web Form 2\" /></a>\n";
									}

								if (enable_third_webform > 0)
									{
									document.getElementById("WebFormSpanThree").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address_three + "\" target=\"" + web_form_target + "\" onMouseOver=\"WebFormThreeRefresH();\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform_three.gif"); ?>\" border=\"0\" alt=\"Web Form 3\" /></a>\n";
									}
...
// Request lookup of manual dial channel
	function ManualDialCheckChanneL(taskCheckOR)
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	document.getElementById("debugbottomspan").innerHTML = "<br>|" + manDiaLlook_query + "|<br>\n" + debug_response;
					...
					//		alert(document.getElementById("MainStatuSSpan").innerHTML);
							document.getElementById("MainStatuSSpan").innerHTML = " <?php echo _QXZ("Calling:"); ?> " + status_display_number + " " + status_display_content + " &nbsp;</br> <?php echo _QXZ("Waiting for Ring..."); ?> " + MD_ring_secondS + " <?php echo _QXZ("seconds"); ?>";
					//		alert("channel not found yet:\n" + campaign);
						...
						if (taskCheckOR == 'YES')
							...
							if ( (XDchannel.match(regMDL)) && (asterisk_version != '1.0.8') && (asterisk_version != '1.0.9') && (MD_ring_secondS < 10) )
                                ...
                                document.getElementById("Leave3WayCall").innerHTML ="<a href=\"#\" onclick=\"leave_3way_call('FIRST');return false;\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_XB_leave3waycall.gif"); ?>\" border=\"0\" alt=\"LEAVE 3-WAY CALL\" style=\"vertical-align:middle\" /></a>";

                                document.getElementById("DialWithCustomer").innerHTML ="<img style='width:210px;height:35px;' class='imagesize'  src=\"./images/<?php echo _QXZ("vdc_XB_dialwithcustomer_OFF.gif"); ?>\" border=\"0\" alt=\"Dial With Customer\" style=\"vertical-align:middle\" />";

                                document.getElementById("ParkCustomerDial").innerHTML ="<img style='width:210px;height:35px;' class='imagesize' src=\"./images/<?php echo _QXZ("vdc_XB_parkcustomerdial_OFF.gif"); ?>\" border=\"0\" alt=\"Park Customer Dial\" style=\"vertical-align:middle\" />";

                                document.getElementById("HangupXferLine").innerHTML ="<a href=\"#\" onclick=\"xfercall_send_hangup();return false;\"><img class='' src=\"./images/<?php echo _QXZ("vdc_XB_hangupxferline.gif"); ?>\" border=\"0\" alt=\"Hangup Xfer Line\" style=\"vertical-align:middle\" /></a>";
							...
							if ( (MDchannel.match(regMDL)) && (asterisk_version != '1.0.8') && (asterisk_version != '1.0.9') )
                                ...
                                document.getElementById("ParkControl").innerHTML ="<a href=\"#\" onclick=\"mainxfer_send_redirect('ParK','" + lastcustchannel + "','" + lastcustserverip + "');return false;\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_parkcall.gif"); ?>\" border=\"0\" alt=\"Park Call\" /></a>";
								if ( (ivr_park_call=='ENABLED') || (ivr_park_call=='ENABLED_PARK_ONLY') )
									{
                                ...
                                document.getElementById("XferControl").innerHTML = "<a href=\"#\" onclick=\"ShoWTransferMain('ON');\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_transferconf.gif"); ?>\" border=\"0\" alt=\"Transfer - Conference\" /></a>";
                                ...
                                document.getElementById("DialBlindVMail").innerHTML = "<a href=\"#\" onclick=\"mainxfer_send_redirect('XfeRVMAIL','" + lastcustchannel + "','" + lastcustserverip + "');return false;\"><img width='7%' src=\"./images/<?php echo _QXZ("vdc_XB_ammessage.gif"); ?>\" border=\"0\" alt=\"Blind Transfer VMail Message\" style=\"vertical-align:middle\" /></a>";
								...
								if (call_requeue_button > 0)
									...
									if ( (CloserSelectChoices.match(regCRB)) || (VU_closer_campaigns.match(regCRB)) )
										...
										{
                                        document.getElementById("ReQueueCall").innerHTML =  "<img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_requeue_call_OFF.gif"); ?>\" border=\"0\" alt=\"Re-Queue Call\" />";
										}
									}
                                ...
                                document.getElementById("XfeRGrouPLisT").innerHTML = "<div class='col-md-8'><select size=\"1\" name=\"XfeRGrouP\" id=\"XfeRGrouP\" class=\"form-control\" onChange=\"XferAgentSelectLink();return false;\">" + live_XfeR_HTML + "</select></div>";
		...
		if ( (MD_ring_secondS > 49) && (MD_ring_secondS > dial_timeout) )
			...
			if (taskCheckOR == 'YES')
				{
				document.getElementById("DialWithCustomer").innerHTML ="<a href=\"#\" onclick=\"SendManualDial('YES');return false;\"><img style='width:210px;height:35px;' class='imagesize'  src=\"./images/<?php echo _QXZ("vdc_XB_dialwithcustomer.gif"); ?>\" border=\"0\" alt=\"Dial With Customer\" style=\"vertical-align:middle\" /></a>";
 				document.getElementById("ParkCustomerDial").innerHTML ="<a href=\"#\" onclick=\"xfer_park_dial();return false;\"><img style='width:210px;height:35px;' class='imagesize'  src=\"./images/<?php echo _QXZ("vdc_XB_parkcustomerdial.gif"); ?>\" border=\"0\" alt=\"Park Customer Dial\" style=\"vertical-align:middle\" /></a>";
				}
			}
		}
				...
				//	alert(xmlhttp.responseText);
					...
					if (UDresponse_status == 'GOOD')
                      ...
                      <!--  document.getElementById("WebFormSpan").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address + "\" target=\"" + web_form_target + "\" onclick=\"openRequestedSinglePopup(this.href); return false;\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform.gif"); ?>\" border=\"0\" alt=\"Web Form\" /></a>\n"; -->
						...
						if (enable_third_webform > 0)
							{
                           <!-- document.getElementById("WebFormSpanTwo").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address_three + "\" target=\"" + web_form_target + "\" onMouseOver=\"WebFormThreeRefresH();\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform_three.gif"); ?>\" border=\"0\" alt=\"Web Form 3\" /></a>\n";  -->
							}
						}
					else
						{
	...
	function ManualDialNext(mdnCBid,mdnBDleadid,mdnDiaLCodE,mdnPhonENumbeR,mdnStagE,mdVendorid,mdgroupalias,mdtype)
		...
		if (waiting_on_dispo > 0)
			...
			if (starting_dial_level == 0)
				{
				document.getElementById("DiaLControl").innerHTML = "<a href=\"#\" onclick=\"ManualDialNext('','','','','','0');\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_dialnextnumber.gif"); ?>\" border=\"0\" alt=\"Dial Next Number\" /></a>";
				}
			else
				{
				if (dial_method == "INBOUND_MAN")
					...
					document.getElementById("DiaLControl").innerHTML = "<a class=\"enjoy-css\" href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADready','','','','','','','');\"><img src=\"./images/<?php echo _QXZ("vdc_LB_paused.gif"); ?>\" border=\"0\" alt=\"You are paused\" /></a><br /><a href=\"#\" onclick=\"ManualDialNext('','','','','','0','','','YES');\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_dialnextnumber.gif"); ?>\" border=\"0\" alt=\"Dial Next Number\" /></a>";
					}
				else
					{
			...
			if (dial_method == "INBOUND_MAN")
				...
				document.getElementById("DiaLControl").innerHTML = "<img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_blank_OFF.gif"); ?>\" border=\"0\" alt=\"pause button disabled\" /><br /><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_dialnextnumber_OFF.gif"); ?>\" border=\"0\" alt=\"Dial Next Number\" />";
				}
			else
				{
				if (active_ingroup_dial.length < 1)
					{
					document.getElementById("DiaLControl").innerHTML = "<img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_dialnextnumber_OFF.gif"); ?>\" border=\"0\" alt=\"Dial Next Number\" />";
					}
				}
			...
			if ( (document.vicidial_form.LeadPreview.checked==true) && (active_ingroup_dial.length < 1) )
				...
				if (alt_phone_dialing == 1)
					{
					var man_status = "Preview the Lead then <a href=\"#\" onclick=\"ManualDialOnly('" + manual_dial_only_type_flag + "')\"><font class=\"preview_text\"> <?php echo _QXZ("DIAL LEAD"); ?></font></a> or <a href=\"#\" onclick=\"ManualDialSkip()\"><font class=\"preview_text\"><?php echo _QXZ("SKIP LEAD"); ?></font></a> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"ManualDialOnly('ALTPhonE')\"><font class=\"preview_text\"><?php echo _QXZ("ALT PHONE"); ?></font></a> or </br><a href=\"#\" onclick=\"ManualDialOnly('AddresS3')\"><font class=\"preview_text\"><?php echo _QXZ("ADDRESS3"); ?></font></a>"; 
					if (manual_preview_dial=='PREVIEW_ONLY')
						{
						var man_status = "Preview the Lead then <a href=\"#\" onclick=\"ManualDialOnly('" + manual_dial_only_type_flag + "')\"><font class=\"preview_text\"> <?php echo _QXZ("DIAL LEAD"); ?></font></a> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"ManualDialOnly('ALTPhonE')\"><font class=\"preview_text\"><?php echo _QXZ("ALT PHONE"); ?></font></a> or</br> <a href=\"#\" onclick=\"ManualDialOnly('AddresS3')\"><font class=\"preview_text\"><?php echo _QXZ("ADDRESS3"); ?></font></a>"; 
						}
					}
				else
					{
					...
					//	document.getElementById("debugbottomspan").innerHTML = manDiaLnext_query + "\n" + xmlhttp.responseText;
						...
						if (active_ingroup_dial.length > 0)
							...
							//END section Added By Poundteam for Audited Comments
								...
								document.getElementById("MainStatuSSpan").innerHTML = " <?php echo _QXZ("Calling:"); ?> " + status_display_number + " " + status_display_content + " &nbsp;</br> " + man_status;
								if ( (dialed_label.length < 2) || (dialed_label=='NONE') ) {dialed_label='MAIN';}
								...
								if (CBentry_time.length > 2)
									{
									document.getElementById("CusTInfOSpaN").innerHTML = " <div class='enjoy-css_cust'> <?php echo _QXZ("PREVIOUS CALLBACK"); ?> </div>";
									//document.getElementById("CusTInfOSpaN").style.background = CusTCB_bgcolor;
									document.getElementById("CBcommentsBoxA").innerHTML = "<b><?php echo _QXZ("Last Call:"); ?> </b>" + CBentry_time;
									document.getElementById("CBcommentsBoxB").innerHTML = "<b><?php echo _QXZ("CallBack:"); ?> </b>" + CBcallback_time;
									document.getElementById("CBcommentsBoxC").innerHTML = "<b><?php echo _QXZ("Agent:"); ?> </b>" + CBuser;
			...
			//		alert(xmlhttp.responseText);
					...
					if (MDnextCID == " CALL NOT PLACED")
						...
						if (alt_dial_status_display=='0')
							...
							document.getElementById("MainStatuSSpan").innerHTML = " <?php echo _QXZ("Calling:"); ?> " + status_display_number + " " + status_display_content + " &nbsp;</br> <?php echo _QXZ("Waiting for Ring..."); ?>";
	...
	function AutoDial_ReSume_PauSe(taskaction,taskagentlog,taskwrapup,taskstatuschange,temp_reason,temp_auto,temp_auto_code)
		...
		if (taskaction == 'VDADready')
			...
			if (dial_method == "INBOUND_MAN")
                ...
                document.getElementById("DiaLControl").innerHTML = "<a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADpause');\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_active.gif"); ?>\" border=\"0\" alt=\"You are active\" /></a><br /><a href=\"#\" onclick=\"ManualDialNext('','','','','','0');\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_dialnextnumber.gif"); ?>\" border=\"0\" alt=\"Dial Next Number\" /></a>";
				}
			else
				{
			...
			if (dial_method == "INBOUND_MAN")
                ...
                document.getElementById("DiaLControl").innerHTML = "<a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADready');\"><img class=\"img\" src=\"./images/<?php echo _QXZ("vdc_LB_paused.gif"); ?>\" border=\"0\" alt=\"You are paused\" /></a><br /><a href=\"#\" onclick=\"ManualDialNext('','','','','','0');\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_dialnextnumber.gif"); ?>\" border=\"0\" alt=\"Dial Next Number\" /></a>";
				}
			else
				{
				document.getElementById("DiaLControl").innerHTML = DiaLControl_auto_HTML;
				...
				xmlhttprequestcheckauto.onreadystatechange = function() 
					...
					//	alert(xmlhttprequestcheckauto.responseText);
						...
						//	DialLog("start");
							...
							if (dial_method == "INBOUND_MAN")
								{
                                document.getElementById("DiaLControl").innerHTML = "<img src=\"./images/<?php echo _QXZ("vdc_LB_blank_OFF.gif"); ?>\" border=\"0\" alt=\"pause button disabled\" /><br /><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_dialnextnumber_OFF.gif"); ?>\" border=\"0\" alt=\"Dial Next Number\" />";
								}
							else
								{
				...
				xmlhttprequestcheckemail.onreadystatechange = function() 
					...
					if (xmlhttprequestcheckemail.readyState == 4 && xmlhttprequestcheckemail.status == 200) 
						...
						//	DialLog("start");
							...
							<!-- document.getElementById("WebFormSpan").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address + "\" target=\"" + web_form_target + "\" onMouseOver=\"WebFormRefresH();\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform.gif"); ?>\" border=\"0\" alt=\"Web Form\" /></a>\n";  -->	
			...
			if (xmlhttprequestcheckother) 
				...
				xmlhttprequestcheckother.onreadystatechange = function() 
					...
					*/
							...
							<!-- document.getElementById("WebFormSpan").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address + "\" target=\"" + web_form_target + "\" onclick=\"openRequestedSinglePopup(this.href);\"><img src=\"./images/<?php echo _QXZ("vdc_LB_webform.gif"); ?>\" border=\"0\" alt=\"Web Form\" /></a>\n"; -->
...
// refresh the content of the web form URL
	function WebFormRefresH(taskrefresh,submittask,force_webvars_refresh) 
		...
		if (taskrefresh == 'OUT')
			{
            <!-- document.getElementById("WebFormSpan").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address + "\" target=\"" + web_form_target + "\" onMouseOver=\"WebFormRefresH('IN');\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform.gif"); ?>\" border=\"0\" alt=\"Web Form\" /></a>\n"; -->
			}
		else 
			{
            <!-- document.getElementById("WebFormSpan").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address + "\" target=\"" + web_form_target + "\" onMouseOut=\"WebFormRefresH('OUT');\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform.gif"); ?>\" border=\"0\" alt=\"Web Form\" /></a>\n"; -->
			}
		}
...
// refresh the content of the second web form URL
	function WebFormTwoRefresH(taskrefresh,submittask) 
		...
		if (enable_second_webform > 0)
			...
			if (taskrefresh == 'OUT')
				{
                document.getElementById("WebFormSpanTwo").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address_two + "\" target=\"" + web_form_target + "\" onMouseOver=\"WebFormTwoRefresH('IN');\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform_two.gif"); ?>\" border=\"0\" alt=\"Web Form 2\" /></a>\n";
				}
			else 
				{
                document.getElementById("WebFormSpanTwo").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address_two + "\" target=\"" + web_form_target + "\" onMouseOut=\"WebFormTwoRefresH('OUT');\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform_two.gif"); ?>\" border=\"0\" alt=\"Web Form 2\" /></a>\n";
				}
			}
		}
...
// refresh the content of the third web form URL
	function WebFormThreeRefresH(taskrefresh,submittask) 
		...
		if (enable_third_webform > 0)
			...
			if (taskrefresh == 'OUT')
				{
              <!--  document.getElementById("WebFormSpanThree").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address_three + "\" target=\"" + web_form_target + "\" onMouseOver=\"WebFormThreeRefresH('IN');\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform_three.gif"); ?>\" border=\"0\" alt=\"Web Form 3\" /></a>\n"; -->
				}
			else 
				{
                document.getElementById("WebFormSpanThree").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address_three + "\" target=\"" + web_form_target + "\" onMouseOut=\"WebFormThreeRefresH('OUT');\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform_three.gif"); ?>\" border=\"0\" alt=\"Web Form 3\" /></a>\n";
				}
			}
		}
...
// Send Hangup command for customer call connected to the conference now to Manager
	function dialedcall_send_hangup(dispowindow,hotkeysused,altdispo,nodeletevdac) 
		...
		//  DEACTIVATE CHANNEL-DEPENDANT BUTTONS AND VARIABLES
			...
			if( document.images ) { document.images['livecall'].src = image_livecall_OFF.src;}
            <!--document.getElementById("WebFormSpan").innerHTML = "<img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform_OFF.gif"); ?>\" border=\"0\" alt=\"Web Form\" />";-->
			if (enable_second_webform > 0)
				{
                <!--document.getElementById("WebFormSpanTwo").innerHTML = "<img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform_two_OFF.gif"); ?>\" border=\"0\" alt=\"Web Form 2\" />";-->
				}
			if (enable_third_webform > 0)
				{
                document.getElementById("WebFormSpanThree").innerHTML = "<img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform_three_OFF.gif"); ?>\" border=\"0\" alt=\"Web Form 3\" />";
				}
            document.getElementById("ParkControl").innerHTML = "<img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_parkcall_OFF.gif"); ?>\" border=\"0\" alt=\"Park Call\" />";
			if ( (ivr_park_call=='ENABLED') || (ivr_park_call=='ENABLED_PARK_ONLY') )
				{
                document.getElementById("ivrParkControl").innerHTML = "<img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_ivrparkcall_OFF.gif"); ?>\" border=\"0\" alt=\"IVR Park Call\" />";
				}
            ...
            document.getElementById("XferControl").innerHTML = "<img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_transferconf_OFF.gif"); ?>\" border=\"0\" alt=\"Transfer - Conference\" />";
            ...
            document.getElementById("DialBlindTransfer").innerHTML = "<img class='imagesize1' src=\"./images/<?php echo _QXZ("vdc_XB_blindtransfer_OFF.gif"); ?>\" border=\"0\" alt=\"Dial Blind Transfer\" style=\"vertical-align:middle\" />";
            document.getElementById("DialBlindVMail").innerHTML = "<img class='img' src=\"./images/<?php echo _QXZ("vdc_XB_ammessage_OFF.gif"); ?>\" border=\"0\" alt=\"Blind Transfer VMail Message\" style=\"vertical-align:middle\" />";
            document.getElementById("VolumeUpSpan").innerHTML = "<img class='img' src=\"./images/<?php echo _QXZ("vdc_volume_up_off.gif"); ?>\" border=\"0\" />";
            document.getElementById("VolumeDownSpan").innerHTML = "<img class='img' src=\"./images/<?php echo _QXZ("vdc_volume_down_off.gif"); ?>\" border=\"0\" />";
...
// Send Hangup command for 3rd party call connected to the conference now to Manager
	function xfercall_send_hangup() 
        ...
        //  document.getElementById("Leave3WayCall").innerHTML ="<img src=\"./images/<?php echo _QXZ("vdc_XB_leave3waycall_OFF.gif"); ?>\" border=\"0\" alt=\"LEAVE 3-WAY CALL\" />";
            ...
            document.getElementById("HangupXferLine").innerHTML ="<img src=\"./images/<?php echo _QXZ("vdc_XB_hangupxferline_OFF.gif"); ?>\" border=\"0\" alt=\"Hangup Xfer Line\" style=\"vertical-align:middle\" class=''  />";
	...
	function DispoSelectContent_create(taskDSgrp,taskDSstage)
		...
		if (disable_dispo_screen > 0)
			...
			if ( (per_call_notes == 'ENABLED') && (comments_dispo_screen != 'REPLACE_CALL_NOTES') )
				...
				document.getElementById("PerCallNotesContent").innerHTML = "<b><font class='padding5' size=\"3\"><?php echo _QXZ("Call Notes:"); ?> </font></b><br /><div class='col-lg-11 padding5'><textarea class='form-control' name=\"call_notes_dispo\" id=\"call_notes_dispo\" rows=\"2\" cols=\"100\" class=\"form-control_text\" value=\"\">" + document.vicidial_form.call_notes.value + "</textarea></div>";
				}
			else
				{
				var test_notes = document.vicidial_form.call_notes_dispo.value;
			...
			if ( (comments_dispo_screen == 'ENABLED') || (comments_dispo_screen == 'REPLACE_CALL_NOTES') )
				...
				var dispo_comment_output = "<table cellspacing=4 cellpadding=0><tr style=\"background-color:transparent;\"><td align=\"right\"><?php echo $label_comments ?>: <br><span id='dispoviewcommentsdisplay'><input type='button' id='DispoViewCommentButton' onClick=\"ViewComments('ON','','dispo')\" value='-<?php _QXZ("History"); ?>-'/></span></font></td><br><td align=\"left\">";
				dispo_comment_output = dispo_comment_output + "<textarea name=\"dispo_comments\" id=\"dispo_comments\" rows=\"2\" cols=\"100\" class=\"form-control\" value=\"\">" + document.vicidial_form.comments.value + "</textarea>\n";
			...
			var dispo_HTML = "<span id=\"DispoSelectA\">";
			var loop_ct = 0;
			var print_ct = 0;
				...
				while (loop_ct < VD_statuses_ct)
					...
					if (VARSELstatuses[loop_ct] == 'Y')
						...
						if (VARCBstatuses[loop_ct] == 'Y')
							...
							{CBflag = '';}
						$people = VARstatuses[loop_ct];
						if (taskDSgrp == VARstatuses[loop_ct]) 
							{
							dispo_HTML = dispo_HTML + "<div class='disp'><a style=\"font-weight:bold;\" class='p_space' href=\"#\" onclick=\"DispoSelect_submit();return false;\">" + VARstatuses[loop_ct] + " - " + VARstatusnames[loop_ct] + " - " + CBflag + "</b></font> </div>";
							}
													if ($people=="Leaerd")
  {
  dispo_HTML = dispo_HTML + "<div class='disp'><a class='p_space' href=\"" + TEMP_VDIC_web_form_address + "\" target=\"" + web_form_target + "\" onclick=\" openRequestedSinglePopup(this.href); DispoSelectContent_create('" + VARstatuses[loop_ct] + "','ADD');return false;\">" +  VARstatuses[loop_ct] + " - " +CBflag + VARstatusnames[loop_ct]  + "</a></div>";
  }
						else
							{
							dispo_HTML = dispo_HTML + "<div class='disp'><a class='p_space' href=\"#\" onclick=\"DispoSelectContent_create('" + VARstatuses[loop_ct] + "','ADD');return false;\">" +  VARstatuses[loop_ct] + " - " +CBflag + VARstatusnames[loop_ct]  + "</a></div>";
							}
	
						if (print_ct == VD_statuses_ct_half) 
							{dispo_HTML = dispo_HTML + "</span><span id=\"DispoSelectB\">";}
						print_ct++;
						}
					loop_ct++;
					}
	...
	function PauseCodeSelectContent_create()
		...
		if (move_on == 1)
			...
			if (APIManualDialQueue > 0)
                ...
                PauseCode_HTML = "<center><div class=\"img_align2\"><div ><div><span id=\"PauseCodeSelectA\">";
				var loop_ct = 0;
				while (loop_ct < VD_pause_codes_ct)
					{
                    PauseCode_HTML = PauseCode_HTML + "<a class=\"col-md-6 spacer2\" href=\"#\" onclick=\"PauseCodeSelect_submit('" + VARpause_codes[loop_ct] + "');return false;\"><span class=\"col-md-12 pause_code\">" + VARpause_codes[loop_ct] + " - " + VARpause_code_names[loop_ct] + "</span></a>";
					loop_ct++;
					if (loop_ct == VD_pause_codes_ct_half) 
                        {PauseCode_HTML = PauseCode_HTML + "</span></div><div bgcolor=\"#fff\" width=\"240px\" valign=\"top\"><span id=PauseCodeSelectB>";}
					}

				if (agent_pause_codes_active=='FORCE')
					{var Go_BacK_LinK = '';}
				else
                    {var Go_BacK_LinK = "<center><div class=\"col-md-12 padding5\"><a class=\"btn btn-primary\" href=\"#\" onclick=\"PauseCodeSelect_submit('');return false;\">Go Back</a></div></center>";}
...
// Generate the Group Alias Chooser panel
	function GroupAliasSelectContent_create(task3way)
        ...
        GroupAlias_HTML = "<table cellpadding=\"5\" cellspacing=\"5\" width=\"50%\"><thead><tr><th colspan=\"2\"><b> <?php echo _QXZ("GROUP ALIAS"); ?></b></th></tr></thead><tr><td height=\"300px\" width=\"240px\" valign=\"top\"><font class=\"log_text\"><span id=\"GroupAliasSelectA\">";
		if (task3way > 0)
			{
        ...
        var Go_BacK_LinK = "<font size=\"3\" style=\"BACKGROUND-COLOR: #FFFFCC\"><b><a class='btn btn-primary' href=\"#\" onclick=\"GroupAliasSelect_submit('');return false;\"><?php echo _QXZ("Go Back"); ?></a>";
...
// open web form, then submit disposition
	function WeBForMDispoSelect_submit()
		...
		if (DispoChoice.length < 1) {alert_box("<?php echo _QXZ("You Must Select a Disposition"); ?>");}
            ...
            <!-- document.getElementById("WebFormSpan").innerHTML = "<a class='enjoy-css1'><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform_OFF.gif"); ?>\" border=\"0\" alt=\"Web Form\" /></a>"; -->
			if (enable_second_webform > 0)
				{
                <!--document.getElementById("WebFormSpanTwo").innerHTML = "<a class='enjoy-css1'><img src=\"./images/<?php echo _QXZ("vdc_LB_webform_two_OFF.gif"); ?>\" border=\"0\" alt=\"Web Form 2\" /></a>"; -->
				}
			if (enable_third_webform > 0)
				{
                document.getElementById("WebFormSpanThree").innerHTML = "<img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_webform_three_OFF.gif"); ?>\" border=\"0\" alt=\"Web Form 3\" />";
			...
			if (document.vicidial_form.lead_id.value == '') {alert_box("<?php echo _QXZ("You can only disposition a call once"); ?>");}
				...
				if ( (VARCBstatusesLIST.match(regCBstatus)) && (DispoChoice.length > 0) && (scheduled_callbacks > 0) && (DispoChoice != 'CBHOLD') )
					...
					if ( (comments_callback_screen == 'ENABLED') || (comments_callback_screen == 'REPLACE_CB_NOTES') )
						...
						cb_comment_output = cb_comment_output + "<div class='col-lg-7'><textarea name=\"cbcomment_comments\" id=\"cbcomment_comments\" rows=\"2\" cols=\"100\" class=\"form-control\" value=\"\">" + document.vicidial_form.dispo_comments.value + "</textarea></div>\n";
				...
				//	alert('hi1');
					...
					document.getElementById("DispoSelectHAspan").innerHTML = "<a class='btn btn-info col-lg-12' href=\"#\" onclick=\"DispoHanguPAgaiN()\"><?php echo _QXZ("Hangup Again"); ?></a>";
					//alert('hi3');
	...
	function get_agents_list()
		{
			//	alert('hiii');
				...
				if (xmlhttp) 
					{ 
					RAview_query = "server_ip=" + server_ip + "&session_name=" + session_name + "&ACTION=getAgentList&format=text&user=" + user + "&pass=" + pass + "&user_group=" + VU_user_group + "&conf_exten=" + session_id + "&extension=" + extension + "&protocol=" + protocol + "&stage=" + agent_status_view_time + "&campaign=" + campaign ;
					xmlhttp.open('POST', 'vdc_db_query.php'); 
					xmlhttp.setRequestHeader('Content-Type','application/x-www-form-urlencoded; charset=UTF-8');
					...
					xmlhttp.onreadystatechange = function() 
						...
						if (xmlhttp.readyState == 4 && xmlhttp.status == 200) 
							{
						//		alert(xmlhttp.responseText);
						//		alert(document.getElementById('selectagent').innerHTML);
								document.getElementById('selectagent').innerHTML =xmlhttp.responseText;
							}
						}
					delete xmlhttp;
					}
...
// Generate the Closer In Group Chooser panel
	function CloserSelectContent_create()
		...
		if ( (VU_agent_choose_ingroups == '1') && (manager_ingroups_set < 1) )
			{
            var live_CSC_HTML = "<center><table class='tranparent_table' cellpadding=\"5\" cellspacing=\"5\" width=\"500px\"><thead><tr><td><b><?php echo _QXZ("GROUPS NOT SELECTED"); ?></b></td><td><b><?php echo _QXZ("SELECTED GROUPS"); ?></b></td></tr></thead><tr><td height=\"300px\" width=\"240px\" valign=\"top\"><font class=\"log_text\"><span id=CloserSelectAdd> &nbsp; <a href=\"#\" onclick=\"CloserSelect_change('-----ADD-ALL-----','ADD');return false;\"><b>--- <?php echo _QXZ("ADD ALL"); ?> ---</b><br />";
			var loop_ct = 0;
            ...
            live_CSC_HTML = live_CSC_HTML + "</span></font></td><td height=\"300px\" width=\"240px\" valign=\"top\"><font class=\"log_text\"><span id=CloserSelectDelete></span></font></td></tr></table></center>";
...
// Open or close the callsinqueue view bottombar
	function show_calls_in_queue(CQoperation)
		...
		if (CQoperation=='SHOW')
			{
			document.getElementById("callsinqueuelink").innerHTML = "<a class='enjoy-css_yellow' href=\"#\"  onclick=\"show_calls_in_queue('HIDE');\"><?php echo _QXZ("Hide Calls In Queue"); ?></a>";
			view_calls_in_queue_active=1;
			showDiv('callsinqueuedisplay');
			}
		else
			{
			document.getElementById("callsinqueuelink").innerHTML = "<a class='enjoy-css' href=\"#\"  onclick=\"show_calls_in_queue('SHOW');\"><?php echo _QXZ("Show Calls In Queue"); ?></a>";
	...
	function AgentsViewOpen(AVlocation,AVoperation)
		...
		if (AVoperation=='open')
			...
			if (AVlocation=='AgentViewSpan')
				...
				document.getElementById("AgentViewLink").innerHTML = "<a class=\"enjoy-css_cust col-md-12 menu_icon agent_stats\" href=\"#\" onclick=\"AgentsViewOpen('AgentViewSpan','close');return false;\"><?php echo _QXZ("Agents View"); ?> -</a>";
			...
			if (AVlocation=='AgentViewSpan')
				...
				document.getElementById("AgentViewLink").innerHTML = "<a class=\"enjoy-css_cust col-md-12 menu_icon agent_stats\" href=\"#\" onclick=\"AgentsViewOpen('AgentViewSpan','open');return false;\"><?php echo _QXZ("Agents View"); ?> +</a>";
...
// Trigger a pause on the next dispo screen only
	function next_call_pause_click()
		...
		document.vicidial_form.DispoSelectStop.checked=true;
		document.getElementById("NexTCalLPausE").innerHTML = "<a class=\"enjoy-css_yellow\"><?php echo _QXZ("Next Call Pause Set"); ?>";
		}
...
// Submitting the callback date and time to the system
	...
	?>
		...
		//	alert(CallBackDatETimE + "|" + CallBackCommenTs);
			...
			document.vicidial_form.DispoSelection.value = 'CBHOLD';
			document.vicidial_form.selectagent_new.value = document.getElementById("new_agent").value;
			hideDiv('CallBackSelectBox');
			DispoSelect_submit();
			}
		}
...
*/
	...
	function start_all_refresh()
		...
		//	if ( (agentcall_manual != '1') && (starting_dial_level > 0) )
			...
			if ( (agent_pause_codes_active=='Y') || (agent_pause_codes_active=='FORCE') )
				{
				document.getElementById("PauseCodeLinkSpan").innerHTML = "<a href=\"#\" class='enjoy-css_yellow' onclick=\"PauseCodeSelectContent_create();return false;\"><?php echo _QXZ("ENTER A PAUSE CODE"); ?></a>";
				}
		...
		//	document.getElementById("debugbottomspan").innerHTML = "custchannellive: " + custchannellive + " lastcustchannel.length: " + lastcustchannel.length + " no_empty_session_warnings: " + no_empty_session_warnings + " lead_id: |" + document.vicidial_form.lead_id.value + "|";
			...
			if (WaitingForNextStep==0)
				...
				if (customerparked==1)
					...
					document.getElementById("ParkCounterSpan").innerHTML = "<div class='col-md-12 padding-b-5'><?php echo _QXZ("Time On Park:"); ?> " + parked_mmss+"</div>";
					}
	...
	function HotKeys(HKstate) 
		...
		if ( (HKstate == 'ON') && (HKbutton_allowed == 1) )
			...
			showDiv('HotKeyEntriesBox');
			hot_keys_active = 1;
            document.getElementById("hotkeysdisplay").innerHTML = "<a href=\"#\" onMouseOut=\"HotKeys('OFF')\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_XB_hotkeysactive.gif"); ?>\" border=\"0\" alt=\"HOT KEYS ACTIVE\" /></a>";
			}
		else
			{
			hideDiv('HotKeyEntriesBox');
			hot_keys_active = 0;
            document.getElementById("hotkeysdisplay").innerHTML = "<a href=\"#\" onMouseOver=\"HotKeys('ON')\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_XB_hotkeysactive_OFF.gif"); ?>\" border=\"0\" alt=\"HOT KEYS INACTIVE\" /></a>";
			}
		}
...
//hideDiv('comments');
			document.getElementById("viewcommentsdisplay").innerHTML = "<input class=\"pull-left space\" type=\"button\" id='ViewCommentButton' value='0' onClick=\"ViewComments('ON')\">";
<!-- <div class=\"col-lg-10 no-padding space pull-right\"><textarea style=\"resize: none;margin-left: -34px;\" name=\"comments\" id=\"comment\" rows=\"1\" cols=\"85\" class=\"pull-left form-control\" value=\"\"></textarea></div> -->
			...
			if (comments_all_tabs == 'ENABLED')
				{
				document.getElementById("otherviewcommentsdisplay").innerHTML = "<input class=\"space\"  type=\"button\" id='OtherViewCommentButton' value='0' onClick=\"ViewComments('ON')\">";
	...
	function ShoWTransferMain(showxfervar,showoffvar)
		...
		if (VU_vicidial_transfers == '1')
			...
			if (showxfervar == 'ON')
                ...
                document.getElementById("XferControl").innerHTML = "<a href=\"#\" onclick=\"ShoWTransferMain('OFF','YES');\"><img class='img' src=\"./images/<?php echo _QXZ("vdc_LB_transferconf.gif"); ?>\" border=\"0\" alt=\"Transfer - Conference\" /></a>";
...
<!--
	...
	div.noscroll_script {height: <?php echo $SSheight ?>px; width: <?php echo $SDwidth ?>px; overflow: hidden; font-size: 12px;  font-family: sans-serif;}
-->
</style>
<?php
echo "</head>\n";
...
<div class="col-md-2">
 <div class="sidebar-logo">
            <div class="logo" >
                <a href="index2.html"><img src="images/logo.png" style="height:50px;"></a>
            </div>
          </div>
</div>
...
<div id="head-nav" class="navbar navbar-default">
    <div class="container-fluid">
      <div class="navbar-collapse" style="border-left:1px solid #e8e8e8;">
 	 <ul class="nav navbar-nav navbar-right user-nav">
            <li class="dropdown profile_menu" >			
				<span style="color:#f7a1a1;"><a onclick="NormalLogout();return false;needToConfirmExit = false;" href="#">Sign Out</a></span>
		</a>
		
		</li>
	</ul>
	<ul class="nav navbar-nav not-nav navbar-right">
		<li class="li_padding button dropdown" style="padding: 10px 5px 0px !important;">
             	<span style="">
		<span id="MainStatuSSpan" style="">
	        </span>
		...
		<li class="li_padding button dropdown" style="border-left:1px solid #e8e8e8;">
			<span id="status" style="">2015-12-31 12:30:28</span>
		</li>
...
<div class="col-xs-3">
 <div class="sidebar-logo">
            <div class="logo">
                <a href="index2.html"><img class="img_responce" src="images/logo.png"></a>
            </div>
          </div>
</div>
<div class="col-xs-10 no-padding">
          
<div id="head-nav" class="col-md-12 navbar navbar-default">
    <div class="container-fluid">
      <div class="navbar-collapse">
 <ul class="nav navbar-nav not-nav navbar-left col-md-8">
        <li class="col-md-12 li_padding button dropdown">
         <span style=""> <span id="MainStatuSSpan" style="word-break: break-all;word-wrap: break-word;font-size: 14px;width: 84%;float: left;" ></span><span id=timer_alt_display></span><span id="busycallsdebug"></span> <img src="./images/<?php echo _QXZ("agc_live_call_OFF.gif"); ?>" name="livecall" alt="Live Call" width="73px" height="25px" border="0" />
</span>         
          </li>
        ...
        <ul class="nav navbar-nav navbar-right user-nav">
          <!--<li class="dropdown profile_menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img alt="Avatar" src="images/agent_profile_pic.png" /><span style="color:#f7a1a1;">Welcome User</span> <b class="caret"></b></a>
            <ul class="dropdown-menu">
              
            </ul>
          </li>-->
 <!--<li class="li_padding button dropdown">
         <span id="status" style=""><?php echo _QXZ("LIVE"); ?></span>
          </li>
<li><a href="#" onclick="NormalLogout();return false;needToConfirmExit = false;" class='no-padding'>
<img alt="Avatar" src="./images/logout.png" height=35 width=100 /></a></li>
        </ul>			
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++; echo $zi ?>;" id="WrapupBox">
    <table border="1" bgcolor="#CCFFCC" width="1350px" height="1020px"><tr><td align="center"> <?php echo _QXZ("Call Wrapup:"); ?> <span id="WrapupTimer"></span> <?php echo _QXZ("seconds remaining in wrapup"); ?><br /><br />
...
<span class="content_width container-fluid" style="position: absolute; z-index:<?php $zi++; echo $zi ?>; display: block; left: 0px; top: 0px; visibility: visible;" id="callsinqueuedisplay">
      				...
      				<div class="side_space1">
        				<div class="block-flat no-margin-bottom" >
							...
							<div class="content no-padding">
								<div style="overflow:scroll;height:433px;" class="col-lg-12 space">
									<center>
...
<span style="position:absolute;left:0px;top:13px;z-index:<?php $zi++; echo $zi ?>;" id="Tabs">
   <!-- <table border="0" bgcolor="#FFFFFF" width="<?php echo $MNwidth ?>px" height="30px">
    ...
    {echo "<td align=\"left\" width=\"67px\"><a href=\"#\" onclick=\"FormPanelToFront();\"><img class='img' src=\"./images/"._QXZ("vdc_tab_form.gif")."\" alt=\"FORM\" width=\"67px\" height=\"30px\" border=\"0\" /></a></td>\n";}
	?>
	<?php if ($email_enabled > 0)
    {echo "<td align=\"left\" width=\"67px\"><a href=\"#\" onclick=\"EmailPanelToFront();\"><img class='img' src=\"./images/"._QXZ("vdc_tab_email.gif")."\" alt=\"EMAIL\" width=\"67px\" height=\"30px\" border=\"0\" /></a></td>\n";}
	?>
    <td width="<?php echo $HSwidth ?>px" valign="middle" align="center"><font class="body_text">&nbsp; <span id="status"><?php echo _QXZ("LIVE"); ?></span>&nbsp; &nbsp; </td>
...
<?php 
$customer_menues='<div class="pull-left padding-b-5">
				<a onclick="MainPanelToFront(\'NO\');" href="#">
				<div class="enjoy-css_cust col-md-12">Customer</div>
				</a>
				</div>
				<div class="pull-left padding-b-5">
				<a onclick="ScriptPanelToFront();" href="#">
				<div class="enjoy-css_cust col-md-12">Script</div>
				</a>
				</div>';
...
if ($custom_fields_enabled > 0){
	$customer_menues.='<div class="pull-left padding-b-5">
					...
					<div class="enjoy-css_cust col-md-12">Form</div>
					</a>
				</div>';
}
if ($email_enabled > 0){
	$customer_menues.='<div class="pull-left padding-b-5">
					...
					<div class="enjoy-css_cust col-md-12">Email</div>
					</a>
				</div>';
}
if ($chat_enabled > 0)
		...
		# INTERNAL CHAT
		$customer_menues.='<div class="pull-left padding-b-5">
					<a onclick="InternalChatContentsLoad(\'YES\');" href="#">
					<div class="enjoy-css_cust col-md-12">Chat Internal</div>
					</a>
				</div>'; 
		$customer_menues.='<div class="pull-left padding-b-5">
					<a onclick="CustomerChatPanelToFront(\'1\',\'YES\');" href="#">
					<div class="enjoy-css_cust col-md-12">Chat Customer</div>
					</a>
				</div>'; 
	}
?>
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++; echo $zi ?>;" id="MainPanel">
     <div class="no-padding" border="0" id="MainTable">
       <div class="cl-sidebar border pull-left" id='left_sidebar'>
    	     ...
    	     <div class="cl-navblock">
      		<div class="menu-space">
        	   <div class="content">
      			...
      			<li>
                          <div class="head_title txt_align">Action Board</div>
                             <div class="col-md-12 padding-b-5" style='margin-top: 10px;'>
	<?php
	if ($webphone_location == 'bar')
		{
    ...
    <span style="background-color: #CCFFCC" id="DiaLControl">
		<a class="enjoy-css" href="#" onclick="ManualDialNext('','','','','','0')">
			<img class='img' src="./images/<?php echo _QXZ("vdc_LB_dialnextnumber_OFF.gif"); ?>" border="0" alt="Dial Next Number" />
		</a>
	</span>
	</div>
	</font>
	...
	<span id="ManualQueueChoice"></span>
     <div class='col-md-12 padding-b-5'><span id="DiaLLeaDPrevieW"><font class="preview_text"> <input type="checkbox" name="LeadPreview" size="1" value="0" /> <?php echo _QXZ("LEAD PREVIEW"); ?><br /></font></span></div>
    ...
    <div class='col-md-12 padding-b-5 '><span id="NexTCalLPausE"> <a class="enjoy-css_yellow" href="#" onclick="next_call_pause_click();return false;"><?php echo _QXZ("Next Call Pause"); ?></a> <br /></span></div>
...
<div class='col-md-12 padding-b-5'><a href="#" onclick="NeWManuaLDiaLCalL('FAST','','','','','YES');return false;" class="enjoy-css_yellow" ><font size="2"><?php echo _QXZ("Fast Dial"); ?></font></a></div>
<div class='col-md-12 padding-b-5'><span id="MDstatusSpan"><a href="#" class="enjoy-css_perrot"  onclick="NeWManuaLDiaLCalL('NO','','','','','YES');return false;"><font size="2"><?php echo _QXZ("Manual Call"); ?></font></a></span> </div>
</font></span>
    ...
    <div class='col-md-12 padding-b-5'></div><span style="background-color: <?php echo $MAIN_COLOR ?>" id="RecorDControl"><a href="#" onclick="conf_send_recording('MonitorConf',session_id,'','','','YES');return false;"><img class='img' src="./images/<?php echo _QXZ("vdc_LB_startrecording.gif"); ?>" border="0" alt="Start Recording" /></a></span><br /></div>
    <!--<span id="SpacerSpanA"><img src="./images/<?php echo _QXZ("blank.gif"); ?>" width="145px" height="16px" border="0" /></span><br />-->
    </center><br><div class='col-md-6 padding-b-5'><span style="background-color: #FFFFFF" id="WebFormSpan"><img class='img' src="./images/<?php echo _QXZ("vdc_LB_webform_OFF.gif"); ?>" border="0" alt="Web Form" /></span></div>
	<?php
	if ($enable_second_webform > 0)
        {echo "<div class='col-md-6 padding-b-5'><span style=\"background-color: #FFFFFF\" id=\"WebFormSpanTwo\"><img class='img' src=\"./images/"._QXZ("vdc_LB_webform_two_OFF.gif")."\" border=\"0\" alt=\"Web Form 2\" /></span><br /></div>\n";}
	if ($enable_third_webform > 0)
        {echo "<div class='col-md-6 padding-b-5'><span style=\"background-color: #FFFFFF\" id=\"WebFormSpanThree\"><img class='img' src=\"./images/"._QXZ("vdc_LB_webform_three_OFF.gif")."\" border=\"0\" alt=\"Web Form 3\" /></span><br /></div>\n";}
	?>
    <div id="ParkCounterSpan"></div>
     <div class='col-md-6 padding-b-5'><span style="background-color: <?php echo $MAIN_COLOR ?>" id="ParkControl"><img class='img' src="./images/<?php echo _QXZ("vdc_LB_parkcall_OFF.gif"); ?>" border="0" alt="Park Call" /></span><br /></div>
	<?php
	if ( ($ivr_park_call=='ENABLED') or ($ivr_park_call=='ENABLED_PARK_ONLY') )
		...
		{echo " <div class='col-md-6 padding-b-5'><span style=\"background-color: $MAIN_COLOR\" id=\"ivrParkControl\"></span></div>\n";}
	?>
     <div class='col-md-12 padding-b-5'><span style="background-color: <?php echo $MAIN_COLOR ?>" id="XferControl"><img class='img' src="./images/<?php echo _QXZ("vdc_LB_transferconf_OFF.gif"); ?>" border="0" alt="Transfer - Conference" /></span><br /></div>
    ...
    <div class='col-md-12 padding-b-5'><span style="background-color: #FFCCFF" id="HangupControl"><img class='img' src="./images/<?php echo _QXZ("vdc_LB_hangupcustomer_OFF.gif"); ?>" border="0" alt="Hangup Customer" /></span><br /></div>
    <!--<span id="SpacerSpanD"><img src="./images/<?php echo _QXZ("blank.gif"); ?>" width="145px" height="16px" border="0" /></span><br />-->
    <div class="text_input" id="SendDTMFdiv"><div class='col-md-12 no-padding'>
		<div class='col-md-6 padding-b-5'><span style="background-color: <?php echo $MAIN_COLOR ?>" id="SendDTMF"><a href="#" onclick="SendConfDTMF(session_id,'YES');return false;"><img class='img' src="./images/<?php echo _QXZ("vdc_LB_senddtmf.gif"); ?>" border="0" alt="Send DTMF" align="bottom" /></a> </div>
		<div class='col-md-6 padding-b-5'> <input style="height:33px;" type="text" size="5" name="conf_dtmf" class="form-control" value="" maxlength="50" /></div></span></div>
	</div><br />


<div class='col-md-12 padding-b-5'><span id="CallbacksButtons"><font size="2">
<span id="CBstatusSpan"><?php echo _QXZ("X ACTIVE CALLBACKS"); ?></span>
</font></span></div>
<div class='col-md-6 padding-b-5'><span id="CallLogButtons"><font size="2">
<span id="CallLogLinkSpan"><a class="enjoy-css_yellow" href="#" onclick="VieWCalLLoG();return false;"><?php echo _QXZ("VIEW CALL LOG"); ?></a></span> <br />
</font></span></div>

<div class='col-md-6 padding-b-5'>
	<span id="AgentAlertSpan"><font size="2">
	<?php
	if ( (preg_match('/ON/',$VU_alert_enabled)) and ($AgentAlert_allowed > 0) )
		{echo "<a class=\"enjoy-css\" href=\"#\" onclick=\"alert_control('OFF');return false;\">"._QXZ("Alert is ON")."</a>";}
	else
		{echo "<a class=\"enjoy-css_yellow\" href=\"#\" onclick=\"alert_control('ON');return false;\">"._QXZ("Alert is OFF")."</a>";}
	?></font>
	</span>
</div>
...
<div class="col-md-12 padding-b-5">
	...
	if ( ($agent_lead_search == 'ENABLED') or ($agent_lead_search == 'LIVE_CALL_INBOUND') or ($agent_lead_search == 'LIVE_CALL_INBOUND_AND_MANUAL') )
		{echo "<a class='enjoy-css_yellow' href=\"#\" onclick=\"OpeNSearcHForMDisplaYBox();return false;\">Lead Search</a>";}?>
...
<div class='col-md-12 padding-b-5'>
<span id="PauseCodeButtons"><font size="2">
...
<div class='col-md-12 padding-b-5'>
		<?php if ($INgrpCT > 0) {echo "<a class='enjoy-css_yellow col-lg-12' href=\"#\" onclick=\"OpeNGrouPSelectioN();return false;\">"._QXZ("GROUPS")."</a> &nbsp; &nbsp; \n";} ?>
	</div>
	
	<div class="col-md-12 padding-b-5" id="callsinqueuelink">
	<?php 
	if ($view_calls_in_queue > 0)
		{ 
		if ($view_calls_in_queue_launch > 0) 
			{echo "<a class='enjoy-css_yellow' href=\"#\" onclick=\"show_calls_in_queue('HIDE');\">"._QXZ("Hide Calls In Queue")."</a>\n";}
		else 
			{echo "<a class='enjoy-css' href=\"#\" onclick=\"show_calls_in_queue('SHOW');\">"._QXZ("Show Calls In Queue")."</a>\n";}
		}
	?>
	
	</div>

<span class="content_width container-fluid" style="position: absolute; z-index: 44; display: block; left: 0px; top: 500px; visibility: visible; width: 880.017px;" id="HotKeyEntriesBox">
	<div class="col-lg-11">
	<div class="col-lg-12 no-padding">
	<div id="" class="col-md-12 container-fluid">
	<div class="cl-mcont">
	<div class="row">
	<div class="side_space1">
	<div class="block-flat no-margin-bottom">
	<div class="header no-border box-shadow">
		<h3>Disposition Hot Keys:</h3>
	</div>
	<div class="content no-padding">
		<div class="col-lg-12 space" >
		<center>
		<table class="hover" border="0" bgcolor="#FFDD99" height="70px">
		<thead>
			<tr>
				<td width="200px">
				  <?php echo _QXZ("Disposition Hot Keys:"); ?> </font>
				</td>
				<td colspan="2">
					<font class="body_small"><?php echo _QXZ("When active, simply press the keyboard key for the desired disposition for this call. </br>The call will then be hungup and dispositioned automatically:"); ?></font>
				</td>
			</tr>
			<tr>
    				<td width="200px">
...
<span id="hotkeysdisplay"><a href="#" onMouseOver="HotKeys('ON')"><img class='img' src="./images/<?php echo _QXZ("vdc_XB_hotkeysactive_OFF.gif"); ?>" border="0" alt="HOT KEYS INACTIVE" /></a></span>
<?php } ?>
</div>
...
<span style="" id="VolumeControlSpan">
	<span id="VolumeUpSpan" class="pull-left r-t-l"><img class='img' src="./images/<?php echo _QXZ("vdc_volume_up_off.gif"); ?>" border="0" /></span>
	<span id="VolumeDownSpan" class="pull-left"><img class='img' src="./images/<?php echo _QXZ("vdc_volume_down_off.gif"); ?>" border="0" /></span>
	<span id="AgentMuteSpan" class="pull-right"></span>
</span>
</div>-->
   ...
   <input type="hidden" name="email_row_id" id="email_row_id" value="" />
	...
	<span class="text_input col-sm-10" id="MainPanelCustInfo" style="padding:0px;">
<div class="content_width container-fluid" id="pcont">
   <!-- TOP NAVBAR -->
   
	<div class="cl-mcont">
    
    		
    <div class="row no-margin" id='main_section1'>
     
      <div class="col-md-12">
        <div class="block-flat" id='main_section2'>
          <div class="header no-border box-shadow">							
...
<span id="SecondSspan" style='float:right;'>
<div class="body_text"> <?php echo _QXZ("seconds:"); ?> 
<span id="SecondSDISP"> &nbsp; &nbsp; </span></div>
</span>

<div class="pull-left col-sm-1" style="margin-left:-10px;"><span id="CusTInfOSpaN"></span></div> &nbsp; &nbsp; &nbsp; &nbsp; 
	<!--<?php
	if ( ($agent_lead_search == 'ENABLED') or ($agent_lead_search == 'LIVE_CALL_INBOUND') or ($agent_lead_search == 'LIVE_CALL_INBOUND_AND_MANUAL') )
		{echo "<a href=\"#\" onclick=\"OpeNSearcHForMDisplaYBox();return false;\"><img class='img' src=\"./images/vicidial_button/lead_serch.gif\" alt=\"Lead Search\"/></a></font>";}?>-->
          ...
          <div class="content no-padding">
	  <div class='col-sm-12 space no-padding' style="height:430px;overflow-y:scroll;">
    
    	<div class='col-md-12 no-padding'><div class='col-md-6 no-padding space'>
<div class='col-lg-12 no-padding'><div class='col-lg-5 l-t-r'><span class='size'><?php echo _QXZ("Customer Time:"); ?></span></div><div class='col-lg-7 pl-t-r'><span name="custdatetime" id="custdatetime" class="log_title"> </span></div></div></div><div class='col-md-6 no-padding space'><div class='col-lg-12 no-padding'><div class='col-lg-3 l-t-r'><span class='size'><?php echo _QXZ("Channel:"); ?></span></div><div class='col-lg-8 pl-t-r'> <span name="callchannel" id="callchannel" class=""> </span></div></div></div>
    	</div>
...
echo "<div class=''><div class=''>";
	if ($label_title == '---HIDE---')
        ...
        {echo "<div class='col-sm-1 l-t-r'><span class='size'>$label_title: </span></div><div class='col-lg-1' style='padding-left:0px;'><input type=\"text\" size=\"4\" name=\"title\" id=\"title\" maxlength=\"4\" class=\"form-control\" value=\"\" /></div>";}

	if ($label_first_name == '---HIDE---')
        {echo "<input type=\"hidden\" name=\"first_name\" id=\"first_name\" value=\"\" />";}
	else
        {echo "<div class='pull-left'><span class='size'>$label_first_name: </span></div><div class='col-lg-3 no-padding'><input type=\"text\" size=\"17\" name=\"first_name\" id=\"first_name\" maxlength=\"30\" class=\"form-control\" value=\"\" /></div>";}
echo "</div></div>";
...
echo "<div class=''><div class=''>";
	if ($label_middle_initial == '---HIDE---')
        ...
        {echo "<div class='pull-left'><span class='size'>$label_middle_initial: </span></div><div class='col-lg-2' style='padding-left:0px;'><input type=\"text\" size=\"1\" name=\"middle_initial\" id=\"middle_initial\" maxlength=\"1\" class=\"form-control\" value=\"\" /></div>";}
	if ($label_last_name == '---HIDE---')
        {echo " <input type=\"hidden\" name=\"last_name\" id=\"last_name\" value=\"\" />";}
	else
        {echo "<div class='pull-left'><span class='size'>$label_last_name: </span></div><div class='col-lg-2 no-padding'><input type=\"text\" size=\"23\" name=\"last_name\" id=\"last_name\" maxlength=\"30\" class=\"form-control\" value=\"\" /></div>";}
	echo "</div></div>";
?>
</div>
...
<?php	
	if ($label_address1 == '---HIDE---')
        ...
        {echo "<div class='col-lg-12 no-padding'> 
                          ...
                          <div class='col-sm-1 l-t-r'><span class='size'>$label_address1:</span></div>
                          <div class='col-sm-11 no-padding'> <input type=\"text\" size=\"85\" name=\"address1\" id=\"address1\" maxlength=\"100\" class=\"form-control\" value=\"\" /></div>
                       
                     </div>";}
	echo '</div><div class="col-md-12 no-padding">';
//    echo "</td></tr><tr><td align=\"right\"><font class=\"body_text\">";
	...
	if ($label_address2 == '---HIDE---')
        ...
        {echo "<div class=\"col-md-6 no-padding space\"><div class='col-lg-12 no-padding'> 
                        
                          <div class='col-lg-3 l-t-r'><span class='size'>$label_address2:</span></div>
                          <div class='col-lg-8  no-padding'> <input type=\"text\" size=\"20\" name=\"address2\" id=\"address2\" maxlength=\"100\" class=\"form-control\" value=\"\" /></div>
                        </div>
                     </div>";}
  ...
  //  echo "</td><td align=\"right\"><font class=\"body_text\">";
	...
	if ($label_address3 == '---HIDE---')
        ...
        {echo "<div class='col-md-6 no-padding space'> 
                        <div class='col-lg-12 no-padding'>
                          <div class='col-lg-3 l-t-r'><span class='size'>$label_address3:</span></div>
                          <div class='col-lg-8  no-padding' style=\"margin-left:11px;\"> <input type=\"text\" size=\"45\" name=\"address3\" id=\"address3\" maxlength=\"100\" class=\"form-control\" value=\"\" /></div>
                        </div>
                     </div>";}
?>
</div>
...
<?php
   // echo "</td></tr><tr><td align=\"right\"><font class=\"body_text\">";
	...
	if ($label_city == '---HIDE---')
        ...
        {echo "<div class='col-md-4 no-padding space'> 
                        <div class='col-lg-12 no-padding'>
                          <div class='col-lg-4 l-t-r'><span class='size'>$label_city:</span> </div>
                          <div class='col-lg-8 pl-t-r'> <input type=\"text\" size=\"20\" name=\"city\" id=\"city\" maxlength=\"50\" class=\"form-control\" value=\"\" /></div>
                        </div>
                     </div>";}
	...
	if ($label_state == '---HIDE---')
        ...
        {echo "<div class='col-md-4 no-padding space'> 
                        <div class='col-lg-12 no-padding'>
                          <div class='col-lg-4 l-t-r'><span class='size'>$label_state: </span></div>
                          <div class='col-lg-8 pl-t-r'> <input type=\"text\" size=\"4\" name=\"state\" id=\"state\" maxlength=\"2\" class=\"form-control\" value=\"\" /></div>
                        </div>
                     </div>";}
 ...
 //   echo "</td><td align=\"right\"><font class=\"body_text\">";
	...
	if ($label_postal_code == '---HIDE---')
        ...
        {echo "<div class='col-md-4 no-padding space'> 
                        <div class='col-lg-12 no-padding'>
                          <div class='col-lg-4 l-t-r'><span class='size'>$label_postal_code: </span></div>
                          <div class='col-lg-8 pl-t-r'> <input type=\"text\" size=\"14\" name=\"postal_code\" id=\"postal_code\" maxlength=\"10\" class=\"form-control\" value=\"\" /></div>
                        </div>
                     </div>";}
?>
</div>
...
<?php    //echo "</td></tr><tr><td align=\"right\"><font class=\"body_text\">";
	...
	if ($label_province == '---HIDE---')
        ...
        {echo "<div class='col-md-4 no-padding space'> 
                        <div class='col-lg-12 no-padding'>
                          <div class='col-lg-4 l-t-r'><span class='size'>$label_province:</span> </div>
                          <div class='col-lg-8 pl-t-r'> <input type=\"text\" size=\"20\" name=\"province\" id=\"province\" maxlength=\"50\" class=\"form-control\" value=\"\" /></div>
                        </div>
                     </div>";}
   ...
   // echo "</td><td align=\"right\"><font class=\"body_text\">";
	...
	if ($label_vendor_lead_code == '---HIDE---')
        ...
        {echo "<div class='col-md-4 no-padding space'> 
                        <div class='col-lg-12 no-padding'>
                          <div class='col-lg-4 l-t-r'><span class='size'>$label_vendor_lead_code:</span> </div>
                          <div class='col-lg-8 pl-t-r'> <input type=\"text\" size=\"15\" name=\"vendor_lead_code\" id=\"vendor_lead_code\" maxlength=\"20\" class=\"form-control\" value=\"\" /></div>
                        </div>
                     </div>";}
...
//    echo "</td><td align=\"right\"><font class=\"body_text\">";
	...
	if ($label_gender == '---HIDE---')
		...
		echo "<div class='col-md-4 no-padding space'> 
                        <div class='col-lg-12 no-padding'>
                          <div class='col-lg-4 l-t-r'><span class='size'></span></div>
                          <div class='col-lg-8 pl-t-r'><span id=\"GENDERhideFORie\"><input type=\"hidden\" name=\"gender_list\" id=\"gender_list\" value=\"\" /></span></div>
                        </div>
                     </div>";
		}
	else
		...
		echo "<div class='col-md-4 no-padding space'> 
                        <div class='col-lg-12 no-padding'>
                          <div class='col-lg-4 l-t-r'><span class='size'>$label_gender:</span></div>
                          <div class='col-lg-8 pl-t-r'> <span id=\"GENDERhideFORie\"><select size=\"1\" name=\"gender_list\" class=\"form-control\" id=\"gender_list\"><option value=\"U\">"._QXZ("U - Undefined")."</option><option value=\"M\">"._QXZ("M - Male")."</option><option value=\"F\">"._QXZ("F - Female")."</option></select></span></div>
                        </div>
                     </div>";
		}
...
<?php
	if ($label_phone_number == '---HIDE---')
		...
		echo "<div class='col-md-4 no-padding space'> 
                        <div class='col-lg-12 no-padding'>
                          <div class='col-lg-4 l-t-r'><span class='size'>$label_phone_number:</span> </div>
                          <div class='col-lg-8 pl-t-r'> ";
		...
		if ( (preg_match('/Y/',$disable_alter_custphone)) or (preg_match('/HIDE/',$disable_alter_custphone)) )
			...
			{
			echo "<input type=\"text\" size=\"20\" name=\"phone_number\" id=\"phone_number\" maxlength=\"16\" class=\"form-control\" value=\"\" /></div>
                        </div>
                     </div>";
			}
		}
  ...
  //  echo "</td><td align=\"right\"><font class=\"body_text\">";
	...
	if ($label_phone_code == '---HIDE---')
        ...
        {echo "<div class='col-md-4 no-padding space'> 
                        <div class='col-lg-12 no-padding'>
                          <div class='col-lg-4 l-t-r'><span class='size'>$label_phone_code:</span></div>
                          <div class='col-lg-8 pl-t-r'> <input type=\"text\" size=\"4\" name=\"phone_code\" id=\"phone_code\" maxlength=\"10\" class=\"form-control\" value=\"\" /></div>
                        </div>
                     </div>";}
  ...
  //  echo "</td><td align=\"right\"><font class=\"body_text\">";
	...
	if ($label_alt_phone == '---HIDE---')
        ...
        {echo "<div class='col-md-4 no-padding space'> 
                        <div class='col-lg-12 no-padding'>
                          <div class='col-lg-4 l-t-r'><span class='size'>$label_alt_phone:</span></div>
                          <div class='col-lg-8 pl-t-r'>  <input type=\"text\" size=\"14\" name=\"alt_phone\" id=\"alt_phone\" maxlength=\"16\" class=\"form-control\" value=\"\" /></div>
                        </div>
                     </div>";}
?>
...
<?php
   // echo "</td></tr><tr><td align=\"right\"><font class=\"body_text\">";
	...
	if ($label_security_phrase == '---HIDE---')
        ...
        {echo "<div class='col-md-6 no-padding space'> 
                        	<div class='col-lg-12 no-padding'>
                              <div class='col-lg-3 l-t-r'><span class='size'>$label_security_phrase: </span></div>
                              <div class='col-lg-8  no-padding'><input type=\"text\" size=\"20\" name=\"security_phrase\" id=\"security_phrase\" maxlength=\"100\" class=\"form-control\" value=\"\" /></div>
                            </div>
                        </div>";}
   ...
   // echo "</td><td align=\"right\"><font class=\"body_text\">";
	...
	if ($label_email == '---HIDE---')
        ...
        {echo "<div class='col-md-6 no-padding space'> 
                        	<div class='col-lg-12 no-padding'>
                              <div class='no-padding padding5 col-lg-2 '><span class='size'>$label_email: </span></div>
                              <div class='col-lg-8 no-padding' style=\"margin-left:30px;\"><input type=\"text\" size=\"45\" name=\"email\" id=\"email\" maxlength=\"70\" class=\"form-control\" value=\"\" /></div>
                            </div>
                        </div>";}
	...
	if ($label_comments == '---HIDE---')
      ...
      //  echo " </td><td align=\"left\" colspan=5>";
        ...
        echo "<div class='col-lg-12 no-padding space'>
			...
			<span id='viewcommentsdisplay' class=\"col-md-12 pull-left\">
...
echo "<textarea style=\"resize: none;\" name=\"comments\" id=\"comments\" rows=\"1\" cols=\"85\" class=\"pull-left form-control\" value=\"\"></textarea></div>
                    </div>
...
?>
	...
	<div class='col-lg-12 no-padding space'><span style="display:none;position:absolute;left:600px;top:<?php echo $QLheight ?>px;z-index:<?php $zi++; echo $zi ?>;" id="callsinqueuelink"><font class="body_text"><span id='callsinqueuelink'></span> <br /></font>
<?php 
if ($view_calls_in_queue > 0)
	{ 
	if ($view_calls_in_queue_launch > 0) 
...
<div class="cl-sidebar border" style="width: 25%;">
    ...
    <div class="cl-navblock">
      <div class="menu-space">
        <div class="content">
			...
			<span id="DispoSelectBox">
 <ul class="cl-vnavigation" style="min-height: 500px;width:214px;">
       
            <li>
    <div class='head_title txt_align dispo_align' style="width:252px;"><?php echo _QXZ("DISPOSITION CALL :"); ?><span id="DispoSelectPhonE"></span></div>
	</li>
<div class="col-md-12 no-padding"><div  style="padding-top:5px;width:252px;overflow-y:scroll;overflow-x:hidden;height:550px;direction: ltr;float:left;z-index: 100;">
<div class='col-lg-12 no-padding'><span id="DispoSelectHAspan"><a href="#" onclick="DispoHanguPAgaiN()" class='btn btn-info col-lg-12'><?php echo _QXZ("Hangup Again"); ?></a></span></div>
<li>
<div class='col-md-12'>
<!--<div class='disp'><span id="DispoSelectMaxMin"><a href="#" onclick="DispoMinimize()"> <?php echo _QXZ("minimize"); ?> </a></span><br /></div>-->
	<?php
	if ($webphone_location == 'bar')
	...
	<input type="hidden" name="selectagent_new" id="selectagent_new" />
    <input type="hidden" name="DispoSelection" id="DispoSelection" /><br />
	
	</li>
<!--</div>-->
<div class='col-md-12 no-padding'>
    <span class="side_label"> <input type="checkbox" name="DispoSelectStop" id="DispoSelectStop" size="1" value="0" /> <label><?php echo _QXZ("PAUSE AGENT DIALING"); ?> </label></span><br />
	</div>
	<div class='col-md-12'><a href=\"" + TEMP_VDIC_web_form_address + "\" target="_blank" onclick="DispoSelectContent_create('','ReSET');return false;" class='btn btn-info col-md-6'><?php echo _QXZ("CLEAR FORM"); ?></a> 
	<a href="#" onclick="DispoSelect_submit();return false;"  class='btn btn-info col-md-5'><?php echo _QXZ("SUBMIT"); ?></a>
	</div>
    <br /><br />
	<div class='col-md-12 no-padding'>
	<a href="#" onclick="WeBForMDispoSelect_submit();return false;"  class='btn btn-info col-md-11'><?php echo _QXZ("WEB FORM SUBMIT"); ?></a>
	</div>
    <br /><br /> &nbsp;
</div>        
          </ul>
...
<span style="width:100%;position:absolute;left:0px;z-index:<?php $zi++; echo $zi ?>;top:851px;" id="MaiNfooterspan" class="table_bg">
<span id="blind_monitor_notice_span"><b><font color="red"> &nbsp; &nbsp; <span id="blind_monitor_notice_span_contents"></span></font></b></span>
   ...
   <!-- <tr><td colspan="3"><span id="outboundcallsspan"></span></td></tr>-->
	...
	<!--<span style="position:absolute;left:0px;top:630px;z-index:<?php $zi++; echo $zi ?>;" id="MaiNfooterspan" class="table_bg">
<span id="blind_monitor_notice_span"><b><font color="red"> &nbsp; &nbsp; <span id="blind_monitor_notice_span_contents"></span></font></b></span>
    <table bgcolor="<?php echo $MAIN_COLOR ?>" id="MaiNfooter" width="<?php echo $MNwidth ?>px"><tr height="32px"><td height="32px">
		<!--<font face="Arial,Helvetica" size="1"><?php //echo _QXZ("VERSION:"); ?> <?php //echo $version ?> &nbsp; <?php //echo _QXZ("BUILD:"); ?> <?php //echo $build ?> &nbsp; &nbsp; <?php //echo _QXZ("Server:"); ?> <?php //echo $server_ip ?>  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</font>-->
...
<!--<span style="position:absolute;left:1105px;top:<?php echo $AVTheight ?>px;height:500px;overflow:scroll;z-index:<?php $zi++; echo $zi ?>;background-color:<?php echo $SIDEBAR_COLOR ?>;" id="AgentViewSpan">
<table cellpadding="0" cellspacing="0" border="0">
	<tr>
	<td align="center">
<?php echo _QXZ("Other Agents Status:"); ?> </td>
</tr><tr><td align="center"><span id="AgentViewStatus">&nbsp;</span></td></tr></table></span>-->
<div id='agentdetailspannew'>
<span class="col-md-push-10" style="position:absolute;height:750px;overflow:scroll;z-index:<?php $zi++; echo $zi ?>;min-width:18.4%;" id="AgentViewSpan">
<table style="width:100%;" cellpadding="0" cellspacing="0" border="0">
	<tr>
	<div class="head_title txt_align" align="center">
<?php echo _QXZ("Other Agents Status:"); ?> </div>
</tr><tr><td align="center"><span id="AgentViewStatus">&nbsp;</span></td></tr></table></span></div>
...
if ($webphone_location == 'bar')
	...
	{
    echo "<span style=\"position:absolute;left:1250px;top:15px;height:500px;overflow:scroll;z-index:$zi;background-color:$SIDEBAR_COLOR;\" id=\"webphoneSpan\"><table cellpadding=\"$webphone_pad\" cellspacing=\"0\" border=\"0\"><tr><td width=\"5px\" rowspan=\"2\">&nbsp;</td><td align=\"center\"><font class=\"body_text\">
    Web Phone: &nbsp; </font></td></tr><tr><td align=\"center\"><span id=\"webphonecontent\">$webphone_content</span></td></tr></table></span>\n";
	}
?>

<div id='agentviewdetail_new'>
<span class="col-md-push-10 col-xs-3" style="position:absolute;top:770px;z-index:<?php $zi++; echo $zi ?>;" id="AgentViewLinkSpan">
<div class="col-md-10 col-md-push-2">
	
			<span id="AgentViewLink">
				<a class="enjoy-css_cust col-md-12 menu_icon agent_stats" href="#" onclick="AgentsViewOpen('AgentViewSpan','open');return false;"><?php echo _QXZ("Agents View +"); ?></a>
			</span>
</div>
</span>
</div>
...
<font class="body_small"><span style="position:absolute;left:570px;top:603px;z-index:<?php $zi++; echo $zi ?>;" id="dialableleadsspan">
<?php 
...
<span class="content_width container-fluid" style="position: absolute; z-index: 46; display: block; left: 255px; top: 0px; visibility: visible;" id="ScriptPanel">
	<div class="col-lg-11 col-xs-11">
		<div id="" class="col-lg-12 container-fluid">   
			<div class="cl-mcont">
    				<div class="row">    
      					<div class="side_space1">
        					<div class="block-flat no-margin-bottom" >
			...
			<span style="z-index: 9999999; display: block; float: right; position: relative;" id="ScriptRefresH">
...
<!--- ruchita -->
	...
	?>
	<div class="content no-padding">
	<div class="col-md-12 space" style="overflow:scroll;height:432px;">
    <table style="border:none;" width="100%"><tr><td align="left" valign="top"><font class="sb_text"><div id="ScriptContents"><?php echo _QXZ("AGENT SCRIPT"); ?></div></font></td></tr></table>

	</div></div></div></div></div></div></div></div>
</span>

<span  class="content_width container-fluid" style="position:absolute;display: block;left:268px;top:<?php echo $SFheight ?>px;visibility: visible;" id="CustomerChatPanel">
	<?php
	if ($webphone_location == 'bar')
        {echo "<img src=\"./images/"._QXZ("pixel.gif")."\" width=\"1px\" height=\"".$webphone_height."px\" /><br />\n";}
	?>
<div class="col-lg-11 col-xs-11" style="z-index:<?php $zi++; echo $zi ?>;">
    <div class="col-lg-12 no-padding">
        <div id="" class="col-md-12 container-fluid">
            <div class="cl-mcont">
                <div class="row">    
...
<?php echo $customer_menues;?>
   ...
   <div id="ChatContents"><iframe src="./vdc_chat_display.php?lead_id=&list_id=&dial_method=<?php echo $dial_method; ?>&stage=WELCOME&server_ip=<?php echo $server_ip; ?>&user=<?php echo $VD_login.$VARchatgroupsURL ?>" style="background-color:transparent;" scrolling="auto" frameborder="0" allowtransparency="true" id="CustomerChatIFrame" name="CustomerChatIFrame" width="791px" height="434px" STYLE="z-index:<?php $zi++; echo $zi ?>"> </iframe></div>
</div></div></div></div></div></div>
	</div>
</span>

<span class="content_width container-fluid"  style="position:absolute;display: block;left:154px;top:0px;z-index:<?php $zi++; echo $zi ?>;visibility: visible;" id="InternalChatPanel">
	<?php
	if ($webphone_location == 'bar')
        {echo "<img src=\"./images/"._QXZ("pixel.gif")."\" width=\"1px\" height=\"".$webphone_height."px\" /><br />\n";}
	?>
...
<?php echo $customer_menues;?>
   ...
   <div id="InternalChatContents"><iframe src="./agc_agent_manager_chat_interface.php?user=<?php echo $VD_login; ?>&pass=<?php echo $VD_pass; ?>" style="background-color:transparent;" scrolling="auto" frameborder="0" allowtransparency="true" id="InternalChatIFrame" name="InternalChatIFrame" width="794px" height="433px" STYLE="z-index:<?php $zi++; echo $zi ?>"> </iframe></div>
</div></div></div></div></div></div></div>
	</div>
</span>
...
<!--Name : Ruchita Patel
Date : 13-April-2017
Change : position change for callback issue -->

<span class="content_width container-fluid" style="position: absolute; display: block; left: 0px; top: 0px; visibility: hidden;
z-index:<?php $zi++; echo $zi ?>;" id="CallBackSelectBox">
	<div class="col-lg-11 col-xs-11">
		<div class="col-lg-12 no-padding"> 
				...
				<div class="cl-mcont">
					<div class="row">
						<div class="col-md-12 side_space1">
							<div class="block-flat no-margin-bottom">
								<div class="header no-border box-shadow">
									<h3>Select a CallBack Date :</h3>		
								</div>

								<center>									

									<div class="content no-padding">
										<div style="overflow-y:scroll;height:432px;" class="col-md-12 space">
													...
													<td valign="top" align="left">
							    						...
							    						<div class="col-lg-12 no-padding">
							    							<div class="col-lg-2 no-padding">
																<label id="CallBackDatEPrinT">Select a Date Below</label> 
															</div>
															<span id="CallBackTimEPrinT"></span>

															<div class="col-lg-1 no-padding"><?php echo _QXZ("Hour:"); ?>
															</div>
														...
														<?php
	if ($agentonly_callbacks)
        {echo "<div class=\"col-lg-3 no-padding\"><input type=\"checkbox\" name=\"CallBackOnlyMe\" id=\"CallBackOnlyMe\" size=\"1\" value=\"0\" /> "._QXZ("MY CALLBACK ONLY")." </div><br />";}

	if ($comments_callback_screen != 'REPLACE_CB_NOTES')
		{
			echo "<div class=\"col-lg-12 no-padding space\"><div class=\"col-lg-2 no-padding\">"._QXZ("CB Comments:")." </div> <div class=\"col-lg-3 no-padding\"><input class=\"form-control\" type=\"text\" name=\"CallBackCommenTsField\" id=\"CallBackCommenTsField\" size=\"50\" maxlength=\"255\" /></div></div><br><br>\n";}
	else
...
<div class="col-lg-12">
	<center>
    <a class="btn btn-default" href="#" onclick="CallBackDatE_submit();return false;"><?php echo _QXZ("SUBMIT"); ?></a></center></div><br /><br />
  	<div class="col-lg-12">
...
<!---Edited bt deepu for playing recoding on click 6-7-2016 END -->
<span class="content_width container-fluid" style="position: absolute; display: block; left: 268px; top: 0px; visibility: visible;" id="FormPanel">
	<?php
	if ($webphone_location == 'bar')
        {echo "<img src=\"./images/"._QXZ("pixel.gif")."\" width=\"1px\" height=\"".$webphone_height."px\" /><br />\n";}
	?>
   <div class="col-lg-11 col-xs-11" style="z-index:50;">
    <div class="col-lg-12 no-padding">
        <div id="" class="col-md-12 container-fluid">
            <div class="cl-mcont">
                <div class="row">    
                    <div class="side_space1">
						...
						<?php echo $customer_menues;?>
								<span style="position:absolute;top:9px;left:720px;" id="FormRefresH">
								<a href="#" onclick="FormContentsLoad()"><?php echo _QXZ("reset form"); ?></a>
								</span>
							</div>
                        	
                               
	    				<div id="FormContents">
		    				<iframe src="./vdc_form_display.php?lead_id=&list_id=&stage=WELCOME" style="background-color:transparent;" scrolling="auto" frameborder="0" allowtransparency="true" id="vcFormIFrame" name="vcFormIFrame" width="100%" height="440px" STYLE="z-index:<?php $zi++; echo $zi ?>">
		    				</iframe>
	</div></div></div></div></div></div></div>
	</div>
	
					
	<span class="col-lg-11" style="position: absolute; z-index: 50; display: block;top: 0px; visibility: hidden;" id="EmailPanel">
	<div class="">
	<div id="" class="col-lg-12 container-fluid">
	<div class="cl-mcont">
	<div class="row">
	...
	<div class="header no-border box-shadow">
		...
		<div class="pull-left col-md-2 no-padding">
			<a href="#" onclick="ScriptPanelToFront();">
			<div class="enjoy-css_cust col-md-11">Script</div>
			</a>
		</div>
		<div class="pull-left col-md-2">
			<a href="#" onclick="FormPanelToFront();">
			<div class="enjoy-css_cust col-md-11">Form</div>
			</a>
		</div>
		<div class="pull-left col-md-2">
			<a href="#" onclick="EmailPanelToFront();">
			<div class="enjoy-css_cust col-md-11">Email</div>
			</a>
		</div>-->
		<?php echo $customer_menues;?>
		<span style="position:absolute;top:10px;left:92%;" id="EmailRefresH">
		<a href="#" onclick="EmailContentsLoad()"><?php echo _QXZ("refresh"); ?></a>
		</span>
	</div>
    	...
    	<tr>
    		<td align="left" valign="top">
    			<div id="EmailContents">
    				<iframe src="./vdc_email_display.php?lead_id=&list_id=&stage=WELCOME" style="background-color:transparent;" scrolling="auto" frameborder="0" allowtransparency="true" id="vcEmailIFrame" name="vcEmailIFrame" width="100%" height="422px" STYLE="z-index:<?php $zi++; echo $zi ?>">
    				</iframe>
    			</div>
    		</td>
    	</tr>
...
<!--<span style="position:absolute;top:10px;left:735px;" id="FormRefresH">
<a href="#" onclick="FormContentsLoad()"><?php echo _QXZ("reset form"); ?></a>
</span>-->

<!--<span style="position:absolute;top:10px;left:735px;" id="EmailRefresH">
<a href="#" onclick="EmailContentsLoad()"><?php echo _QXZ("refresh"); ?></a>
</span>-->
	    						</div>
	    					</div>
...
<span class="content_width container-fluid" style="position: absolute; z-index: 46; display: block; left: 255px; visibility: visible;" id="TransferMain">
  <div class="col-lg-11 col-xs-11">
  <div class="col-lg-12 container-fluid">
	  <div class="cl-mcont">
		  <div class="row">
			  <div class="col-lg-12 side_space1">
				  <div class="block-flat no-margin-bottom">
					  <div class="header no-border box-shadow">
					  <h3 class="pull-left"><?php echo _QXZ("TRANSFER CONFERENCE FUNCTIONS:"); ?></h3>
			<span id="TransferMaindiv">
    		<span id="XfeRDiaLGrouPSelecteD"></span>
     		<span id="XfeRCID"></span><br /></div>
     <div class="content no-padding">
		 <div class="col-lg-12 space" style="overflow-y:scroll;height:436px;">
	<center>
    ...
    <span id="LocalCloser"><img class='imagesize'  src="./images/<?php echo _QXZ("vdc_XB_localcloser_OFF.gif"); ?>" border="0" alt="LOCAL CLOSER" style="vertical-align:middle;margin-top:5px;" /></span> &nbsp; &nbsp;
 </td>
    <td align="left" style="width:100px;">
    <span id="HangupXferLine"><img class=''  src="./images/<?php echo _QXZ("vdc_XB_hangupxferline_OFF.gif"); ?>" border="0" alt="Hangup Xfer Line" style="vertical-align:middle" /></span>
 </td>
 </tr>

    <tr>
    <td align="left" colspan="2">
    <div class="col-md-12"><div class="col-md-4"><font style="font-size:13px;font-family:arial;">Seconds : </font></div>
    <!--<img   src="./images/<?php echo _QXZ("vdc_XB_seconds.gif"); ?>" border="0" alt="seconds" style="vertical-align:middle" />-->
    <div class="col-md-7"><input type="text" size="2" name="xferlength" id="xferlength" maxlength="4" class="form-control" readonly="readonly" /></div></div>
	&nbsp; 
    <!--<img src="./images/<?php echo _QXZ("vdc_XB_channel.gif"); ?>" border="0" alt="channel" style="vertical-align:middle" />-->
    <div class="col-md-12"><div class="col-md-4"><font style="font-size:13px;font-family:arial;">Channel : </font></div>
    <div class="col-md-7"><input type="text" size="12" name="xferchannel" id="xferchannel" maxlength="200" class="form-control" readonly="readonly" /></div></div>
 </td>
    <td align="left">
    ...
    <td align="left">
    <span id="HangupBothLines"><a href="#" onclick="bothcall_send_hangup();return false;"><img class=''  src="./images/<?php echo _QXZ("vdc_XB_hangupbothlines.gif"); ?>" border="0" alt="Hangup Both Lines" style="vertical-align:middle" /></a></span>
 </td>
 </tr>
    ...
    <td align="left" class='col-md-3'>
    <span id="Leave3WayCall" class='col-md-12 no-padding'><a class='col-md-12 no-padding' href="#" onclick="leave_3way_call('FIRST');return false;"><img class=''  src="./images/<?php echo _QXZ("vdc_XB_leave3waycall.gif"); ?>" border="0" alt="LEAVE 3-WAY CALL" style="vertical-align:middle" /></a></span>
 </td>
 </tr>

    <tr>
    <td align="left" COLSPAN="4">
    <span id="DialBlindTransfer"><img class='imagesize1' src="./images/<?php echo _QXZ("vdc_XB_blindtransfer_OFF.gif"); ?>" border="0" alt="Dial Blind Transfer" style="vertical-align:middle" /></span>
	&nbsp;
    <span  id="DialWithCustomer"><a href="#" onclick="SendManualDial('YES');return false;"><img style="width:210px;height:35px;" class='imagesize' src="./images/<?php echo _QXZ("vdc_XB_dialwithcustomer.gif"); ?>" border="0" alt="Dial With Customer" style="vertical-align:middle" /></a></span>
	&nbsp;
    <span id="ParkCustomerDial"><a href="#" onclick="xfer_park_dial();return false;"><img style="width:210px;height:35px;" class='imagesize' src="./images/<?php echo _QXZ("vdc_XB_parkcustomerdial.gif"); ?>" border="0" alt="Park Customer Dial" style="vertical-align:middle" /></a></span>
	...
	if ($enable_xfer_presets=='ENABLED')
		{
		?>
        <span id="PresetPullDown"><a href="#" onclick="generate_presets_pulldown();return false;"><img src="./images/<?php echo _QXZ("vdc_XB_presetsbutton.gif"); ?>" border="0" alt="Presets Button" style="vertical-align:middle" /></a></span>
		<?php
		}
	else
		{
		if ( ($enable_xfer_presets=='CONTACTS') and ($VU_preset_contact_search != 'DISABLED') )
			{
			?>
			<span id="ContactPullDown"><a href="#" onclick="generate_contacts_search();return false;"><img src="./images/<?php echo _QXZ("vdc_XB_contactsbutton.gif"); ?>" border="0" alt="Contacts Button" style="vertical-align:middle" /></a></span>
			<?php
			}
		else
			{
...
<span class="content_width container-fluid" style="position: absolute; z-index:<?php $zi++; echo $zi ?>; display: block; top: 0px;left:0px;" id="AgentXferViewSpan">
...
<div id="" class="col-lg-12 container-fluid">
   <!-- TOP NAVBAR -->
	...
	<div class="header no-border box-shadow"><h3><?php echo _QXZ("Available Agents Transfer:"); ?></h3></div>

		<div class="content no-padding">
			<div class="col-lg-12 space" style="overflow:scroll;height:408px;">
		<center>
...
<span style="position:absolute;left:5px;top:<?php echo $HTheight ?>px;z-index:<?php $zi++; echo $zi ?>;" id="EAcommentsBox">
    <table border="0" bgcolor="#FFFFCC"  height="70px">
    <tr bgcolor="#FFFF66">
...
<span style="position:fixed;left:0px;top:0px;width:100%;height:100%;z-index:<?php $zi++; echo $zi ?>;" id="NoneInSessionBox">
    <table border="1" class="tranparent_table " width=100% height=100%><tr><td align="center"> <?php echo _QXZ("No one is in your session:"); ?> <span id="NoneInSessionID"></span><br />
...
<span id="CustomerGoneBox" class="col-xs-push-1 popup_box" style="display:none;">
    <div class="col-lg-4 col-md-push-4 spacer3">
  <div class="col-md-12 no-padding spacer3">
		<div class="">
	    		<div class="row">    
	      			<div class="col-md-12 side_space1">
		        		<div class="block-flat no-margin-bottom btn-shadow">
				<div class="header no-border box-shadow"><h3> <?php echo _QXZ("Customer has hung up:"); ?> </h3></div>

	<div class="content no-padding">
	<div class="col-sm-12 space"><span id="CustomerGoneChanneL"></span><br />
...
<span class="col-xs-push-1 popup_box" style="display:none;" id="TimerSpan">
  <div class="col-lg-4 col-md-push-4 spacer3">
  <div class="col-md-12 no-padding spacer3">
		<div class="">
	    		<div class="row">    
  ...
  <span id="TimerContentSpan"></span>
	<a href="#" onclick="hideDiv('TimerSpan');return false;" class="btn btn-warning col-md-push-4 col-lg-4" ><?php echo _QXZ("Close Message"); ?></a></div></div>
	</div></div></div></div></div></div>
</span>

<span style="height:100%; width:100%;position:fixed;left:0px;top:0px;z-index:<?php $zi++; echo $zi ?>;" id="AgenTDisablEBoX">
    <table border="1" class="tranparent_table" width="100%" height="100%"><tr><td align="center"><?php echo _QXZ("Your session has been disabled"); ?><br /><a href="#" onclick="LogouT('DISABLED','');return false;"><?php echo _QXZ("CLICK HERE TO RESET YOUR SESSION"); ?></a><br /><br /><!--<a href="#" onclick="hideDiv('AgenTDisablEBoX');return false;">Go Back</a>-->
    </td></tr></table>
</span>
...
<span style="height:100%; width:100%;position:fixed;left:0px;top:0px;z-index:<?php $zi++; echo $zi ?>;" id="LogouTBox">
...
<span class="content_width container-fluid" style="position: absolute; z-index:<?php $zi++; echo $zi ?>; display: block; left: 0px; top: 0px; visibility: visible;" id="ViewCommentsBox">
	<div class="col-lg-11 col-xs-11">
	<div class='col-lg-12 no-padding'>
	<div class="col-md-12 container-fluid">
	<div class="cl-mcont">
	...
	<div class="block-flat no-margin-bottom">
	<div class='header no-border box-shadow'>
		<h3><?php echo _QXZ("View Comment History:"); ?></h3>
	</div>
	<div class='content no-padding'>
	<div class="col-md-12" style="height:433px;">
		<div class='content'>
...
<span class='content_width container-fluid' style="position: absolute; z-index:<?php $zi++; echo $zi ?>; display: block; left: 0px; top: 0px; visibility: visible;" id="CBcommentsBox">
    <div class="col-lg-11 col-xs-11">
<div class="col-lg-12 no-padding">
<div id="" class="col-md-12 container-fluid">
<div class="cl-mcont">
    		<div class="row">    
        		...
        		<div class="block-flat no-margin-bottom" >
        		<div class="header no-border box-shadow" >
        			<h3 class="pull-left"><?php echo _QXZ("Previous Callback Information:"); ?> </h3>
        			<a class='pull-right' href="#" onclick="CBcommentsBoxhide();return false;"><?php echo _QXZ("close"); ?></a>
        		</div>
   		<div class="content no-padding">
<div class="col-lg-12 space sub_section" style="overflow:scroll;height:442px;">
<center>
...
<span class="content_width container-fluid" style="position: absolute; z-index:<?php $zi++; echo $zi ?>; display: block; left: 0px; top: 0px;" id="CallBacKsLisTBox">
<div class="col-lg-11 col-xs-11">
<div class="col-lg-12 no-padding">
<div id="" class="col-md-12 container-fluid">
	...
	<div class="content no-padding">
<div class="col-lg-12 space sub_section" style="overflow:scroll;">
<center>
 ...
 <br />
    ...
    <br /> &nbsp;
	<a class="btn btn-default" href="#" onclick="CalLBacKsLisTCheck();return false;"><?php echo _QXZ("Refresh"); ?></a>
...
<span style="position: absolute; z-index: <?php $zi++; echo $zi ?>; display: block; left: 0px; top: 66px; visibility: visible;" class="content_width container-fluid"
 id="NeWManuaLDiaLBox">
   <div class="col-lg-11 col-xs-11 ">
<div class="col-lg-12 no-padding">
...
<div class="header no-border box-shadow">
	<?php echo _QXZ("NEW MANUAL DIAL LEAD FOR %1s in campaign %2s:",0,'',$VD_login,$VD_campaign); ?><br /><br />
	</div>
	<div class="content no-padding">
		<div class="col-lg-12 space" style="overflow-y:scroll;height:420px;">
    ...
    <td align="left"><div class="col-md-3"><input class="form-control" type="text" size="7" maxlength="10" name="MDDiaLCodE" id="MDDiaLCodE" class="form-control" value="" /></div>&nbsp; <?php echo _QXZ("(This is usually a 0 in the INDIA)"); ?></td>
	</tr><tr>
 ...
 <br />
	<a class="btn btn-default" href="#" onclick="NeWManuaLDiaLCalLSubmiT('NOW','YES');return false;"><?php echo _QXZ("Dial Now"); ?></a>
	 &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; 
	<a class="btn btn-primary" href="#" onclick="NeWManuaLDiaLCalLSubmiT('PREVIEW','YES');return false;"><?php echo _QXZ("Preview Call"); ?></a>
	 &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; 
	<a class="btn btn-default" href="#" onclick="ManualDialHide();return false;"><?php echo _QXZ("Go Back"); ?></a>
    </td></tr></table></center>
    </div></div>
...
<span class='col-md-12' style="background: #FCFBFB repeat 0 0 !important;height:100%;width:100%;position:fixed;left:0px;top:0px;z-index:<?php $zi++; echo $zi ?>;" id="CloserSelectBox">
  <div class="row">    
      			<div class="col-md-12 side_space1">
        		<div class="">
		...
		<div class="header no-border box-shadow padding5">							
          ...
          <div class="content no-padding">
			  <div class="col-lg-12 space" style="height:100%;">
	<?php
	if ($webphone_location == 'bar')
        {echo "<br /><img src=\"./images/"._QXZ("pixel.gif")."\" width=\"1px\" height=\"".$webphone_height."px\" /><br />\n";}
	?>
	...
	?>
	<a href="#" class='btn btn-default' onclick="CloserSelectContent_create();return false;"> <?php echo _QXZ("RESET"); ?> </a> 
	<a href="#" class='btn btn-primary' onclick="CloserSelect_submit();return false;"><?php echo _QXZ("SUBMIT"); ?></a>
	</center>
    </div>
        </div>    </div>    </div>    </div>    
</span>
...
<span class="content_width container-fluid" style="position: absolute; z-index:<?php $zi++; echo $zi ?>; display: block; left: 0px; top: 0px; visibility: visible;" id="CalLLoGDisplaYBox">
<div class="col-lg-11">
<div class="col-lg-12 no-padding">
<div id="" class="col-md-12 container-fluid">
   <!-- TOP NAVBAR -->
	...
	<div class="cl-mcont">
		...
		<div class="header no-border box-shadow">							
            <h3><?php echo _QXZ("AGENT CALL LOG:"); ?></h3>
          </div>

	<!--<table border="1" bgcolor="#CCFFCC" ><tr><td align="center" valign="top"> &nbsp; &nbsp; &nbsp;<center><div class="head_title" style="width:100%;"> <?php echo _QXZ("AGENT CALL LOG:"); ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href="#" onclick="CalLLoGVieWClose();return false;"><?php echo _QXZ("close"); ?> [X]</a></div></center><br />-->
	<?php
	if ($webphone_location == 'bar')
		{echo "<br /><img src=\"./images/"._QXZ("pixel.gif")."\" width=\"1px\" height=\"".$webphone_height."px\" /><br />\n";}
	?>
	<div class="content no-padding">
	<div class="col-lg-12 space" id="CallLogSpan" style="overflow:scroll;height:436px;"> <?php echo _QXZ("Call log List"); ?> </div>
	</div>
	</div></div></div></div></div></div></div>
</span>

<span class="content_width container-fluid" style="position: absolute; z-index:<?php $zi++; echo $zi ?>; display: block; left: 0px; top: 0px; visibility: visible;" id="SearcHContactsDisplaYBox">
	<div class="col-lg-11 col-xs-11">
	<div class="col-lg-12 container-fluid">
	<div class="cl-mcont">
    		<div class="row">    
			...
			<div class="header no-border box-shadow">		
			 ...
			 <div class="content no-padding">
	<div class="col-sm-12 space" style="height:356px;">
	<table class="col_table table"  width="100%">
	<tr><td align="center" valign="top"> &nbsp; &nbsp; &nbsp;
	<br />
<div style="width:500px;background-color:#fff; border-left:1px solid #e1e6ef; border-right:1px solid #e1e6ef;"> 
	<?php
	if ($webphone_location == 'bar')
		{echo "<br /><img src=\"./images/"._QXZ("pixel.gif")."\" width=\"1px\" height=\"".$webphone_height."px\" /><br />\n";}
	?>
	...
	<center>
	<table class="col_table table" width="100%" cellspacing="1" cellpadding="0" style="background-color:#fff;"><tbody>
	<div class="col-lg-12 no-padding">
  		<div class=''>
			<div class='col-lg-12 no-padding'>
	<center>
...
<span class="content_width container-fluid" style="position: absolute; z-index: <?php $zi++; echo $zi ?>; display: block; left: 255px; top: 0px; visibility: visible;" id="SearcHResultSContactsBox">
	<div class="col-lg-11">
	<div class="col-lg-12 container-fluid" id="">  
		<div class="cl-mcont">
		    <div class="row">
		     	<div class="col-md-12 side_space1">
     				<div class="block-flat">
						...
						<a class="pull-right" href="#" onclick="hideDiv('SearcHResultSContactsBox');return false;"><?php echo _QXZ("close"); ?> [X]</a>
						</div>
						<div class="content no-padding">
	<div class="col-md-12 space" style="overflow:scroll;height:355px;">
	<?php
	if ($webphone_location == 'bar')
		{echo "<br /><img src=\"./images/"._QXZ("pixel.gif")."\" width=\"1px\" height=\"".$webphone_height."px\" /><br />\n";}
	?>
...
<span class="content_width container-fluid" style="position: absolute; z-index: <?php $zi++; echo $zi ?>; display: block; left: 0px; top: 0px; visibility: visible;" id="SearcHForMDisplaYBox">
	<div class="col-lg-11 col-xs-11">
		<div class="col-lg-12 no-padding">
			<div id="" class="col-md-12 container-fluid">
				<div class="cl-mcont">
					<div class="row">
						<div class="side_space1">
							<div class="block-flat no-margin-bottom">
								<div class="header no-border box-shadow">
									<h3 class='pull-left'><?php echo _QXZ("SEARCH FOR A LEAD:"); ?></h3>
									<a class="pull-right" href="#" onclick="LeaDSearcHVieWClose();return false;"><?php echo _QXZ("close"); ?> [X]</a>
								</div>
								<div class="content no-padding">
								<div class="col-lg-12 space" style="overflow:scroll;height:427px;">
	<?php
	if ($webphone_location == 'bar')
		{echo "<br /><img src=\"./images/"._QXZ("pixel.gif")."\" width=\"1px\" height=\"".$webphone_height."px\" /><br />\n";}
	?>
	...
	<tr>
	<td align="center" colspan="2"><br /> <a class='btn btn-default' href="#" onclick="LeadSearchSubmit();return false;"><?php echo _QXZ("SUBMIT SEARCH"); ?></a> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a class='btn btn-primary' href="#" onclick="LeadSearchReset();return false;"><?php echo _QXZ("reset form"); ?></a></td>
	</tr>
	</table>
	<br /><br /> &nbsp;
...
<span class="content_width container-fluid" style="position: absolute; z-index: <?php $zi++; echo $zi ?>; display: block; left: 0px; top: 0px; visibility: visible;" id="SearcHResultSDisplaYBox">
	<div class="col-lg-11 col-xs-11">
		<div class="col-lg-12 no-padding">
			<div class="col-md-12 container-fluid" id="">
				<div class="cl-mcont">
		    		<div class="row">    
		      			<div class="side_space1">
			        		<div class="block-flat no-margin-bottom" style="overflow-y:scroll;height:489px;">
							<div class="header no-border box-shadow">
							<h3 class="pull-left"><?php echo _QXZ("SEARCH RESULTS:"); ?></h3>
							<a class='pull-right' href="#" onclick="hideDiv('SearcHResultSDisplaYBox');return false;"><?php echo _QXZ("close"); ?> [X]
							</a>
							</div>
							<?php
								if ($webphone_location == 'bar')
								...
								<div class="content no-padding" id="SearcHResultSSpan">
									<div style="overflow-y:scroll;height:356px;" class="col-sm-12 space">
...
<span style="position: absolute; z-index: <?php $zi++; echo $zi ?>; display: block; left: 0px; top: 0px; visibility: visible;" class="content_width container-fluid" id="CalLNotesDisplaYBox">
	<div class="col-lg-11 col-xs-11">
		<div class="col-lg-12 no-padding">
			<div class="col-md-12 container-fluid" id="">
				<div class="cl-mcont">
		    		<div class="row">    
		      			<div class="side_space1">
			        		<div class="block-flat no-margin-bottom" style="overflow-y:scroll;height:490px;">
				        	<div class="header no-border box-shadow">							
...
<span style="position: absolute; z-index: <?php $zi++; echo $zi ?>; display: block; left: 0px; top: 0px; visibility: visible;" class="content_width container-fluid" id="LeaDInfOBox" >
	<div class="col-lg-11 col-xs-11">
		<div class="col-lg-12 no-padding">
			<div class="col-md-12 container-fluid" id="">
				<div class="cl-mcont">
	    			<div class="row">    
	      				<div class="side_space1">
		        			<div class="block-flat no-margin-bottom">
								<div class="header no-border box-shadow">							
            						<h3 class="pull-left"><?php echo _QXZ("Customer Information:"); ?></h3>
	   	 							<a class="pull-right" href="#" onclick="hideDiv('LeaDInfOBox');return false;"><?php echo _QXZ("close"); ?> [X]</a>
          						</div>	
 								<div class="content no-padding">
								<div style="overflow-y:scroll;height:435px;" class="col-sm-12 space">	
								<table style="border:none;width:100%;" height="<?php echo $WRheight ?>px">
									<tr >
										<td align="center" valign="top">
											<div class="col-md-12">

										<!--<div class="head_title" style="width:500px;"> <?php echo _QXZ("Customer Information:"); ?>
										 <a href="#" onclick="hideDiv('LeaDInfOBox');return false;"><?php echo _QXZ("close"); ?> [X]</a>
										</center></div>-->
									...
									<br /><br /> &nbsp;
									<a class="btn btn-primary" href="#" onclick="hideDiv('LeaDInfOBox');return false;"><?php echo _QXZ("Close Info Box"); ?></a>
											</div>
										</td>
									</tr>
								</table></br>
...
<span style="position: absolute; z-index: <?php $zi++; echo $zi ?>; display: block; left: 0px; top: 0px; visibility: visible;" class="content_width container-fluid" id="PauseCodeSelectBox">
<div class="col-lg-11 col-xs-11">
	<div class="col-lg-12 no-padding">
		<div class="col-md-12 container-fluid" >
   <!-- TOP NAVBAR -->  
			<div class="cl-mcont">
      		...
      		<div class="side_space1">
        		<div class="block-flat no-margin-bottom">
		<div class="header no-border box-shadow">							
            	<center><div class="enjoy-css_cust col-lg-4" style="margin-left:210px;"><strong><?php echo _QXZ("Break Code"); ?></strong></div></center>
          </div>
	<div class="content no-padding">
...
<span class="content_width container-fluid" style="position: absolute; z-index: <?php $zi++; echo $zi ?>; display: block; left: 0px; top: 0px; visibility: visible;" id="PresetsSelectBox">
	<div class="col-lg-11 col-xs-11">
		<div class="col-lg-12 no-padding">
		<div class="col-md-12 container-fluid" >
   <!-- TOP NAVBAR -->  
...
<span style="position: absolute; display: block; left: 0px; top: 0px; visibility: visible; z-index:<?php $zi++; echo $zi ?>;" class="content_width container-fluid" id="GroupAliasSelectBox">
	<div class="col-lg-11 col-xs-11">    
      			<div class="col-lg-12 no-padding">
        		<div class="col-md-12 container-fluid">
        		<div class="cl-mcont">
	...
	<div class="header no-border box-shadow padding5"><h3> <?php echo _QXZ("SELECT A GROUP ALIAS :"); ?></h3>
	</div>
	<div class="content no-padding">
			  <div class="col-lg-12 space" style="overflow-y:scroll;height:431px;">
	<br />
	<?php
	if ($webphone_location == 'bar')
		{echo "<br /><img src=\"./images/"._QXZ("pixel.gif")."\" width=\"1px\" height=\"".$webphone_height."px\" /><br />\n";}
	?><center>
	<span id="GroupAliasSelectContent">
		 <?php echo _QXZ("Group Alias Selection"); ?> 
	</span></center>
...
<span class='content_width container-fluid' style="position: absolute; display: block; left: 0px; top: 0px; visibility: visible;z-index:<?php $zi++; echo $zi ?>;" id="DiaLInGrouPSelectBox">
	<div class="col-lg-11 col-xs-11">
		<div class="col-lg-12 no-padding">
			<div class="col-md-12 container-fluid">
				<div class="cl-mcont">
...
<span id="AlertBox" class="col-xs-push-1 popup_box" style="">
	<div class="col-lg-4 col-md-push-4 spacer3">
  		<div class="col-md-12 no-padding spacer3">
			<div class="">
	    		<div class="row">    
	      			<div class="col-md-12 side_space1">
		        		<div class="block-flat no-margin-bottom btn-shadow">
							<div class="header no-border box-shadow">
								<h3> <?php echo _QXZ("Agent Alert!"); ?></h3>
							</div>
								...
								<div class="col-sm-12 space">
									<div>
										<table align="left" class="col_table col-md-12">
											<tr>
												<td align="left">  
														<img style="width:80%;height:50px;" class='img' src="./images/<?php echo _QXZ("alert.png"); ?>" alt="alert" border="0">
												</td>
												<td>
											...
											<tr>
												<td align="center" valign="top" colspan="2">
													<button class="btn btn-warning col-md-push-5 col-md-2" 
													type="button" name="alert_button" id="alert_button" 
													onclick="hideDiv('AlertBox');return false;">
													<?php echo _QXZ("OK"); ?>
													</button>
...
<span style="height:887px; width:262px;position:absolute;left:0px;top:66px;z-index:9;" id="DispoButtonHideC">
