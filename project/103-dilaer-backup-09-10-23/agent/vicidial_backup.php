...
$MAIN_COLOR				= '#FCFBFB';	# old default is E0C2D6
$SCRIPT_COLOR			= '#E6E6E6';	# old default is FFE7D0
$REC_COLOR			    = '#E6E6E6'; ## change by deepu
$FORM_COLOR				= '#EFEFEF';
...
if ($user_login_first == 1)
	...
	if ( (strlen($VD_login)<1) or (strlen($VD_pass)<1) or (strlen($VD_campaign)<1) )
        ...
        echo "<td align=\"left\" valign=\"bottom\"><img src=\"./images/"._QXZ("vtc_tab_vicidial.gif")."\" border=\"0\" alt=\"VICIdial\" style=\"height:57px;\" /></td>";
...
//        echo "<span id=\"LogiNReseT\"></span></td></tr>\n";
  ...
  //      echo "<input type=\"hidden\" name=\"VD_login\" value=\"$VD_login\" />\n";
     ...
     //   echo "<input type=\"hidden\" name=\"VD_campaign\" value=\"$VD_campaign\" />\n";
       // echo "<center><table width=\"460px\" cellpadding=\"0\" cellspacing=\"0\" bgcolor=\"$MAIN_COLOR\"><tr bgcolor=\"white\">";
       // echo "<td align=\"left\" valign=\"bottom\"><img src=\"./images/"._QXZ("vdc_tab_vicidial.gif")."\" border=\"0\" alt=\"VICIdial\" /></td>";
	echo "<div class=\"content\">\n";
		...
		if (taskMDstage == "start") 
			...
			if (alt_phone_dialing == 1)
				...
				if (document.vicidial_form.DiaLAltPhonE.checked==true)
					...
					if (status_display_LEADID > 0) {status_display_content = status_display_content + " <?php echo _QXZ("CRMLead:"); ?> " + document.vicidial_form.lead_id.value;}
					...
					if (CBcounT == 0) {var CBprint = "<?php echo _QXZ("NO"); ?>";}
						...
						if ( (LastCallbackViewed > 0) && (Defer > 0) )
							...
							if ( (scheduled_callbacks_alert == 'BLINK_RED') || (scheduled_callbacks_alert == 'BLINK_RED_DEFER') )
								{
								CBpre = '<span class="blinking"><b><font color="red">';
								CBpost = '</font></b></span>';
								}
							}
						}
			...
			if (xmlhttp) 
				...
				xmlhttp.onreadystatechange = function() 
					...
					//	alert(xmlhttp.responseText);
						...
						var loop_ct=0;
						var conv_start=0;
                        var CB_HTML = "<table width=\"<?php echo $HCwidth ?>px\"><tr bgcolor=\"<?php echo $SCRIPT_COLOR ?>\"><td><font class=\"log_title\">#</font></td><td align=\"center\"><font class=\"log_title\"> <?php echo _QXZ("CALLBACK DATE/TIME"); ?> </font></td><td align=\"center\"><font class=\"log_title\"> <?php echo _QXZ("INFO"); ?> </font></td><td align=\"center\"><font class=\"log_title\"> <?php echo _QXZ("FULL NAME"); ?> </font></td><td align=\"center\"><font class=\"log_title\">  <?php echo _QXZ("STATUS"); ?> </font></td><td align=\"center\"><font class=\"log_title\"> <?php echo _QXZ("CAMPAIGN"); ?> </font></td><td align=\"center\"><font class=\"log_title\"> <?php echo _QXZ("LAST CALL DATE/TIME"); ?> </font></td><td align=\"center\"><font class=\"log_title\"> <?php echo _QXZ("DIAL"); ?></font></td><td align=\"center\"><font class=\"log_title\"> <?php echo _QXZ("ALT"); ?> </font></td></tr>"
					...
					if (VARSELstatuses[loop_ct] == 'Y')
						...
						if (taskDSgrp == VARstatuses[loop_ct]) 
							...
							dispo_HTML = dispo_HTML + "<div class='disp'><a style=\"font-weight:bold;\" class='p_space' href=\"#\" onclick=\"DispoSelect_submit();return false;\">" + VARstatuses[loop_ct] + " - " + VARstatusnames[loop_ct] + " - " + CBflag + "</b></font> </div>";
													...
													if ($people=="Lead")
  {
  dispo_HTML = dispo_HTML + "<div class='disp'><a class='p_space' href=\""  + "\" target=\"" + web_form_target + "\" onclick=\" ScriptPanelToFront(this.href), RefresHScript(); DispoSelectContent_create('" + VARstatuses[loop_ct] + "','ADD');return false;\">" +  VARstatuses[loop_ct] + " - " +CBflag + VARstatusnames[loop_ct]  + "</a></div>";
  }
						else
							{
...
<div class='col-lg-12 no-padding'><div class='col-lg-5 l-t-r'><span class='size'><?php echo _QXZ("Customer Time:"); ?></span></div><div class='col-lg-7 pl-t-r'><span name="custdatetime" id="custdatetime" class="log_title"> </span></div></div></div><div class='col-md-6 no-padding space'><div class='col-lg-12 no-padding'><div class='col-lg-3 l-t-r'><span class='size'><?php echo _QXZ("Channel:"); ?></span></div><div class='col-lg-8 pl-t-r'> <input type="hidden" name="callchannel" id="callchannel" class=""> </span></div></div></div>
    	</div>
...
<div class="header no-border box-shadow">
    ...
    <td align="left"><font class="body_text"><input type="checkbox" name="LeadLookuP" id="LeadLookuP" size="1" value="1" <?php echo $LeadLookuPXtra ?>/>&nbsp; <?php echo _QXZ("(This option if checked will attempt to find the phone number in the system before inserting it as a new lead)"); ?></font></td>
	</tr><tr>
