...
$LINKbase = "$PHP_SELF?query_date=$query_date&end_date=$end_date&query_time=$query_time&end_time=$end_time$groupQS$user_groupQS&shift=$shift&DB=$DB&show_percentages=$show_percentages&time_in_sec=$time_in_sec&search_archived_data=$search_archived_data&show_defunct_users=$show_defunct_users&breakdown_by_date=$breakdown_by_date&report_display_type=$report_display_type";
...
$HTML_head.="<link href='js/bootstrap/dist/css/bootstrap.css' rel='stylesheet'/>\n";
$HTML_head.="<script src='js/jquery.js'></script>";
$HTML_head.="    <script src='js/jquery_j.js'></script>";
$HTML_head.="	<script src='js/jquery.cookie/jquery.cookie.js'></script>";
$HTML_head.="  <script src='js/jquery.pushmenu/js/jPushMenu.js'></script>";
$HTML_head.="	<script type='text/javascript' src='js/jquery.nanoscroller/jquery.nanoscroller.js'></script>";
$HTML_head.="	<script type='text/javascript' src='js/jquery.sparkline/jquery.sparkline.min.js'></script>";
$HTML_head.="  <script type='text/javascript' src='js/jquery.ui/jquery-ui.js'></script>";
$HTML_head.="	<script type='text/javascript' src='js/jquery.gritter/js/jquery.gritter.js'></script>";
$HTML_head.="	<script type='text/javascript' src='js/behaviour/core.js'></script>";
$HTML_head.="  <script src='js/bootstrap/dist/js/bootstrap.min.js'></script>";
...
$HTML_text.='<div id="pcont" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding">
		<div class="col-md-12"><div class="block-flat">';
		
$HTML_text.="<div class='header' style='border-bottom:1px solid #5BC0DE;'><h3>"._QXZ("$report_name")."</h3></div>";
$HTML_text.="<TABLE class='col-md-12 spacer no-padding' CELLPADDING=3 CELLSPACING=0><TR><TD>";
...
$HTML_text.="<div class='col-lg-12' style='display:flex;flex-direction:column'><div class='query_date_input_chooser'><div class='col-lg-7 no-padding'><INPUT  TYPE=TEXT NAME=query_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$query_date\"></div><div class='col-lg-1 no-padding'>";
...
$HTML_text.="</script>\n";
$HTML_text.="</div></div><INPUT  style='width:58%;margin:5px 0;font-size:16px;padding:6px 12px'   TYPE=TEXT NAME=query_time SIZE=10 MAXLENGTH=10 VALUE=\"$query_time\">";


$HTML_text.="</div><div class='col-lg-12'><div class='col-sm-6' align='center'> "._QXZ("to")."</div> </div><div class='col-lg-12'><div class='end_date_input_chooser'><div class='col-lg-7 no-padding' style='display:flex;flex-direction:column'><INPUT TYPE=TEXT NAME=end_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$end_date\"></div><div class='col-lg-1 no-padding'>";
...
$HTML_text.="// o_cal.a_tpl.weekstart = 1; // Monday week start\n";
$HTML_text.="</script>\n";
$HTML_text.="</div></div><INPUT  style='width:58%;margin:5px 0;font-size:16px;padding:6px 12px' TYPE=TEXT NAME=end_time SIZE=10 MAXLENGTH=10 VALUE=\"$end_time\">";


$HTML_text.="</div></TD><TD class='no-border size'> "._QXZ("Campaigns").":<BR>";
$HTML_text.="<SELECT SIZE=5 class=form-control NAME=group[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
$HTML_text.="</SELECT>\n";
$HTML_text.="</TD><TD class='no-border size'>"._QXZ("User Groups").":<BR>";
$HTML_text.="<SELECT SIZE=5 class=form-control NAME=user_group[] multiple>\n";
...
$HTML_text.="</SELECT>\n";
$HTML_text.="</TD><TD class='no-border size'>"._QXZ("Users").": <BR>";
$HTML_text.="<SELECT SIZE=5 class=form-control NAME=users[] multiple>\n";
...
$HTML_text.="</TD><TD VALIGN=TOP><input class='ace' type='checkbox' name='show_percentages' class=form-control value='checked' $show_percentages><label class='lbl'>"._QXZ("Show %s")."</label>'s";
$HTML_text.="<input class='ace' type='checkbox' name='time_in_sec' value='checked' $time_in_sec><label class='lbl'>"._QXZ("Time in seconds")."</label>'s";
$HTML_text.="</td><TD class='col-lg-2 no-border size' rowspan=2 valign=top>"._QXZ("Display as").":<BR>";
$HTML_text.="<div class='col-lg-9 no-padding'><select size=1 name='report_display_type' class=form-control>";
...
$HTML_text.="</TD></TR><tr><td class='no-border' align=center colspan=7><INPUT TYPE=SUBMIT class='btn btn-bdr-sucess' NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'><!--$NWB#agent_performance_detail$NWE-->\n";
...
//$HTML_text.="<pre><div style='width:140%;'>\n";
