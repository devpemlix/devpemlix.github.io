...
##### END RUN THE EXPORT AND OUTPUT FLAT DATA FILE #####
	...
	echo "<TABLE BORDER=0 CELLSPACING=8 class='block-flat spacer no-border'><TR><TD ALIGN=LEFT VALIGN=TOP class='no-border col-sm-2'>\n";
	echo "<div class='col-lg-12 no-padding'><B>"._QXZ("Date Range").":</B></div></font><BR><CENTER>\n";
	echo "<div class='col-md-9 no-padding'><INPUT TYPE=TEXT NAME=query_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$query_date\"></div><div class='col-md-2'>";
	...
	echo "<div class='col-lg-12 no-padding'><SELECT SIZE=6 class=form-control NAME=group[] multiple>\n";
		$o=0;
	...
	echo "<div class='col-lg-10 no-padding'><SELECT SIZE=6 class=form-control NAME=list_id[] multiple>\n";
	...
	echo "<div class='col-lg-14 no-padding'><SELECT SIZE=6 class=form-control NAME=status[] multiple>\n";
		$o=0;
	...
	echo "</TD></TR><tr> \n";
	echo "<td class='no-border col-sm-2'><div class='col-lg-12 no-padding'><B>"._QXZ("Header Row").":</B></div>\n";
	echo "<div class='col-lg-6 no-padding'><select size=1 name=header_row class=form-control><option selected>"._QXZ("YES")."</option><option>"._QXZ("NO")."</option></select></div></td>\n";


	echo "<td class='no-border col-sm-2'><div class='col-lg-12 no-padding'><B>"._QXZ("Recording Fields").":</B></div>\n";
	...
	if ($custom_fields_enabled > 0)
		...
		echo "<B>"._QXZ("Custom Fields").":</B></div>\n";
		echo "<div class='col-lg-6 no-padding'><select size=1 name=custom_fields class=form-control><option value='YES'>"._QXZ("YES")."</option><option value='NO' selected>"._QXZ("NO")."</option></select></div></td>\n";
		}
	...
	echo "<td class='no-border col-sm-2'><div class='col-lg-12 no-padding'><B>"._QXZ("Per Call Notes").":</B></div>\n";
	...
	echo "<td class='no-border col-sm-2'><div class='col-lg-9 no-padding'><B>"._QXZ("Export Fields").":</B></div>\n";
	echo "<div class='col-lg-9 no-padding'><select size=1 name=export_fields class=form-control><option selected>"._QXZ("STANDARD")."</option><option>"._QXZ("EXTENDED")."</option></select></div></td>\n";
