...
$MAIN.="<TABLE BORDER=0 CELLPADDING=2 CELLSPACING=2 ><TR ><TD class='no-border col-lg-2'><div class='col-lg-12'><div class='col-lg-9 no-padding'>";
$MAIN.="<INPUT TYPE=TEXT NAME=query_date class=form-control SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"></div><div class='col-lg-1 no-padding'>";
...
//name:ruchita,date:4-dec,change:set alignment//
$MAIN.="</div></div> <div class='col-lg-12'><div class='col-sm-9 size ' align='center'>"._QXZ("to")."</div></div><div class='col-lg-12'><div class='col-lg-9 no-padding'><INPUT TYPE=TEXT NAME=end_date class=form-control SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div><div class='col-lg-1 no-padding'>";
...
$MAIN.="</div></div></TD><TD align=center class='no-border col-lg-3'><div class='col-lg-12'>";
...
$MAIN.="</SELECT>\n";
$MAIN.="</div></TD><TD align=center class='no-border col-lg-2'><div class='col-lg-9'>";
...
$MAIN.="</SELECT>\n";
$MAIN.="</div><div class='col-lg-9'>";
$MAIN.="<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
$MAIN.=" &nbsp;";
$MAIN.="<select name='report_display_type' class=form-control>";
if ($report_display_type) {$MAIN.="<option value='$report_display_type' selected>$report_display_type</option>";}
$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select></div>";
$MAIN.="</td><td class='no-border col-lg-3'>";
$MAIN.="<div class='col-lg-12 '><a href=\"$PHP_SELF?query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&DB=$DB&SUBMIT=$SUBMIT&file_download=1\">"._QXZ("DOWNLOAD")."</a> | <a href=\"./admin.php?ADD=3311&did_id=$group[0]\">"._QXZ("MODIFY")."</a> | <a href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a></div>";
$MAIN.="</TD></TR><TR><td class='no-border' colspan=4 align=center><INPUT TYPE=submit NAME=SUBMIT VALUE=SUBMIT class='btn btn-bdr-sucess'></td></TR></TABLE>\n";
$MAIN.="</FORM>\n";
...
if (!$group)
	...
	if (strlen($extension[0]) > 0)
		...
		$GRAPH_text.="</PRE><table cellspacing=\"1\" cellpadding=\"0\" bgcolor=\"white\" summary=\"DID Summary\" class=\"horizontalgraph\" style='margin-left:12px;'>\n";
	...
	if (strlen($did_server_ip[0]) > 0)
		...
		$GRAPH_text.="</PRE><table cellspacing=\"1\" cellpadding=\"0\" bgcolor=\"white\" summary=\"Server Summary\" class=\"horizontalgraph\" style='margin-left:12px;'>\n";
