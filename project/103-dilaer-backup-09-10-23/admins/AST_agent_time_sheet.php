...
$HEADER.="<TITLE>"._QXZ("$report_name")."</title>";
...
$MAIN.="<TABLE WIDTH=$page_width BGCOLOR=\"\" class=\" table1\" cellpadding=2 cellspacing=0><TR BGCOLOR=\"\"><TD>\n";


//$MAIN.="<BR>\n";
$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET> &nbsp; \n";
$MAIN.="<div class='col-lg-12 no-padding' style='padding-bottom:10px;'><div class='col_que  size'>"._QXZ("Date").":</div><div class='col-lg-2 '> <INPUT TYPE=TEXT NAME=query_date SIZE=19 class='form-control' MAXLENGTH=19 VALUE=\"$query_date\">\n</div><div class='col-lg-1 size'>";
$MAIN.=_QXZ("User ID").":</div><div class='col-lg-2'> <INPUT TYPE=TEXT NAME=agent SIZE=10 class='form-control' MAXLENGTH=20 VALUE=\"$agent\"></div><div style='padding-top:-10px;'>";
...
$MAIN.="<TABLE width=750 cellspacing=0 cellpadding=1 class=\"hover\">\n";
$MAIN.="<thead><tr><th ><font align=\"center\" size=2>"._QXZ("ID")." </th><th ><font align=\"center\" size=2>"._QXZ("EDIT")." </th><th><font  align=\"center\" size=2>"._QXZ("EVENT")." </th><th ><font align=\"center\" size=2> "._QXZ("DATE")."</th><th><font  align=\"center\" size=2> "._QXZ("IP ADDRESS")."</th><th ><font align=\"center\" size=2> "._QXZ("GROUP")."</th><th ><font align=\"center\" size=2>"._QXZ("HOURS:MINUTES")."</th></tr></thead>\n";
