...
if ( ($invalid_record < 1) or (strlen($timeclock_id)<1) )
	...
	#	$LOGOUTevent_id =	$tcid_link;
		...
		echo "<TR><TD >"._QXZ("TIMECLOCK ID").": </TD><TD >$LOGINevent_id</TD></TR>\n";
		echo "<TR><TD >"._QXZ("USER GROUP").": </TD><TD >$LOGINuser_group</TD></TR>\n";
		echo "<TR><TD >"._QXZ("IP ADDRESS").": </TD><TD >$LOGINip_address</TD></TR>\n";
		echo "<TR><TD >"._QXZ("MANAGER USER").": </TD><TD >$LOGINmanager_user</TD></TR>\n";
		echo "<TR><TD >"._QXZ("MANAGER IP").": </TD><TD >$LOGINmanager_ip</TD></TR>\n";
		echo "<TR><TD >"._QXZ("NOTES").": </TD><TD >$LOGINnotes</TD></TR>\n";
		echo "<TR><TD >"._QXZ("LAST CHANGE").": </TD><TD >$LOGINevent_datestamp</TD></TR>\n";
		echo "</TABLE>\n";
		...
		echo "<TR><TD >"._QXZ("TIMECLOCK ID").": </TD><TD >$LOGOUTevent_id</TD></TR>\n";
		echo "<TR><TD >"._QXZ("USER GROUP").": </TD><TD >$LOGOUTuser_group</TD></TR>\n";
		echo "<TR><TD >"._QXZ("IP ADDRESS").": </TD><TD >$LOGOUTip_address</TD></TR>\n";
		echo "<TR><TD >"._QXZ("MANAGER USER").": </TD><TD >$LOGOUTmanager_user</TD></TR>\n";
		echo "<TR><TD >"._QXZ("MANAGER IP").": </TD><TD >$LOGOUTmanager_ip</TD></TR>\n";
		echo "<TR><TD >"._QXZ("NOTES").": </TD><TD >$LOGOUTnotes</TD></TR>\n";
		echo "<TR><TD >"._QXZ("LAST CHANGE").": </TD><TD >$LOGOUTevent_datestamp</TD></TR>\n";
		echo "</TABLE>\n";
		echo "</TD></TR>\n";
