...
//$MAIN.="<TABLE class='table1 col_table' CELLPADDING=4 CELLSPACING=0><TR><TD>";
...
$MAIN.=_QXZ("Date").":\n";
$MAIN.="</div></div>";
$MAIN.="<div class=\"col-lg-4 no-padding\"><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"></div>";
...
$MAIN.="<div class=\"col-lg-12 no-padding\"><SELECT class='form-control' SIZE=5 NAME=server_ip[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$server_ip_string))
...
$MAIN.="<TD ROWSPAN=2 VALIGN=top>"._QXZ("SIP Response").":<BR/>";
$MAIN.="<div class=\"col-lg-10 no-padding\"><SELECT class='form-control' SIZE=5 NAME=sip_hangup_cause[] multiple>\n";
