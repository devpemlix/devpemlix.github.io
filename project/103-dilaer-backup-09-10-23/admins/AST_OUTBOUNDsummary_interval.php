...
if ($bareformat < 1)
	...
	$MAIN.="<TABLE class='table1 col_table' BORDER=0><TR><TD VALIGN=TOP>\n";
	$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
	$MAIN.="<INPUT TYPE=HIDDEN NAME=costformat VALUE=\"$costformat\">\n";
	$MAIN.="<INPUT TYPE=HIDDEN NAME=print_calls VALUE=\"$print_calls\">\n";
	$MAIN.="<div class='col-lg-12 no-padding'>"._QXZ("Date Range").":</div><BR>\n";
	$MAIN.="<div class='col-lg-4 no-padding'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\">";
	$MAIN.="</div><div class='col-lg-2 no-padding'>	<script language=\"JavaScript\">\n";
	...
	$MAIN.="	</script>\n";
	$MAIN.=" "._QXZ("to")."</div><div class='col-lg-4 no-padding'> <INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\">";
	$MAIN.="	</div><div class='col-lg-1 no-padding'><script language=\"JavaScript\">\n";
	$MAIN.="	var o_cal = new tcal ({\n";
	$MAIN.="		// form name\n";
	$MAIN.="		'formname': 'vicidial_report',\n";
	$MAIN.="		// input name\n";
	...
	$MAIN.="</TD><TD class='no-border' VALIGN=TOP ROWSPAN=2> "._QXZ("Campaigns").":<BR>";
	$MAIN.="<SELECT class=\"form-control\" SIZE=5 NAME=group[] multiple>\n";
	...
	$MAIN.="</SELECT>\n";
	$MAIN.="</TD><TD class='no-border' VALIGN=TOP ROWSPAN=2>";
	$MAIN.="<div class='col-lg-12'>"._QXZ("Include Drop")." "._QXZ("Rollover").":</div><BR>";
	$MAIN.="<div class='col-lg-10'><SELECT class='form-control' SIZE=1 NAME=include_rollover>\n";
	...
	$MAIN.="</SELECT></div><BR><BR><br>\n";
	$MAIN.="<div class='col-lg-12'>"._QXZ("Time Interval").":</div><BR>";
	$MAIN.="<div class='col-lg-10'><SELECT class='form-control' SIZE=1 NAME=time_interval>\n";
	...
	$MAIN.="</SELECT></div>\n";
	$MAIN.="</TD><TD class='col-lg-3 no-border'  ALIGN=LEFT ROWSPAN=2>\n";
	...
	$MAIN.="<div class='col-lg-4 spacer no-padding'>"._QXZ("Display as").":</div>";
	$MAIN.="<div class='col-lg-5 no-padding'><select class='form-control' name='report_display_type'>";
	if ($report_display_type) {$MAIN.="<option value='$report_display_type' selected>$report_display_type</option>";}
	$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select></div>\n<BR><BR><BR>";
	$MAIN.="<div class='col-lg-4 spacer no-padding'>"._QXZ("Call Time").":</div>\n";
	$MAIN.="<div class='col-lg-5 no-padding'><SELECT class='form-control' SIZE=1 NAME=shift>\n";
	$o=0;
