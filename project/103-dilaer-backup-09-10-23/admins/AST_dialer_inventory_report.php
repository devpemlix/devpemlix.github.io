...
$campaign_span_txt="<b>"._QXZ("Campaigns").":</b><BR>";
$campaign_span_txt.="<SELECT SIZE=5 NAME=group[] multiple class=\"form-control\">";
if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
$list_span_txt.="<SELECT class='form-control' NAME='selected_list'>";
$o=0;
if ($selected_list) 
	{
...
$HTML_text="<TITLE>"._QXZ("$report_name")."</TITLE></HEAD><BODY $onload BGCOLOR=WHITE marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>\n";
...
$HTML_text.="<div class=\"header\" style=\"border-bottom:1px solid #5BC0DE;\">\n";
$HTML_text.="<h3>Dialer Inventory Report</h3>\n";
$HTML_text.="</div>\n";
$HTML_text.="<div class=\"row\">\n";
...
$HTML_text.="<TABLE CELLPADDING=4 CELLSPACING=0 class=\"no-border\"><TR><TD style=\"border-top:none;\">\n";
$HTML_text.="\n";
...
$HTML_text.="	<tr><td><b>"._QXZ("Report type").":</b></td></tr>\n";
if ($report_type=='LIST') {$cmp_checked=""; $list_checked="checked";} else {$cmp_checked="checked"; $list_checked="";}
$HTML_text.="	<tr><td><input type='radio' class='ace' name='report_type' value='CAMPAIGNS' onClick=\"ToggleSpan('campaign_span', 'list_span')\" $cmp_checked><label class='lbl'>"._QXZ("Campaigns")."</label></td></tr>\n";
$HTML_text.="	<tr><td><input type='radio' class='ace' name='report_type' value='LIST' onClick=\"ToggleSpan('list_span', 'campaign_span')\" $list_checked><label class='lbl'>"._QXZ("List")."</label></td></tr>\n";
$HTML_text.="	</table>\n";
$HTML_text.="</TD>\n";
...
$HTML_text.="	<table width='*' align='center'>\n";
$HTML_text.="	<tr><td><b>"._QXZ("Time setting").":</b></td></tr>\n";
...
$HTML_text.="	<tr><td><input type='radio' class='ace' name='time_setting' value='SERVER' $svr_checked><label class='lbl'>"._QXZ("Server")."</label></td></tr>\n";
$HTML_text.="	<tr><td><input type='radio' class='ace' name='time_setting' value='LOCAL' $local_checked><label class='lbl'>"._QXZ("Local")."</label></td></tr>\n";
$HTML_text.="	<tr><td><input type='checkbox' class='ace' name='override_24hours' value='OVERRIDE' $override_checked><label class='lbl'>"._QXZ("Ignore local campaign call time")."</label><BR>("._QXZ("default to 24 hours").")</td></tr>\n";
$HTML_text.="	</table>\n";
$HTML_text.="</TD>\n";
$HTML_text.="<TD VALIGN=TOP width='150'>\n";
$HTML_text.="	<table width='*' align='center'>\n";
$HTML_text.="	<tr><td><b>"._QXZ("Report source")."</b>:</td></tr>\n";
if ($report_source=='REALTIME') {$ss_checked=""; $rt_checked="checked";} else {$ss_checked="checked"; $rt_checked="";}
$HTML_text.="	<tr><td width='150' align='left'><input type='radio' class='ace' name='report_source' value='SNAPSHOT' onClick=\"ToggleSpan('snapshot_span', '')\" $ss_checked><label class='lbl'>"._QXZ("Snapshot")."</label></td></tr>\n";
...
$HTML_text.="<input class=\"btn btn-bdr-sucess\" name='SUBMIT' value='"._QXZ("SUBMIT")."' type='submit'>\n";
$HTML_text.="</TD>\n";
$HTML_text.="</TR>\n";
$HTML_text.="</TABLE>\n";

//$HTML_text.="</div></div></div></div></div></div></div></div>";
