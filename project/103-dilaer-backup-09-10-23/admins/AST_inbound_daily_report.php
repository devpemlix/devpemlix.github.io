...
$MAIN.='<div id="pcont" class="container-fluid">
		...
		<div class="header" style="border-bottom:1px solid #5BC0DE;"><h3>'._QXZ("$report_name").'</h3></div>
...
$MAIN.="<div id='cl-wrapper' class='sb-collapsed' style='position:relative;border:1px #e8e8e8 solid;margin-bottom:10px;'>";

$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$MAIN.="<table cellspacing='0' cellpadding='4' class='col-lg-12 block-flat'><tr class=''><td class='col-lg-12 no-border'>";
$MAIN.="<div class='col-lg-2 spacer no-padding'>";

$MAIN.="<INPUT TYPE=TEXT NAME=query_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$query_date\"></div><div class='col-lg-1 spacer '>";
...
$MAIN.="&nbsp;&nbsp;"._QXZ("to")."</div><div class='col-lg-2 spacer no-padding'> <INPUT TYPE=TEXT NAME=end_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$end_date\"></div><div class='col-sm-1 spacer'>";
...
$MAIN.="<div class='col-lg-2 spacer no-padding'><SELECT SIZE=3 class=form-control NAME=group[] multiple>\n";
...
$MAIN.="<div class='col-lg-2 spacer '><select name='report_display_type' class=form-control>";
if ($report_display_type) {$MAIN.="<option value='$report_display_type' selected>"._QXZ("$report_display_type")."</option>";}
$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select></div><div class='no-border'>&nbsp; ";


if ($IDR_calltime_available==1)
	{
	$MAIN.="<SELECT SIZE=1 NAME=shift class=form-control>\n";
...
$MAIN.="<INPUT TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'></div>\n";
$MAIN.="</td></tr><tr class=''><td class='col-lg-12 no-border'><div class='col-lg-5 size'><INPUT TYPE=checkbox class='ace' NAME=hourly_breakdown VALUE='checked' $hourly_breakdown><label class='lbl'>"._QXZ("Show hourly results")."</label><BR><INPUT TYPE=checkbox class='ace' NAME=show_disposition_statuses VALUE='checked' $show_disposition_statuses><label class='lbl'>"._QXZ("Show disposition statuses")."</label><BR><INPUT TYPE=checkbox class='ace' NAME=ignore_afterhours VALUE='checked' $ignore_afterhours><label class='lbl'>"._QXZ("Ignore after-hours calls")."</label></div><div class='col-lg-4'><a href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date$selected_group_URLstr&shift=$shift&hourly_breakdown=$hourly_breakdown&show_disposition_statuses=$show_disposition_statuses&SUBMIT=$SUBMIT&file_download=1\">"._QXZ("DOWNLOAD")."</a> | <a href=\"./admin.php?ADD=3111&group_id=$group\">"._QXZ("MODIFY")."</a> | <a href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a></div>\n";
$MAIN.="</td>";
$MAIN.="</tr><tr><td class='no-border'><PRE class='pretag_no_scroll'><div style='width:100%;'>";
