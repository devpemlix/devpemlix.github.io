...
$NWE = "')\"><IMG SRC=\"help.gif\" WIDTH=20 HEIGHT=20 BORDER=0 ALT=\"HELP\" ALIGN=TOP></A>";
	...
	if (!$manager_chat_id) { # DO NOT ALLOW NEW CHATS WHILE AN OLD ONE IS OPEN!!!
		...
		echo "<TR>\n";
		echo "<TD align='left'><h4>"._QXZ("MESSAGE").":</h4></td>";
		...
		echo "<input class='ace' type='checkbox' name='allow_replies' id='allow_replies' value='Y' checked><label class='lbl'>"._QXZ("Allow agent replies")."</label>";
		echo "</TD>";
		...
		echo "\t<TD align='left' colspan='2'><h4>"._QXZ("Message")."</h4></TD>\n";
		echo "</TR>";
