...
if ($file_download < 1)
	...
	echo "</span>";
	//$ASCII_text.="<span id=agent_status_stats>\n";
	//$ASCII_text.="<PRE class=\"no-border\">";
	//$GRAPH_text.="<PRE class=\"no-border\">\n";
	
	echo '<div class=" no-padding">';
	echo "<span  id=agent_status_stats>\n";
 	//echo "<b style='padding-left:9px;'>"._QXZ("$report_name")."</b> <!--$NWB#single_agent_daily$NWE-->\n";
...
if (strlen($group[0]) < 1)
	...
	$GRAPH2="<tr><th style='padding: 7px 8px' class='column_header grey_graph_cell' id='callgraph1'><a href='#' onClick=\"DrawGraph('CALLS', '1'); return false;\">"._QXZ("CALLS")."</a></th><th style='padding: 7px 8px'  class='column_header grey_graph_cell' id='callgraph2'><a href='#' onClick=\"DrawGraph('CICALLS', '2'); return false;\">"._QXZ("CI/CALLS")."</a></th><th style='padding: 7px 8px'  class='column_header grey_graph_cell' id='callgraph3'><a href='#' onClick=\"DrawGraph('DNCCI', '3'); return false;\">"._QXZ("DNC/CI")."</a></th>";
	...
	$CALLS_graph=$graph_header."<th class='thgraph' style='padding: 7px 8px'  scope='col' >"._QXZ("CALLS")."</th></tr>";
...
echo "<TABLE CELLSPACING=3 BGCOLOR=\"#e3e3ff\"><TR><TD VALIGN=TOP class='no-border size'> "._QXZ("Dates").":<BR>";

echo "<INPUT class=\"form-control\" TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
echo "<div class='col-lg-12 no-padding'><div class='col-lg-7 no-padding'>
      <input type=\"text\" name=\"query_date\" size=\"10\" class=\"form-control\" maxlength=\"10\" value='".$query_date."'>
...
</div><div class='col-lg-12 no-padding'><div class='col-sm-6' align='center'>
<?php

echo ""._QXZ("to")."</div></div><div class='col-lg-12 no-padding'><div class='col-lg-7 no-padding'><INPUT class=\"form-control\" TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\" class=\"form-control\">";
...
echo ' <td style="width:15%" class="no-border size">'._QXZ("Campaigns").":<BR>";
...
echo "</SELECT>\n";
echo '</td>
    <td style="width:12%" class="no-border size" valign=top>';
...
echo "</td>
    <td style=\"width:10%\" class=\"no-border size\" valign=top>"._QXZ("User").":";
echo "<INPUT TYPE=TEXT SIZE=10 NAME=user value=\"$user\" class=form-control>\n";
echo "</TD><TD VALIGN=TOP  style=\"width:10%\" class=\"no-border size\">"._QXZ("Shift").":<BR>";
...
echo "</SELECT><BR><BR>\n";
echo "</TD><TD style=\"width:31%\" class=\"no-border\"> ";
...
echo '</td></tr><tr>
    <td colspan="6" style="width:100%" class="no-border" >
      <center><INPUT TYPE=SUBMIT NAME=SUBMIT VALUE="'._QXZ("SUBMIT").'" class="btn btn-bdr-sucess"></center>';
echo "</TD></TR></TABLE>";
