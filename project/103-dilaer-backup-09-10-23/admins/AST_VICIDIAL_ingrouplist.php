...
echo "<div class=\"col-lg-5\"><SELECT class=\"form-control\" SIZE=1 NAME=group>\n";
$o=0;
...
echo " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a class=\"btn btn-bdr-sucess\" href=\"./admin.php?ADD=3111&group_id=$group\">"._QXZ("MODIFY")."</a> \n";
echo "</FORM>\n\n";
