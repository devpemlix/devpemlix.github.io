...
$MAIN.="<div class='header' style='border-bottom:1px solid #5BC0DE;'><h3>"._QXZ("$report_name")."</h3></div>";
//$MAIN.="<b>"._QXZ("$report_name")."</b> $NWB#called_counts_multilist_report$NWE\n";
$MAIN.="<TABLE CELLSPACING=3 class='col-lg-12 spacer'><TR style=''><TD VALIGN=TOP class='col-lg-3'><div class='col-lg-12'><input type='checkbox' class='ace' name='override_date' value='1' checked><label class='lbl'>"._QXZ("All dates")."</label></div><div class='col-lg-12 size'>"._QXZ("Dates").":</div>";
$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
$MAIN.="<INPUT TYPE=HIDDEN NAME=outbound_rate VALUE=\"$outbound_rate\">\n";
$MAIN.="<div class='col-lg-12'><div class='col-lg-6 no-padding'><INPUT TYPE=TEXT NAME=query_date class=form-control SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\">";


$MAIN.="</div><div class='col-lg-1'><script language=\"JavaScript\">\n";
...
$MAIN.="</div></div><div class='col-lg-12 size'> <div class='col-sm-5' align='center'>"._QXZ("to")." </div> </div><div class='col-lg-12'><div class='col-lg-6 no-padding'><INPUT TYPE=TEXT NAME=end_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$end_date\">";
...
$MAIN.="</TD><TD class='no-border col-lg-2'>  "._QXZ("Campaigns").":<BR>";
$MAIN.="<SELECT multiple SIZE=5 NAME=group[] class=form-control id='group' $JS_events>\n";
if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
if (strlen($group[0]) > 1)
	...
	$MAIN.=" <a href=\"$PHP_SELF\">"._QXZ("RESET")."</a>";
	}
else
	{
...
$MAIN.="</TD></TR></TABLE>";
$MAIN.="</FORM></div></div></div></div></div></div>\n\n";
...
if (strlen($QUERY_STRING) > 5)
	...
	$MAIN.="<br><center><b>"._QXZ("CALLED COUNTS WITHIN LIST(S)")." $list_id_title_str$date_range_title:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"$PHP_SELF?DB=$DB$groupQS$list_idQS&query_date=$query_date&end_date=$end_date&override_date=$override_date&SUBMIT=$SUBMIT&file_download=1\">["._QXZ("DOWNLOAD")."]</a></b><br>\n";
	$CSV_text.=_QXZ("CALLED COUNTS WITHIN LIST(S)")." $list_id_title_str$date_range_title:\n";
	$MAIN.="<pre style=\"width:1000px !important\"><TABLE  width=100% cellspacing=1 style='padding:3px !important ; '>\n";
	$MAIN.="<tr><td align=left width=5px  style='padding:3px; !important'><b>"._QXZ("STATUS")."</b></td><td align=center width=5px  style='padding:3px; !important'><b>"._QXZ("STATUS NAME")."</b></td>";
	...
	$MAIN.="<td align=center width=3px><font  style='padding:3px; !important'><b>"._QXZ("SUBTOTAL")."</b></td></tr>\n";
