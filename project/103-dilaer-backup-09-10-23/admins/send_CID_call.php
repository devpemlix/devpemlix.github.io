...
echo '<div id="pcont" class="container-fluid">
			  ...
			  <div class="header"><h3>'._QXZ("VICIDIAL: Manual CID call")."</h3></div>";
echo '<div class="col-md-12"><div class="content">';

echo "<FORM ACTION=\"$PHP_SELF\" METHOD=GET>\n";
echo '<div class="col-lg-1 no-padding"><div class="pull-right">'._QXZ("Sender").": </div></div><div class=\"col-lg-1 no-padding\"><INPUT TYPE=TEXT NAME=sender SIZE=12 MAXLENGTH=10 VALUE=\"$sender\" class='form-control'></div><div class=\"col-lg-1 no-padding\"> \n";
echo '<div class="pull-right">'._QXZ("Receiver").": </div></div><div class=\"col-lg-1 no-padding\"><INPUT TYPE=TEXT NAME=receiver SIZE=12 MAXLENGTH=10 VALUE=\"$receiver\"  class='form-control'></div><div class=\"col-lg-1 no-padding\">\n";
echo '<div class="pull-right">'._QXZ("CID Number").": </div></div><div class=\"col-lg-1 no-padding\"><INPUT TYPE=TEXT NAME=cid_number SIZE=12 MAXLENGTH=10 VALUE=\"$cid_number\"  class='form-control'></div><div class=\"col-lg-1 no-padding\"> \n";
echo '<div class="pull-right">'._QXZ("Server").": </div></div><div class=\"col-lg-1 no-padding\"><SELECT SIZE=1 NAME=server_ip class='form-control'>\n";
$o=0;
...
echo "</SELECT></div><div class=\"col-lg-1 no-padding\"><div class=\"pull-right\">\n";
