...
<div id="pcont" class="container-fluid">
			  ...
			  <div class="header">
			  <h3><?php echo _QXZ("Listloader Custom Template Maker"); ?></h3>
			  </div> 
			  <div class="col-md-12">
			  <div class="content">
...
?>
	...
	<tr valign="top">
		...
		<form id="listloader_file_primer" action="leadloader_template_display.php?form_action=prime_file" method="post" enctype="multipart/form-data" target="file_holder">
			<font class="standard"><?php echo _QXZ("Sample file fitting template"); ?>:<BR><font size="-2">(<?php echo _QXZ("needed for field assignation"); ?>)</font></font><BR><BR><div class="col-lg-6 no-padding"><input class="form-control" type=file name="sample_template_file" value="<?php echo $sample_template_file; ?>" onChange="loadIFrame('prime_file', this.value); this.form.submit();"></div>
		</form>
		</td>
		<td align="left" width='50%'><form action="<?php echo $PHP_SELF; ?>" method="post"><font class="standard"><?php echo _QXZ("Select template to delete"); ?>:</font><BR><div class="col-lg-5"><select class="form-control" name="template_id" onChange="loadIFrame('hide_new_template_form', '')">
<?php
...
?>
		</select></div><BR/><BR/><BR><BR><div class="col-lg-5"><input class="btn btn-bdr-sucess" type="submit" value="<?php echo _QXZ("DELETE TEMPLATE"); ?>" name="delete_template"></div>
		</form></td>
	</tr>
	<tr>
...
<table border=0 cellpadding=3 cellspacing=0 width="100%" align="center">
	...
	<tr >
		...
		<td align="left" width='75%'><div class="col-lg-5"><input class="form-control" type='text' name='template_id' size='15' maxlength='20'></div></td>
	</tr>
	<tr >
		<td align="right" width='25%'><font class="standard"><?php echo _QXZ("Template Name"); ?>:</font></td>
		<td align="left" width='75%'><div class="col-lg-5"><input class="form-control" type='text' name='template_name' size='15' maxlength='30'></div></td>
	</tr>
	<tr >
		<td align="right" width='25%'><font class="standard"><?php echo _QXZ("Template Description"); ?>:</font></td>
		<td align="left" width='75%'><div class="col-lg-5"><input class="form-control" type='text' name='template_description' size='50' maxlength='255'></div></td>
	</tr>
	<tr>
	...
	<tr style='border:1px solid #FFF'>
		<th colspan='2' ><br/><input class='btn btn-bdr-sucess' type='submit' name='submit_template' onClick="return checkForm(this.form)" value='SUBMIT TEMPLATE'><br/></th>
	</tr>
...
<table class="col-md-12 content" border=0 cellpadding=3 cellspacing=1 width="100%" align="center">
	<tr>
		<th colspan="2" ><font class="standard" ><?php echo _QXZ("Assign columns to file fields"); ?><BR/><font size='-2'>(<?php echo _QXZ("selecting a different list will reset columns"); ?>)</font></font></th>
	</tr>
	<tr valign="top">
		<td border="1" align="center" width="50%"><font class="standard"><?php echo _QXZ("Standard Field"); ?></font></td>
		<td border="0" align="center" width="50%"><font class="standard"><?php echo _QXZ("Custom Field"); ?></font></td>
	</tr>
	<tr valign="top">
