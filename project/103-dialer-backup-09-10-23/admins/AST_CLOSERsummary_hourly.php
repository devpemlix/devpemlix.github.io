...
if ($bareformat < 1)
	...
	$MAIN.="<TABLE BORDER=0 class='block-flat spacer'><TR><TD class='no-border col-lg-4 spacer'>\n";
	...
	$MAIN.="<div style='col-lg-12  no-padding'><div class='col-lg-12 size no-padding'>"._QXZ("Date Range").":</div></div><div class='col-md-12 '><div class='col-lg-4 no-padding'>\n";
	...
	$MAIN.=" </div><div class='col-md-1'>"._QXZ("to")." </div><div class='col-lg-4 no-padding'><INPUT TYPE=TEXT NAME=end_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$end_date\"></div><div class='col-lg-1 no-padding'>";
	...
	$MAIN.="</div></div><div class='col-lg-12 size no-padding spacer'>"._QXZ("Call Time").":</div><div class='col-lg-11 no-padding'>\n";
	...
	$MAIN.="<TD class='no-border no-padding col-lg-2'><div class='col-lg-12 size no-padding'>";
	$MAIN.=_QXZ("Inbound Groups").": </div><div class='col-lg-12 no-padding'>\n";
	...
	$MAIN.="<div class='col-lg-12 size'>\n";
	$MAIN.=_QXZ("Display as").":</div>";
	$MAIN.="<div class='col-lg-10 size'><select name='report_display_type' class=form-control>";
	if ($report_display_type) {$MAIN.="<option value='$report_display_type' selected>$report_display_type</option>";}
	$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select>\n</div>";
	$MAIN.=" <br><br><br><br><div class='col-lg-12 size'> "._QXZ("Exclude Outbound Drop Groups").":</div>";
	$MAIN.=" <div class='col-lg-10 '> <SELECT SIZE=1 NAME=exclude_rollover class=form-control>>\n";
	...
	$MAIN.="</TD></TR>\n";
	$MAIN.="<TR><TD class='no-border' style='border:none !important;text-align:center;' colspan=4>\n";

	$MAIN.="<div class='col-lg-12 '><INPUT TYPE=submit NAME=SUBMIT VALUE=SUBMIT class='btn btn-bdr-sucess'></div>";
	$MAIN.="</TD>\n";
	$MAIN.="</TR></TABLE>\n";
	$MAIN.="</FORM>\n\n";
