...
$MAIN.='<div id="pcont" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class=\"col-md-12\"><div class=\"content\">';
...
$MAIN.="<TD class='no-border col-lg-4 '><div class='col-lg-12'> "._QXZ("Lists").":</div>";
$MAIN.="<div class='col-lg-12'><SELECT SIZE=5 NAME=list[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$list_string))
...
$MAIN.="</SELECT></div><div class='col-lg-12 spacer'><a href=\"AST_LISTS_campaign_stats.php?DB=$DB\">"._QXZ("SWITCH TO CAMPAIGNS")."</a></div>";
$MAIN.="</TD>";

$MAIN.="<TD VALIGN=TOP class='no-border'>";
