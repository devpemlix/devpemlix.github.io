...
if ($file_download < 1)
	...
	//echo "</span>\n";
 	...
 	echo "<span style=\"left:3px;top:30px;z-index:19;\" id=agent_status_stats>\n";
...
echo "</pre></pre><FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
...
echo "<TABLE CELLSPACING=3 class='block-flat spacer'><TR  class='no-border' style=''><TD class='col-lg-3 no-border size'><div class='col-lg-12'> Date:</div>";
//echo "<div class='header' style='border-bottom:1px solid #5BC0DE;'><h3>"._QXZ("$report_name")."</h3></div>";
...
echo "</div></div><div class='col-lg-12'> <div class='col-sm-6' align='center'>to</div> </div><div class='col-lg-12'><div class='col-lg-7 no-padding'><INPUT TYPE=TEXT NAME=end_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$end_date\"></div><div class='col-lg-1 no-padding'>";
...
echo "</div></div></TD><TD  class='no-border size'>"._QXZ('Campaigns').":<BR>";
...
echo "</SELECT>\n";
echo "</TD><TD class='no-border size'>"._QXZ("User Groups").":<BR>";
...
echo "</SELECT>\n";
echo "</TD><TD class='no-border size'>"._QXZ("Shift").":<BR>";
echo "<SELECT SIZE=1 class=form-control NAME=shift>\n";
...
echo "</SELECT><BR><BR>\n";
echo "<div class='size'>"._QXZ("Display as").":</div>";
...
echo "<input type='checkbox' name='search_archived_data' value='checked' $search_archived_data><label class='lbl'>"._QXZ("Search archived data")."</label><BR>\n";
echo "<input type='checkbox' name='show_defunct_users' value='checked' $show_defunct_users><label class='lbl'>"._QXZ("Show defunct users")."</label><BR><BR>\n";
echo "&nbsp;&nbsp;&nbsp;<TD class='no-border' colspan=5 align=center><INPUT class='btn btn-bdr-sucess' TYPE=SUBMIT NAME=SUBMIT VALUE=SUBMIT>\n</td>";

echo "</TD><TD class='no-border'> &nbsp; &nbsp; &nbsp; &nbsp; ";

echo " <a href=\"$LINKbase&stage=$stage&file_download=1\">"._QXZ("DOWNLOAD")."</a> | \n";
echo " <a href=\"./admin.php?ADD=999999\">REPORTS</a> </FONT>";
echo "</TD></TR><TR><TD class='no-border' colspan=5 align=center>";
echo "</TD></TR></TABLE>";
