		...
		if ($SUBMIT=="SUBMIT") 
			...
			if ($add_copy_disabled > 0)
				...
				if (mysqli_affected_rows($link)==0) 
					{
					$error_msg.="<div id=\"pcont\" class=\"container-fluid\">
					<div class=\"cl-mcont\">
					<div class=\"row\">
					<div class=\"col-md-12 no-padding\">
					<div class=\"block-flat\">"._QXZ("There was an unknown error when attempting to create the new account")."<BR/></div></div></div></div></div>";
					if($DB>0) {$error_msg.="<B>$ins_stmt</B><BR>";}
					}
				else 
					{
					$message="<div id=\"pcont\" class=\"container-fluid\">
					<div class=\"cl-mcont\">
					<div class=\"row\">
					<div class=\"col-md-12 no-padding\">
			...
			if (mysqli_affected_rows($link)==0) 
				...
				$error_msg.="<div id=\"pcont\" class=\"container-fluid\">
					...
					<div class=\"row\">
					<div class=\"col-md-12 no-padding\">
					<div class=\"block-flat\">"._QXZ("There was an unknown error when attempting to update account")." $email_account_id<BR/></div></div></div></div></div>";
		...
		if ($add_copy_disabled > 0)
			...
			if (mysqli_affected_rows($link)==0) 
				...
				$error_msg.="<div id=\"pcont\" class=\"container-fluid\">
					...
					<div class=\"row\">
					<div class=\"col-md-12 no-padding\">
					<div class=\"block-flat\">"._QXZ("There was an unknown error when attempting to copy the new account")."<BR/></div></div></div></div></div>";
...
if ($eact == "COPY")
	...
	if ($accounts_to_print>0) 
		...
		echo "<tr ><td align=center colspan=2><input class='btn btn-bdr-sucess' type=submit name=SUBMIT value='"._QXZ("COPY")."'></td></tr>\n";
...
### END copy fields to a list form
	...
	if ( ($LOGemails_modify==1) )
		...
		echo "<tr ><td align=right>"._QXZ("Active").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=active><option>Y</option><option SELECTED>N</option></select></div><!--$NWB#email_accounts-email_account_active$NWE--></td></tr>\n";
		...
		echo "<tr ><td align=right>"._QXZ("Email Account Type").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=email_account_type><option>INBOUND</option></select></div><!--$NWB#email_accounts-email_account_type$NWE--></td></tr>\n";
		...
		echo "<tr ><td align=right>"._QXZ("Auth Mode for POP3 protocol only").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=pop3_auth_mode><option SELECTED>BEST</option><option>PASS</option><option>APOP</option><option>CRAM-MD5</option></select></div><!--$NWB#email_accounts-pop3_auth_mode$NWE--></td></tr>\n";
		...
		echo "<tr ><td align=right>"._QXZ("In-Group Call Handle Method").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=call_handle_method><option>EMAIL</option><option>EMAILLOOKUP</option><option>EMAILLOOKUPRL</option><option>EMAILLOOKUPRC</option><option SELECTED>$call_handle_method</option></select></div><!--$NWB#email_accounts-call_handle_method$NWE--></td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("In-Group Agent Search Method").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=agent_search_method><option value=\"LB\">LB - Load Balanced</option><option value=\"LO\">LO - Load Balanced Overflow</option><option value=\"SO\">SO - Server Only</option><option SELECTED>$agent_search_method</option></select></div><!--$NWB#email_accounts-agent_search_method$NWE--></td></tr>\n";
		...
		echo "<tr ><td align=center colspan=2><input class='btn btn-bdr-sucess' type=submit name=SUBMIT VALUE='"._QXZ("SUBMIT")."'><input type=hidden name='eact' value='ADD'></td></tr>\n";
	...
	if ( ($LOGemails_modify==1) )
		...
		echo "<option>Y</option><option>N</option></select></div><!--$NWB#email_accounts-email_account_active$NWE--></td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account Description").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_description size=70 maxlength=255 value='$email_account_description'></div><!--$NWB#email_accounts-email_account_description$NWE--></td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account Type").": </td><td align=left><div class='col-lg-5'><select  class='form-control' size=1 name=email_account_type><option value='$email_account_type' selected>$email_account_type</option><option>INBOUND</option></select></div><!--$NWB#email_accounts-email_account_type$NWE--></td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Admin User Group").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=user_group>\n";
		...
		echo "<tr ><td align=right>"._QXZ("Auth Mode for POP3 protocol only").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=pop3_auth_mode><option>BEST</option><option>PASS</option><option>APOP</option><option>CRAM-MD5</option><option SELECTED>$pop3_auth_mode</option></select></div><!--$NWB#email_accounts-pop3_auth_mode$NWE--></td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Reply-to Address").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_replyto_address size=70 maxlength=255 value='$email_replyto_address'></div><!--$NWB#email_accounts-email_replyto_address$NWE--></td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account Server").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_server size=70 maxlength=255 value='$email_account_server'></div><!--$NWB#email_accounts-email_account_server$NWE--></td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account User").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_user size=30 maxlength=255 value='$email_account_user'></div><!--$NWB#email_accounts-email_account_user$NWE--></td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account Password").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_pass size=30 maxlength=100 value='$email_account_pass'></div><!--$NWB#email_accounts-email_account_pass$NWE--></td></tr>\n";
...
################
		...
		echo "<tr ><td align=center colspan=2><input class='btn btn-bdr-sucess' type=submit name=SUBMIT VALUE='"._QXZ("UPDATE")."'><input type=hidden name='eact' value='UPDATE'></td></tr>\n";
		echo "</TABLE><BR><BR>";
		if ($LOGuser_level >= 9)
			{
	...
	echo "<center><div class=\"col-md-12\"><div class=\"content\"><TABLE class='hover' width=750 cellspacing=0 cellpadding=1>\n";
	echo "<TR>\n";
	echo "<TD>"._QXZ("ACCOUNT ID")."</TD>\n";
	echo "<TD>"._QXZ("ACCOUNT NAME")."</TD>\n";
	echo "<TD>"._QXZ("DESCRIPTION")."</TD>\n";
	echo "<TD>"._QXZ("REPLY-TO ADDRESS")."</TD>\n";
	echo "<TD>"._QXZ("PROTOCOL")."</TD>\n";
	echo "<TD>"._QXZ("SERVER")."</TD>\n";
	echo "<TD>"._QXZ("FREQUENCY")."</TD>\n";
	echo "<TD>"._QXZ("ACTIVE")."</TD>\n";
	echo "<TD>"._QXZ("UNREAD EMAILS")."</TD>\n";
	echo "<TD>"._QXZ("MODIFY")."</TD></tr>\n";
	...
	while ($accounts_to_print > $o) 
		...
		echo "<td> $row[email_frequency_check_mins] mins</td>";
		echo "<td> $row[active]</td>";
		echo "<td> $unhandled_emails</td>";
		echo "<td><a href=\"$PHP_SELF?eact=UPDATE&email_account_id=$row[email_account_id]\">"._QXZ("MODIFY")."</a></td></tr>\n";
		$o++;
		}
