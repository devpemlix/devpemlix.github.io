...
$MAIN.="<TABLE BORDER=0 class='spacer block-flat'><TR><TD VALIGN=TOP class='no-border col-lg-5'>\n";
$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
$MAIN.="<INPUT TYPE=HIDDEN NAME=type VALUE=\"$type\">\n";
$MAIN.="<div class='col-lg-12 size'>"._QXZ("Date Range").":</div>\n";
...
$MAIN.="<div class='col-lg-12'><div class='col-lg-4 no-padding'><INPUT TYPE=TEXT NAME=query_date_D SIZE=11 class=form-control MAXLENGTH=10 VALUE=\"$query_date_D\"></div><div class='col-lg-1'>";
...
$MAIN.="</script></div><div class='col-lg-4 no-border'>\n";

$MAIN.="<INPUT TYPE=TEXT NAME=query_date_T SIZE=9 class=form-control MAXLENGTH=8 VALUE=\"$query_date_T\"></div></div><div class='col-lg-12'>";

$MAIN.="<div class='col-lg-12 size'><div class='col-sm-3' align='center'>"._QXZ("to")."</div></div></div><div class='col-lg-12'><div class='col-lg-4 no-padding'><INPUT TYPE=TEXT NAME=end_date_D SIZE=11 class=form-control MAXLENGTH=10 VALUE=\"$end_date_D\"></div><div class='col-lg-1 no-border'>";
...
$MAIN.="<INPUT TYPE=TEXT NAME=end_date_T SIZE=9 class=form-control MAXLENGTH=8 VALUE=\"$end_date_T\"></div>";
$MAIN.="</td><td class='col-lg-3 no-border'><div class='col-lg-12 no-border'><div class='col-lg-12 size'>";
...
if ($type == 'inbound')
	...
	$MAIN.="<SELECT SIZE=5 class=form-control NAME=group[] multiple>\n";
	$o=0;
	...
	$MAIN.="</SELECT>\n";
	$MAIN.="</div></div></td><td class='no-border'><div class='col-lg-12 no-padding'>";
...
#$MAIN.="</SELECT>\n";
$MAIN.="</TD></TR>\n";
$MAIN.="<TR ><TD class='col-lg-5 no-border'>\n";

$MAIN.="<div class='col-lg-4 no-padding'><div class='col-lg-12 size'>"._QXZ("Shift").": </div> <div class='col-lg-12'><SELECT SIZE=1 NAME=shift class=form-control>\n";
...
$MAIN.="</SELECT></div></div><div class='col-md-6'>\n";
...
$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select></div></div></td></tr><tr><td class='no-border' align='center' colspan=3 style='border:none !important;'>";
$MAIN.="&nbsp; &nbsp; <input type=button value=\""._QXZ("SUBMIT")."\"  class='btn btn-bdr-sucess' name=smt id=smt onClick=\"submit_form()\">\n";
...
if ($groups_to_print < 1)
	...
	$max_ivr_avg=1;
	$max_total_avg=1;
	$GRAPH="<table border='0' cellpadding='0' cellspacing='2' width='800'>";
