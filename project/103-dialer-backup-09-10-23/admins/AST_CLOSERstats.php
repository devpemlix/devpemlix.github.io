...
$MAIN.="<TABLE CELLPADDING=4 CELLSPACING=0 class='no-border'><TR class='no-border'><TD class='no-border'>";
...
$MAIN.="<table class='no-border'><tr ><td class='no-border'><div class='col-md-12 size no-padding'><div class='col-lg-3 size no-padding'>"._QXZ("Date Range").":</div></div><div class='col-md-12 size'><div class='col-lg-4 no-padding'>";
$MAIN.="<INPUT TYPE=TEXT NAME=query_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$query_date\"></div><div class='col-lg-1 no-padding'>";
...
$MAIN.=" </div><div class='col-md-1 no-padding'>"._QXZ("to")."</div><div class='col-lg-4 no-padding'> <INPUT TYPE=TEXT NAME=end_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$end_date\"></div><div class='col-lg-1 no-padding'>";
...
$MAIN.="<div class='col-md-6 no-padding'><div class='col-md-12 size spacer'>"._QXZ("Shift").":</div><div class='col-md-8 no-padding'> <SELECT SIZE=1 NAME=shift class='form-control'>\n";
...
$MAIN.="</SELECT>\n";
$MAIN.="</div></div><div class='col-md-6 no-padding'><div class='col-md-12 size spacer'>"._QXZ("Display as").":</div><div class='col-md-8 no-padding'>";
...
$MAIN.="</div></div></td><td class='no-border'><div class='col-lg-12 size no-padding'>";
...
$MAIN.="</div><div class='col-lg-12 no-padding'>\n";
...
$MAIN.="</SELECT>\n";
$MAIN.="</div></td><td class='no-border' style='width:25%;'><div class='col-lg-12 no-padding'>\n";
$MAIN.="";
if ($DID!='Y')
	{
...
$MAIN.="</div></td></tr></table></td></TR>\n";
$MAIN.="<TR class='no-border' style='text-align: center;width:20%;'><td class='no-border'><div class='col-lg-12 size'>\n";
