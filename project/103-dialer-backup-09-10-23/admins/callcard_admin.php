...
if ($action == "CALLCARD_DETAIL")
	...
	if ($details_to_print > 0) 
		...
		echo "<div class='header'><h4>"._QXZ("CallCard Detail")."</h4></div><form action=$PHP_SELF method=POST>\n";
...
if ($action == "CALLCARD_SUMMARY")
	...
	echo "<TABLE class='no-border'><TR><TD class='no-border'>\n";
	echo "<center><TABLE class='hover centerline' width=400 cellspacing=0 cellpadding=1 class='col-lg-12 spacer'>\n";
	echo "<thead><TR>";
	...
	echo "<BR><BR>\n";
		...
		echo "<center><TABLE class='hover centerline' width=740 cellspacing=0 cellpadding=1 class='col-lg-12 spacer'>\n";
		echo "<thead><TR>";
		echo "<th><B>#</B></th>";
...
if ($action == "CALLCARD_RUNS")
	...
	while ($vt_ct > $i)
		...
		echo "<td> $Lrun[$i] </td>";
		echo "<td> $Lcount[$i] </td>";
		echo "<td> <a href=\"$PHP_SELF?action=SEARCH_RESULTS&run=$Lrun[$i]&DB=$DB\">LIST</a> </td>";
		echo "</tr>\n";
...
if ($action == "CALLCARD_BATCHES")
	...
	while ($vt_ct > $i)
		...
		echo "<td> $Lbatch[$i] </td>";
		echo "<td> $Lcount[$i] </td>";
		echo "<td> <a href=\"$PHP_SELF?action=SEARCH_RESULTS&batch=$Lbatch[$i]&DB=$DB\">LIST</a> </td>";
		echo "</tr>\n";
...
if ($action == "SEARCH_RESULTS")
	...
	if (strlen($searchSQL) < 5)
		...
		while ($vt_ct > $i)
			...
			echo "<td> <a href=\"$PHP_SELF?action=CALLCARD_DETAIL&card_id=$Lcard_id[$i]&DB=$DB\">DETAILS</a> </td>";
			echo "</tr>\n";
...
if ($action == "SEARCH")
	{
	//echo "<TABLE class='table1 col_table'>\n";
	echo "<div class='header'><h3>"._QXZ("CallCard Search").":</h3></div>";
	echo "<form action=$PHP_SELF method=POST>\n";
	echo "<input type=hidden name=action value=SEARCH_RESULTS>\n";
	echo "<input type=hidden name=DB value=$DB>\n";
	echo "<center><div class=\"col-md-12\"><div class=\"content\"><TABLE class='table1 col_table' width=$section_width cellspacing=3 class='col-lg-12 spacer'>\n";
	echo "<tr><td >"._QXZ("PIN").": </td><td><div class='col-lg-5'><input type=text class='form-control' name=pin size=20 maxlength=20></div></td></tr>\n";
	echo "<tr><td >"._QXZ("Card ID").": </td><td><div class='col-lg-5'><input type=text class='form-control' name=card_id size=20 maxlength=20></div></td></tr>\n";
	echo "<tr><td >"._QXZ("Run").": </td><td><div class='col-lg-5'><input type=text class='form-control' name=run size=5 maxlength=4></div></td></tr>\n";
	echo "<tr><td >"._QXZ("Batch").": </td><td><div class='col-lg-5'><input type=text class='form-control' name=batch size=6 maxlength=5></div></td></tr>\n";
	echo "<tr><td >"._QXZ("Sequence").": </td><td><div class='col-lg-5'><input type=text class='form-control' name=sequence size=6 maxlength=5></div></td></tr>\n";
	echo "<tr><td align=center colspan=2><p style='text-align:center;'><input type=submit class='btn btn-bdr-sucess' name=SUBMIT value='"._QXZ("SUBMIT")."'></td></tr>\n";
