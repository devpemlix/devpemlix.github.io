...
$result = mysql_query("SELECT lead_id,vendor_lead_code, phone_number, entry_date FROM vicidial_list where list_id in('999','2222','3333')and (entry_date > (NOW() - INTERVAL SECOND(SYSDATE()) SECOND - INTERVAL 1 MINUTE))";
