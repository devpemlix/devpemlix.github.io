...
$MAIN.="<div class='col-md-12'><div class='content'><TABLE CELLPADDING=4 CELLSPACING=0 ><TR><TD>";
...
$MAIN.="<TABLE CELLSPACING=3 class='col-lg-12 spacer'><TR style=''><TD VALIGN=TOP>";
$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
$MAIN.="<INPUT TYPE=HIDDEN NAME=use_lists VALUE=\"$use_lists\">\n";

if ($use_lists > 0)
	{
	$MAIN.="</TD><TD class='no-border col-lg-4 size'><div class='col-lg-12'>"._QXZ("Lists").":</div><BR>";
	$MAIN.="<div class='col-lg-12'><SELECT SIZE=5 class=form-control NAME=group[] multiple>\n";
	if  (preg_match('/\-\-ALL\-\-/',$group_string))
	...
	$MAIN.="</SELECT></div>";
	$MAIN.="<div class='col-lg-12 spacer'><a href=\"$PHP_SELF?use_lists=0&DB=$DB\">"._QXZ("SWITCH TO CAMPAIGNS")."</a></div>";
	}	

	
else
	{
	$MAIN.="</TD><TD class='col-lg-4 no-border size'><div class='col-lg-12'> "._QXZ("Campaigns").":</div>";
	$MAIN.="<div class='col-lg-12'><SELECT SIZE=5 class=form-control NAME=group[] multiple>\n";
	if  (preg_match('/\-\-ALL\-\-/',$group_string))
	...
	$MAIN.="</SELECT></div>";
	$MAIN.="<div class='col-lg-12 spacer'><a href=\"$PHP_SELF?use_lists=1&DB=$DB\">"._QXZ("SWITCH TO LISTS")."</a></div>";
	}	
	

$MAIN.="</TD><TD class='col-lg-4 no-border size' valign=top>";
$MAIN.="<div class='col-lg-12'>"._QXZ("Display as").":</div><div class='col-lg-12'>";
...
$MAIN.="<div class='col-lg-12 spacer'>";
$MAIN.="<INPUT type=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'></div>";
$MAIN.="</TD><TD class='no-border col-lg-4'>  ";
$MAIN.="<div class='col-lg-12'>";
...
$MAIN.="</div></TD></TR></TABLE></div></div>";
$MAIN.="</FORM></div></div></div></div>\n\n";
