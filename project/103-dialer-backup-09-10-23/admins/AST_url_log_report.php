...
$MAIN.="<TABLE BORDER=0 cellspacing=5 cellpadding=5 class='spacer col-lg-12'><TR><TD VALIGN=TOP class='col-lg-4 no-border size'>\n";


//name:ruchita,date:3-dec,chnage:set proper theme in this page and resize //
...
$MAIN.="<INPUT TYPE=TEXT NAME=query_date SIZE=10 class='form-control' MAXLENGTH=10 VALUE=\"$query_date\">";
...
$MAIN.="</div></div></TD><TD VALIGN=TOP class='no-border size col-lg-4'>URL type:<BR/>\n";
$MAIN.="<div class='col-lg-8 no-padding'><SELECT SIZE=5 NAME=url_type[] class='form-control' multiple>\n";
if  (preg_match('/--ALL--/',$url_type_string))
...
$MAIN.="</SELECT></div></TD><TD VALIGN=top class='no-border size col-lg-4'>\n";
$MAIN.="Display as:</br>";
$MAIN.="<div class='col-lg-4 no-padding'><select name='report_display_type' class='form-control'>";
if ($report_display_type) {$MAIN.="<option value='$report_display_type' selected>$report_display_type</option>";}
$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select>\n<BR><BR>";
$MAIN.="</TD></TR><TR><TD align=center colspan=3 class='no-border'><INPUT TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' align=center class='btn btn-bdr-sucess'><BR/><BR/>\n";
$MAIN.="</TD></TR></TABLE>\n";
