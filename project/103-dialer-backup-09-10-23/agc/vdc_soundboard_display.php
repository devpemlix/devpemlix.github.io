		...
		if ( ($Abutton_type[$o] == 'header') or ($Abutton_type[$o] == 'head2r') )
			...
			if ($Abutton_type[$o] == 'space')
                ...
                {  
					switch ($Ah_ord[$o]) {
						case 1:
							echo "$tr_begin<td class='voice-row'  style= 'width:165px; border-radius:3px'  onClick=\"click_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\"   id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"left\" bgColor=\"#B3ECF2\"  colspan=$Rcolspan  nowrap><div  style='font-size:$font_size_convert;font-family:sans-serif;'  >$Abold_start[$o]$Aitalic_start[$o] &nbsp; $count_display$display_button &nbsp; $Aitalic_end[$o]$Abold_end[$o]</div></td>";
							echo "$tr_end\n";
							break;
						case 2:
							echo "$tr_begin<td class='voice-row'  style= 'width:165px; border-radius:3px'  onClick=\"click_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\"  id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"left\" bgColor=\"#FACFCE\"  colspan=$Rcolspan  nowrap><div  style='font-size:$font_size_convert;font-family:sans-serif;'  >$Abold_start[$o]$Aitalic_start[$o] &nbsp; $count_display$display_button &nbsp; $Aitalic_end[$o]$Abold_end[$o]</div></td>";
							echo "$tr_end\n";
							break;
						case 3:
							echo "$tr_begin<td class='voice-row'  style= 'width:165px; border-radius:3px'  onClick=\"click_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\"  id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"left\" bgColor=\"#D9D4CC\"  colspan=$Rcolspan nowrap ><div  style='font-size:$font_size_convert;font-family:sans-serif;'  >$Abold_start[$o]$Aitalic_start[$o] &nbsp; $count_display$display_button &nbsp; $Aitalic_end[$o]$Abold_end[$o]</div></td>";
							echo "$tr_end\n";
							break;
						case 4:
							echo "$tr_begin<td class='voice-row'  style= 'width:165px; border-radius:3px'  onClick=\"click_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\"  id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"left\" bgColor=\"#a8a8e9\"  colspan=$Rcolspan  nowrap><div  style='font-size:$font_size_convert;font-family:sans-serif;'  >$Abold_start[$o]$Aitalic_start[$o] &nbsp; $count_display$display_button &nbsp; $Aitalic_end[$o]$Abold_end[$o]</div></td>";
							echo "$tr_end\n";
							break;
						case 5:
							echo "$tr_begin<td class='voice-row'  style= 'width:165px; border-radius:3px'  onClick=\"click_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\"  id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"left\" bgColor=\"orange\"  colspan=$Rcolspan  nowrap><div  style='font-size:$font_size_convert;font-family:sans-serif;'  >$Abold_start[$o]$Aitalic_start[$o] &nbsp; $count_display$display_button &nbsp; $Aitalic_end[$o]$Abold_end[$o]</div></td>";
							echo "$tr_end\n";
							break;
						default:
						echo "$tr_begin<td class='voice-row' style= 'width:165px; border-radius:3px'  onClick=\"click_cell('TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length')\"  id=\"TOP---$Aaudio_filename[$o]---$Arank[$o]---$Alevel[$o]---$Ah_ord[$o]---$audio_length\" align=\"left\" bgColor=\"$colors[$m]\"  colspan=$Rcolspan  nowrap><div  style='font-size:$font_size_convert;font-family:sans-serif;'  >$Abold_start[$o]$Aitalic_start[$o] &nbsp; $count_display$display_button &nbsp; $Aitalic_end[$o]$Abold_end[$o]</div></td>";
						echo "$tr_end\n";
					}
