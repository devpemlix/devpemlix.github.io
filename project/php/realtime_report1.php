...
$select_list .= "<div class='col-lg-7'><SELECT class='form-control' SIZE=8 NAME=groups[] ID=groups[] multiple>";
$o=0;
...
$select_list .= "<BR><BR><BR><BR><BR><BR><BR><BR><BR><BR>&nbsp;&nbsp;<font size=1>("._QXZ("To select more than 1 campaign, hold down the Ctrl key and click").")</font>";

$select_list .= "<BR><BR>"._QXZ("Select User Groups").": <BR>";
$select_list .= "<div class='col-lg-7'><SELECT class='form-control' SIZE=8 NAME=user_group_filter[] ID=user_group_filter[] multiple>";
$o=0;
...
$select_list .= "<INPUT class='btn btn-bdr-sucess' type=button VALUE=SUBMIT onclick=\\\"update_variables('form_submit','');\\\"><FONT FACE='ARIAL,HELVETICA' COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; ";
$select_list .= "</TD></TR>";
...
function ingroup_info(agent_user,count)
	...
	document.getElementById("agent_ingroup_display").style.top = 400;
	//	alert(session_id + "|" + server_ip + "|" + monitor_phone + "|" + stage + "|" + user);
	var xmlhttp=false;
	/*@cc_on @*/
	/*@if (@_jscript_version >= 5)
...
function gather_realtime_content()
	...
	if (xmlhttp) 
		...
		xmlhttp.open('POST', 'AST_timeonVDADall1.php'); 
		xmlhttp.setRequestHeader('Content-Type','application/x-www-form-urlencoded; charset=UTF-8');
...
function update_variables(task_option,task_choice,force_reload)
	...
	if (task_option == 'CUSTPHONEdisplay')
		...
		//if (CUSTPHONEdisplay == '1') {CUSTPHONEdisplay='0';   document.getElementById("CUSTPHONEdisplayTXT").innerHTML = "<?php echo _QXZ("SHOW CUSTPHONES"); ?>";}
		  if (CUSTPHONEdisplay == '1') {CUSTPHONEdisplay='0';   document.getElementById("CUSTPHONEdisplayTXT").innerHTML = "<?php echo _QXZ(""); ?>";}
...
document.getElementById("chartContainer").innerHTML = "hello bro";
</script>
...
<div id="pcont" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header" style="padding-bottom: 0px;"><span style="font-size:24px;"><?php echo _QXZ("$report_name") ?> <?php echo "<span style=\"position:absolute;left:160px;z-index:20;\" id=campaign_select_list_link>"; ?></span>	
...
<?php
echo "<TABLE CELLPADDING=4 CELLSPACING=0 class=\"col_table table1\"><TR><TD>";
