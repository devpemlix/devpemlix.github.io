...
echo "<link rel=\"stylesheet\" href=\"fonts/font-awesome-4/css/font-awesome.min.css\">";
echo "<link href=\"css/style.css\" rel=\"stylesheet\" />";
?>

<?php
echo "</head>\n";
echo "<BODY marginheight=0 marginwidth=0 leftmargin=0 topmargin=0  style=\"overflow-x:hidden;overflow-y:hidden !important;\">\n";
...
<div class="text_input col-sm-12 no-padding" id="MainPanelCustInfo">
<div class="block-flat" style="height:530px;border:none !important;">
...
<div class="col-lg-12 no-padding">
  <div class='col-md-6 no-padding space'>
	<div class='col-lg-12 no-padding'>
		<div class='col-lg-4 l-t-r'><span class='size'><?php echo $label_first_name ?>:* </span></div>
		<div class='col-lg-8 pl-t-r'><input class="form-control" type=text name=first_name id=first_name size=30 maxlength=30 value="<?php echo $first_name ?>"> </div>
	</div>
  </div>
	<div class='col-md-6 no-padding space'>
	<div class='col-lg-12 no-padding'>
		<div class='col-lg-4 l-t-r'><span class='size'><?php echo $label_last_name ?>:* </span></div>
		<div class='col-lg-8 pl-t-r'><input class="form-control" type=text name=last_name id=last_name size=30 maxlength=30 value="<?php echo $last_name ?>"> </div>
	</div>
  </div>
</div>
<!-- <TR BGCOLOR="#E6E6E6">
...
<div class="col-lg-12 no-padding">
	<div class='col-md-6 no-padding space'>
		<div class='col-lg-12 no-padding'>
		<div class='col-lg-4 l-t-r'><span class='size'><?php echo $label_address1 ?>:* </span></div>
		<div class='col-lg-8 pl-t-r'><input class="form-control" type=text name=address1 id=address1 size=30 maxlength=100 value="<?php echo $address1 ?>"> </div>
	</div>
  </div>
	<div class='col-md-6 no-padding space'>
		<div class='col-lg-12 no-padding'>
		<div class='col-lg-4 l-t-r'><span class='size'><?php echo $label_address2 ?>: </span></div>
		<div class='col-lg-8 pl-t-r'><input class="form-control" type=text name=address2 id=address2 size=30 maxlength=100 value="<?php echo $address2 ?>"></div>
	</div>
  </div>
</div>
...
<div class="col-lg-12 no-padding">
	<div class='col-md-6 no-padding space'>
		<div class='col-lg-12 no-padding'>
		<div class='col-lg-4 l-t-r'><span class='size'><?php echo $label_address3 ?>: </span></div>
		<div class='col-lg-8 pl-t-r'><input class="form-control" type=text name=address3 id=address3 size=30 maxlength=100 value="<?php echo $address3 ?>"></div>
	</div>
  </div>

	<div class='col-md-6 no-padding space'>
		<div class='col-lg-12 no-padding'>
		<div class='col-lg-4 l-t-r'><span class='size'><?php echo $label_city ?>:* </span></div>
		<div class='col-lg-8 pl-t-r'><input class="form-control" type=text name=city id=city size=30 maxlength=50 value="<?php echo $city ?>"> </div>
	</div>
  </div>
</div>
...
<div class="col-lg-12 no-padding">
	<div class='col-md-6 no-padding space'>
		<div class='col-lg-12 no-padding'>
		<div class='col-lg-4 l-t-r'><span class='size'><?php echo $label_state ?>:* </span></div>
...
<TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA">Province: </TD><TD ALIGN=LEFT><input type=text name=province id=province size=20 maxlength=50 value="<?php echo $province ?>"></TD>
	...
	<div class='col-md-6 no-padding space'>
		<div class='col-lg-12 no-padding'>
		<div class='col-lg-4 l-t-r'><span class='size'><?php echo $label_postal_code ?>:* </span></div>
		<div class='col-lg-8 pl-t-r'><input class="form-control" type=text name=postal_code id=postal_code size=6 maxlength=5 value="<?php echo $postal_code ?>"> </div>
	</div>
  </div>
</div>
<!-- <TR BGCOLOR="#E6E6E6">
...
<div class="col-lg-12 no-padding">
	<div class='col-md-6 no-padding space'>
		<div class='col-lg-12 no-padding'>
		<div class='col-lg-4 l-t-r'><span class='size'><?php echo $label_phone_number ?>:* </span></div>
		<div class='col-lg-8 pl-t-r'><input class="form-control" type=text name=phone_number id=phone_number size=18 maxlength=18 value="<?php echo $phone_number ?>"> </div>
	</div>
  </div>
...
<TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA">Owner: </TD><TD ALIGN=LEFT><input type=text name=owner id=owner size=20 maxlength=20 value="<?php echo $owner ?>"> *</TD>
	...
	<div class='col-md-6 no-padding space'>
		<div class='col-lg-12 no-padding'>
		<div class='col-lg-4 l-t-r'><span class='size'><?php echo _QXZ("Order ID:"); ?> </span></div>
		<div class='col-lg-8 pl-t-r'><input class="form-control" type=text name=order_id id=order_id size=20 maxlength=20 value="<?php echo $order_id ?>"></div>
	</div>
  </div>
</div>
...
<div class="col-lg-12 no-padding">
		...
		<div class='col-lg-6 no-padding space'>
		<div class='col-lg-4 l-t-r'><?php echo _QXZ("Appointment Date/Time:"); ?> </span></div>
		<div class='col-lg-7 pl-t-r'><input class="form-control" type=text name=appointment_date id=appointment_date size=10 maxlength=10 value="<?php echo $appointment_date ?>"></div>
...
<SELECT class="form-control" name=appointment_hour id=appointment_hour>
<option>00</option>
<option>01</option>
<option>02</option>
<option>03</option>
...
<div class="col-lg-4">
<SELECT class="form-control" name=appointment_min id=appointment_min>
<option>00</option>
<option>05</option>
<option>10</option>
<option>15</option>
...
<div class="col-lg-12 no-padding">
		...
		<div class='col-lg-2 l-t-r'><?php echo _QXZ("Appointment Notes:"); ?> </span></div>
		<div class='col-lg-8 pl-t-r'><TEXTAREA class="form-control" NAME=call_notes ID=call_notes ROWS=3 COLS=50><?php echo $call_notes ?></TEXTAREA></div>
	</div>
</div>
...
<div class="col-lg-12 no-padding">
		...
		<div class='col-lg-12 no-padding'>
		<div class='l-t-r'>
			<div class='col-lg-4 l-t-r'>&nbsp;</div>
	<center><div class='col-lg-12 pl-t-r'>
	<p><?php echo _QXZ("Please click SUBMIT to commit the changes"); ?>,
	* <?php echo _QXZ("denotes required fields"); ?></p>
	</div></center>
		</div>
...
<center>
<input class="btn btn-primary" type=button value="<?php echo _QXZ("SUBMIT"); ?>" name=smt id=smt onClick="submit_form()"></center>
</TD>
</TR>
