...
echo "\t<textarea class='form-control' rows='2' cols='65' name='manager_message' id='manager_message' onkeypress='if (event.keyCode == 13) {SendMgrChatMessage();}'></textarea><BR><input class='enjoy-css' type='button' value='"._QXZ("SEND MESSAGE")."' onClick=\"SendMgrChatMessage()\">\n";
echo "\t</div>\n";
echo "</TD>\n";
echo "<TD align='left' rowspan='2' valign='top' style='border-bottom:1px solid #e1e6ef;'>\n";
...
echo "\t<BR><BR><input class='enjoy-css' type='button' value='"._QXZ("CHAT WITH LIVE AGENT")."' onClick=\"document.getElementById('AgentChatSpan').style.display='none'; document.getElementById('AgentNewChatSpan').style.display='block'; ReloadAgentNewChatSpan('$user');\">\n";
echo "\t<BR><BR><span id='AgentEndChatSpan' style='display: none;'><div align='left'><input class='enjoy-css' type='button' style='width:178px' value='"._QXZ("END CHAT")."' onClick='EndAgentToAgentChat()'></div></span>";
echo "</TD>\n";
echo "</TR>\n";
...
echo "<table width='100%' border='0' cellpadding='5' cellspacing='0'>\n";
echo "<TR valign='top'>\n";
echo "<td><font class='arial'>"._QXZ("Select a live agent").":</font><BR>\n";
...
$loop_count=0;
echo "<select class='form-control' name='agent' id='agent'>\n";
...
echo "</td>\n";
echo "<td><font class='arial'>"._QXZ("Message").":</font><BR>\n";
echo "<textarea class='form-control' rows='5' style='name='agent_message' id='agent_message'></textarea>";
echo "</td></TR>\n";

echo "<TR>\n";
echo "<td><BR><input class='enjoy-css' type='button' value='"._QXZ("BACK TO CHAT SCREEN")."' onClick=\"document.getElementById('AgentChatSpan').style.display='block'; document.getElementById('AgentNewChatSpan').style.display='none';\"></td>\n";
echo "<td align='center'><BR><input class='enjoy-css' type='button' value='"._QXZ("START CHAT")."' onClick=\"CreateAgentToAgentChat()\">\n</td></TR>\n";
echo "</table>";
?>
</span>
</body>
