...
$HTML_text.="<div class='col-lg-12'><div class='col-lg-7 no-padding'><INPUT TYPE=TEXT NAME=query_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$query_date\"></div><div class='col-lg-1 no-padding'>";
...
$HTML_text.="</div></div><div class='col-lg-12'><div class='col-sm-6' align='center'> "._QXZ("to")."</div> </div><div class='col-lg-12'><div class='col-lg-7 no-padding'><INPUT TYPE=TEXT NAME=end_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$end_date\"></div><div class='col-lg-1 no-padding'>";
