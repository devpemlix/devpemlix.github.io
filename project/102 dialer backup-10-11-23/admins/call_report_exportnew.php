...
/*	echo "<FONT SIZE=3 FACE=\"Arial,Helvetica\"><B>"._QXZ("Export Calls Report");
	...
	echo "<TABLE BORDER=0 CELLSPACING=8 class='col-md-12 no-border' style=''><TR><TD ALIGN=LEFT VALIGN=TOP  class='no-border col-sm-2'>\n";

//name:ruchita,date:4-dec,change:set proper alignment//

	echo "<font class=\"select_bold\"><div class='col-lg-12 no-padding'><B>"._QXZ("Date Range").":</B></div></font><CENTER>\n";
	echo "<div class='col-md-9 no-padding'><INPUT TYPE=TEXT NAME=query_date class=form-control SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"></div><div class='col-md-1'>";
	...
	echo "</div><div class='size col-lg-8'><b>"._QXZ("to")."</b></div>\n";
	echo "<div class='col-md-9 no-padding'><INPUT TYPE=TEXT NAME=end_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$end_date\"></div><div class='col-md-1'>";
	...
	echo "<font class=\"select_bold\"><B>"._QXZ("Campaigns").":</B></font><CENTER>\n";
	echo "<SELECT SIZE=6 class=form-control NAME=campaign[] multiple>\n";
		$o=0;
	...
	if ($ivr_export != 'YES')
		{
		echo "</TD><TD ALIGN=LEFT VALIGN=TOP  class='no-border col-sm-2'>\n";
		echo "<font class=\"select_bold\"><B>"._QXZ("Inbound Groups").":</B></font><CENTER>\n";
		echo "<SELECT SIZE=6 class=form-control NAME=group[] multiple>\n";
			$o=0;
	...
	echo "</TD><TD ALIGN=LEFT VALIGN=TOP  class='no-border col-sm-2'>\n";
	echo "<font class=\"select_bold\"><B>"._QXZ("Lists").":</B></font><CENTER>\n";
	echo "<SELECT class=form-control SIZE=6 NAME=list_id[] multiple>\n";
		$o=0;
	...
	echo "</SELECT>\n";
	echo "</TD><TD ALIGN=LEFT VALIGN=TOP class='no-border col-sm-2'>\n";
	echo "<font class=\"select_bold\"><B>"._QXZ("Statuses").":</B></font><CENTER>\n";
	echo "<SELECT SIZE=6 class=form-control NAME=status[] multiple>\n";
		$o=0;
	...
	if ($ivr_export != 'YES')
		...
		echo "<SELECT SIZE=6 class=form-control NAME=user_group[] multiple>\n";
			$o=0;
	...
	echo "</TD></TR><tr>\n";
	//<TD ALIGN=LEFT VALIGN=TOP COLSPAN=2 class='no-border'> &nbsp; \n";

	echo "<td class='no-border col-sm-2'></br><div class='col-lg-12 no-padding'><b>"._QXZ("Header Row").":</b></div>\n";
	echo "</br><div class='col-lg-6 no-padding'><select size=1 name=header_row class=form-control><option selected>"._QXZ("YES")."</option><option>"._QXZ("NO")."</option></select></div></td>\n";

	echo "\n";

	echo "<td class='no-border col-sm-2'></br><div class='col-lg-12 no-padding'><B>"._QXZ("Recording Fields").":</b></div>\n";
	echo "<div class='col-lg-8 no-padding'><select size=1 name=rec_fields class=form-control>";
	...
	if ($custom_fields_enabled > 0)
		{
		echo "<td class='no-border col-sm-2'><br/><div class='col-lg-12 no-padding'><b>";

		echo ""._QXZ("Custom Fields").":</b></div>\n";
		echo "</br><div class='col-lg-6 no-padding'><select size=1 name=custom_fields class=form-control><option>"._QXZ("YES")."</option><option selected>"._QXZ("NO")."</option></select></div>\n";
		}

	echo "<BR>\n";

	echo "<td class='no-border col-sm-2'></br><div class='col-lg-12 no-padding'><b>"._QXZ("Per Call Notes").":</b></div>\n";
	echo "</br><div class='col-lg-6 no-padding'><select size=1 name=call_notes class=form-control><option>"._QXZ("YES")."</option><option selected>"._QXZ("NO")."</option></select></div></td>\n";

	echo "\n";


	echo "<td class='no-border col-sm-2'><br/><div class='col-lg-12 no-padding'><b>"._QXZ("Export Fields").":</b></div>\n";
	echo "</br><div class='col-lg-9 no-padding'><select size=1 name=export_fields class=form-control><option selected>"._QXZ("STANDARD")."</option><option>"._QXZ("EXTENDED")."</option><option value=\"EXTENDED_2\">"._QXZ("EXTENDED_2")."</option><option>ALTERNATE_1</option></select></div></td>\n";
	
	
	echo "</td></TR><TR ></TD></div><TD ALIGN=CENTER VALIGN=TOP COLSPAN=6 class='no-border'>\n";
