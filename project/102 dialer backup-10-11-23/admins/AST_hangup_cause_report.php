...
$MAIN.="<TABLE BORDER=0 cellspacing=5 cellpadding=5 class='spacer col-lg-12'><TR><TD VALIGN=TOP class='col-lg-4 no-border'>\n";
$MAIN.="<div class='col-lg-12 '><INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
$MAIN.=_QXZ("Date").":</div><div class='col-lg-12'><div class='col-lg-5 no-padding'>";
$MAIN.="<INPUT TYPE=TEXT NAME=query_date class='form-control' SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\">";
...
$MAIN.="</script>\n";
//name:ruchita,date:3-dec,change:apply class and resize for all menu// 
$MAIN.="</div></br></br>";
...
$MAIN.="</div><div class='col-lg-1 '>"._QXZ("to")."</div><div class='col-lg-5 no-padding'><INPUT TYPE=TEXT NAME=query_date_T SIZE=9 class='form-control' MAXLENGTH=8 VALUE=\"$query_date_T\">";

$MAIN.="</div></div></TD><TD VALIGN=TOP class='no-border  col-lg-2'>"._QXZ("Server IP").":</br>";
$MAIN.="<SELECT SIZE=5 NAME=server_ip[] multiple class='form-control'>\n";
if  (preg_match('/\-\-ALL\-\-/',$server_ip_string))
...
$MAIN.="<TD VALIGN=top class='no-border  col-lg-2'>"._QXZ("Hangup Cause").":<BR/>";
$MAIN.="<SELECT class='form-control' SIZE=5 NAME=hangup_cause[] multiple>\n";
...
$MAIN.="<TD VALIGN=top class='no-border  col-lg-2'>"._QXZ("Dial status").":<BR/>";
$MAIN.="<SELECT class='form-control' SIZE=5 NAME=dial_status[] multiple>\n";
...
$MAIN.="<TD VALIGN=top class='no-border  col-lg-2'>"._QXZ("SIP Response").":<br/>";
$MAIN.="<SELECT SIZE=5 class='form-control' NAME=sip_hangup_cause[] multiple>\n";
...
$MAIN.="</TR><TR><TD colspan=5 class='no-border' align=center>\n";
