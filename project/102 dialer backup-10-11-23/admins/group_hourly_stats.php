...
echo ""._QXZ("Please enter the group you want to get hourly stats for").": <form action=$PHP_SELF method=GET>\n";
echo "<table class='table1 col_table'><tr><td>";
echo "<input type=hidden name=DB value=$DB>\n";
echo _QXZ("group").": </td><td><div class='col-lg-5'><select class='form-control' size=1 name=group>\n";
...
echo "$groups_list</select></div></td></tr>\n";
echo "<tr><td>"._QXZ("status").": </td><td><div class='col-lg-5'><input class='form-control' type=text name=status size=10 maxlength=10 value=\"$status\"></div> &nbsp; ("._QXZ("example").": XFER)</td></tr>\n";
echo "<tr><td>"._QXZ("date with hour").": </td><td><div class='col-lg-5'><input class='form-control' type=text name=date_with_hour size=14 maxlength=13 value=\"$date_with_hour\"></div> &nbsp; ("._QXZ("example").": 2004-06-25 14)</td></tr>\n";
echo "<tr><td colspan=2  align=center><p style='text-align:center;'>"."<input class='btn btn-bdr-sucess' type=submit name=submit value='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'></p></td></tr>\n";
echo "</table>\n";
