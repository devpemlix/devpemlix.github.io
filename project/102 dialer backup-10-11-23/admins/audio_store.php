...
<table align=center width="700" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
  <tr>
	...
	<td align=left width="65%"><div class='col-lg-5'><input class='form-control' type=file name="audiofile" value=""></div></td>
  </tr>
  <tr>
	<td align=center colspan=2><input class='btn btn-bdr-sucess' type=submit name=submit value='<?php echo _QXZ("submit"); ?>'></td>
  </tr>
...
if ($auth_delete > 0)
	{
	echo "<center><BR><BR>"._QXZ("File to Delete").":<BR><br>\n";
	...
	echo "<div class='col-lg-2' style='text-align:left;'><input class='btn btn-bdr-sucess' type=submit name=submit value=submit></div>\n";
	}
else
	{
	echo "<BR>\n";
