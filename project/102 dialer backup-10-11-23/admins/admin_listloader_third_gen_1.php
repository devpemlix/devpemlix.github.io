...
if ( (!$OK_to_process) or ( ($leadfile) and ($file_layout!="standard") ) )
	...
	if ($file_layout!="custom") 
		...
		?>
		 <div class="header">
			  ...
			  <div class="col-md-12">
			  <div class="content">
		<table class="col_table table1" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
		  <tr>
			<td><B><font face="arial, helvetica" size=2>Load leads from this file:</font></B></td>
			<td align=left width="65%"><div class="col-lg-5"><input class="form-control" type=file name="leadfile" value="<?php echo $leadfile ?>"></div> <?php echo "<!--$NWB#vicidial_list_loader$NWE-->"; ?></td>
		  </tr>
		  <tr>
			<td ><font face="arial, helvetica" size=2>List ID Override: </font></td>
			<td align=left width="75%"><font face="arial, helvetica" size=1>
			<div class="col-lg-5"><select class="form-control" name='list_id_override'>
		  ...
		  <tr>
			<td><font face="arial, helvetica" size=2>Phone Code Override: </font></td>
			<td align=left width="75%"><font face="arial, helvetica" size=1>
		  ...
		  <tr>
			...
			<td align=left><div class='col-lg-6'><font face="arial, helvetica" size=2><input type=radio name="file_layout" value="standard" checked>Standard Format&nbsp;&nbsp;&nbsp;&nbsp;<input type=radio name="file_layout" value="custom">Custom layout</div></td>
		  </tr>
		  <tr>
			<td><font face="arial, helvetica" size=2>Lead Duplicate Check: </font></td>
		  ...
		  <tr>
			<td><font face="arial, helvetica" size=2>USA-Canada Check: </font></td>
		  ...
		  <tr>
			<td><font face="arial, helvetica" size=2>Lead Time Zone Lookup: </font></td>
			<td align=left width="75%"><font face="arial, helvetica" size=1><div class="col-lg-5"><select class="form-control" size=1 name=postalgmt><option selected value="AREA">COUNTRY CODE AND AREA CODE ONLY</option><option value="POSTAL">POSTAL CODE FIRST</option><option value="TZCODE">OWNER TIME ZONE CODE FIRST</option></select></td>
		  </tr>
		<tr>
			<td></td>
			<td ><div class='col-lg-5'><input class="btn btn-bdr-sucess" type=submit value="SUBMIT" name='submit_file'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="btn btn-danger" type=button onClick="javascript:document.location='admin_listloader_third_gen.php'" value="START OVER" name='reload_page'></div></td>
		  </tr>
		  <tr><td align=left><font size=1> &nbsp; &nbsp; &nbsp; &nbsp; <a href="admin.php?ADD=100" target="_parent">BACK TO ADMIN</a> </td></tr>
	...
	<table class="" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
	<tr>
	<td align=right><B><font face="arial, helvetica" size=2>Lead file:</font></B></td>
	<td align=left width="75%"><font face="arial, helvetica" size=2><?php echo $leadfile_name ?></font></td>
	</tr>
	<tr>
	<td align=right><B><font face="arial, helvetica" size=2>List ID Override:</font></B></td>
	<td align=left width="75%"><font face="arial, helvetica" size=2><?php echo $list_id_override ?></font></td>
	</tr>
	<tr>
	<td align=right><B><font face="arial, helvetica" size=2>Phone Code Override:</font></B></td>
	<td align=left width="75%"><font face="arial, helvetica" size=2><?php echo $phone_code_override ?></font></td>
	</tr>
	<tr>
	<td align=right><B><font face="arial, helvetica" size=2>USA-Canada Check:</font></B></td>
	<td align=left width="75%"><font face="arial, helvetica" size=2><?php echo $usacan_check ?></font></td>
	</tr>
	<tr>
	<td align=right><B><font face="arial, helvetica" size=2>Lead Duplicate Check:</font></B></td>
	<td align=left width="75%"><font face="arial, helvetica" size=2><?php echo $dupcheck ?></font></td>
	</tr>
	<tr>
	<td align=right><B><font face="arial, helvetica" size=2>Lead Time Zone Lookup:</font></B></td>
	...
	<input type=hidden name='leadfile_name' value="<?php echo $leadfile_name ?>">
	<input type=hidden name='DB' value="<?php echo $DB ?>">
	<a href="admin_listloader_third_gen.php">Load Another Lead File</a> 
	</td>
	</tr></table>
...
if (($leadfile) && ($LF_path))
	...
	##### BEGIN field chooser #####
		...
		print "<script language='JavaScript1.2'>document.forms[0].leadfile.disabled=true; document.forms[0].submit_file.disabled=true; document.forms[0].reload_page.disabled=true;</script>";
		flush();
		print "<div class=\"col-md-12\"><div class=\"content\">";
		print "<table class='hover' border=0 cellpadding=3 cellspacing=0 width=700 align=center>\r\n";
		print "  <tr >\r\n";
		print "    <th width=30% style=\"text-align:right; border-right:1px solid #CDCDCD ; padding-top:7px ; padding-bottom:7px\">"._QXZ("VICIDIAL Column")."  &nbsp;</th>\r\n";
		...
		print "    <th colspan=2><p style='text-align:center'><input class='btn btn-bdr-sucess' type=submit name='OK_to_process' value='OK TO PROCESS'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class='btn btn-danger' type=button onClick=\"javascript:document.location='admin_listloader_third_gen.php'\" value=\"START OVER\" name='reload_page'></p></th>\r\n";
		print "  </tr>\r\n";
		print "</table></div></div></div></div></div></div></div>\r\n";
