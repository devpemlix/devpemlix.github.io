...
<div id="pcont" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> <?php echo _QXZ("User Status for"); ?> <?php echo $user ?> </h3> </div>
...
echo "<TR class='no-border'><TD ALIGN=LEFT COLSPAN=2 class='no-border'>\n";
...
if ($agents_to_print > 0)
	...
	if ($change_agent_campaign > 0)
		...
		echo "</SELECT></div>\n";
		echo "<input class='btn btn-bdr-sucess' type=submit name=submit value='"._QXZ("CHANGE")."' disabled><BR></form>\n";

		echo "<form action=$PHP_SELF method=POST>\n";
		echo "<input type=hidden name=DB value=\"$DB\">\n";
		echo "<input type=hidden name=user value=\"$user\">\n";
		echo "<input type=hidden name=stage value=\"log_agent_out\">\n";
		echo "<input class='btn btn-bdr-sucess' type=submit name=submit value=\""._QXZ("EMERGENCY LOG AGENT OUT")."\"><BR></form>\n";
		}
	}
...
if ($modify_timeclock_log > 0)
	...
	echo "<div class=\"col-lg-12 spacer\"><input type=submit name=submit value=\"$TC_log_change_button\" class='btn btn-bdr-sucess'></div><BR></form>\n";
	echo "<BR><BR>\n";
	}
