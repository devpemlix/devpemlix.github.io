...
$MAIN.="<div class=\"col-md-12\"><div class=\"content\"><TABLE class=\"no-border\" CELLPADDING=4 CELLSPACING=0>";
$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";

$MAIN.="<TABLE CELLSPACING=3 class='col-lg-12 spacer'><TR style=''><TD VALIGN=TOP>";
$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";

$MAIN.="</TD><TD class='no-border col-lg-4 size'><div class='col-lg-12'>"._QXZ("Campaigns").":</div>";
...
$MAIN.="</SELECT></div><div class='col-lg-12 spacer'><a href=\"AST_LISTS_stats.php?DB=$DB\">"._QXZ("SWITCH TO LISTS")."</a></div>";
$MAIN.="</TD><TD  class='col-lg-4 no-border size' valign=top>";
$MAIN.="<div class='col-lg-12'>"._QXZ("Display as").":</div><div class='col-lg-12'>";
$MAIN.="<select class=form-control name='report_display_type'>";
