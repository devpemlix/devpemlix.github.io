				...
				if ($file_sizes[$m] == $NOWsize)
					...
					if (preg_match('/selectframe/i',$format))
						...
						if ($sf < 1)
							...
							<?php
							echo "<body>\n";
							echo "<a href=\"javascript:close_file();\"><font size=3 face=\"Arial,Helvetica\">close frame</font></a>\n";
							echo "<div id='selectframe' style=\"height:400px;width:710px;margin: 0px 15px;overflow:scroll;\">\n";
							echo "<div style=\" height: 100%; padding: 10px;\">";
							echo "<table class='hover' cellpadding=1 cellspacing=2 width=690><tr>\n";
							echo "<td>#</td>\n";
...
<link href='fonts/font-awesome-4.2.0/css/font-awesome.min.css' rel='stylesheet'/>
			...
			echo "<a href=\"javascript:close_file();\"><font size=3 face=\"Arial,Helvetica\">close frame</font></a>\n";
			echo "<div id='selectframe' style=\"height:400px;width:710px; margin: 0px 15px;overflow:scroll;\">\n";
			echo "<div padding: 10px; style='margin:10'>";
			echo "<table class='hover' cellpadding=1 cellspacing=2 width=690 ><tr>\n";
			echo "<td width=30>#</td>\n";
			...
			while ($moh_to_print > $k) 
				...
				if (preg_match("/1$|3$|5$|7$|9$/i", $sf))
					...
					{$bgcolor='';}
				echo "<tr><td width=30><font size=1 face=\"Arial,Helvetica\">$sf</td>\n";
				...
				echo "<tr ><td colspan=2 width=100><font size=1 face=\"Arial,Helvetica\">&nbsp;</td>\n";
...
<link href='fonts/font-awesome-4.2.0/css/font-awesome.min.css' rel='stylesheet'/>
		...
		echo "<td colspan=2><b>Voicemail Boxes</b></td>\n";
		echo "<td><b>Name</b></td>\n";
			...
			if ($admin_permission < 1)
				...
				if ($session_exists < 1)
					...
					if ($stage == 'text')
						...
						{
						$output  = '';
						$output .= "<TABLE WIDTH=680 CELLPADDING=0 CELLSPACING=5 BGCOLOR=\"#DDD\"><TR><TD ALIGN=LEFT BGCOLOR=\"#DDD\">\n";
						$output .= "Agent: $agent_user - $full_name </TD><TD BGCOLOR=\"#DDD\">\n";
						$output .= " &nbsp; Campaign: $campaign_id</TD><TD BGCOLOR=\"#DDD\">\n";
						$output .= "<a href=\"#\" onclick=\"hide_ingroup_info();\">Close</a></TD></TR><TR><TD COLSPAN=3 BGCOLOR=\"#DDD\">\n";
						...
						if ( ($allowed_user_change_ingroups > 0) and ($stage == 'change') )
							{
							$output .= "<TABLE CELLPADDING=0 CELLSPACING=3 class='col_table'>\n";
							if ($on_hook_agent == 'Y')
								{
							...
							$output .= "<SELECT class=\"form-control\" SIZE=10 NAME=ingroup_new_selections ID=ingroup_new_selections multiple>\n";
							...
							$output .= "<TR><TD ALIGN=RIGHT bgcolor='#fff'>Change, Add, Remove:\n";
							$output .= "</TD><TD ALIGN=LEFT bgcolor='#fff'>\n";
							$output .= "<SELECT class='form-control' SIZE=1 NAME=ingroup_add_remove_change ID=ingroup_add_remove_change>\n";
							...
							$output .= "<SELECT  class='form-control' SIZE=1 NAME=blended ID=blended";
							...
							$output .= "<TR><TD ALIGN=RIGHT bgcolor='#fff'>Set As User Default:\n";
							$output .= "</TD><TD ALIGN=LEFT bgcolor='#fff'>\n";
							$output .= "<SELECT  class='form-control' SIZE=1 NAME=set_as_default ID=set_as_default";
							...
							$output .= "<INPUT TYPE=BUTTON NAME=SUBMIT ID=SUBMIT VALUE=\"Submit Changes\" class='btn btn-bdr-sucess' onclick=\"submit_ingroup_changes('$agent_user')\">\n";
							$output .= "</TD></TR>\n";
