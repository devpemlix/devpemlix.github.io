...
if (strlen($user_group[0]) < 1)
	...
	if ($file_download < 1)
		...
		$GRAPH.="<table cellspacing=\"0\" cellpadding=\"0\" summary=\"AGENT TIME-CLOCK DETAIL\" class=\"horizontalgraph\" style='width:100%'>\n";
		$GRAPH.="  <caption align=\"top\">"._QXZ("AGENT TIME-CLOCK DETAIL")."</caption>\n";
		$GRAPH.="  <tr>\n";
		$GRAPH.="	<td class=\"thgraph\" scope=\"col\" width=20%>"._QXZ("USER/USER GROUP")."</td>\n";
		$GRAPH.="	<td class=\"thgraph\" scope=\"col\" width=30% nowrap>"._QXZ("TIME CLOCK")." </td>\n";
		$GRAPH.="	<td class=\"thgraph\" scope=\"col\" width=50%>"._QXZ("TIME CLOCK PUNCHES")."</td>\n";
		$GRAPH.="  </tr>\n";
...
echo "<TABLE CELLSPACING=3 class='col-lg-12 spacer'><TR class='no-border' style=''><TD class='no-border'><div class='col-lg-12 size no-padding'> "._QXZ("Dates").":</div><div class='col-lg-12 no-padding'>";
...
echo "<div class='col-lg-4 no-padding'><INPUT TYPE=TEXT NAME=query_date_D SIZE=11 class=form-control MAXLENGTH=10 VALUE=\"$query_date_D\"></div><div class='col-lg-1 no-padding'>";
...
echo "</div><div class='col-md-4 no-padding'><INPUT TYPE=TEXT NAME=query_date_T class=form-control SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_T\"></div>";
?>

<?php
//name:ruchita,date=4-dec,change:resize to text//
echo "<br><div class='col-lg-12 size'><div class='col-sm-3' align='center'>"._QXZ("to")."</div></div></div><div class='col-lg-12 no-padding'> <div class='col-lg-4 size no-padding'><INPUT TYPE=TEXT NAME=end_date_D SIZE=11 class=form-control MAXLENGTH=10 VALUE=\"$end_date_D\"></div>";

?>
<div class='col-lg-1 no-padding size'><script language="JavaScript">
var o_cal = new tcal ({
	// form name
	'formname': 'vicidial_report',
	// input name
...
echo "</div><div class='col-lg-4 size no-padding'><INPUT TYPE=TEXT NAME=end_date_T SIZE=9 MAXLENGTH=8 class=form-control VALUE=\"$end_date_T\"></div>";
...
echo "</TD><TD class='no-border'><div class='col-md-12'><div class='col-md-12 size'>"._QXZ("User Groups").":</div>";
echo "<div class='col-md-12'><SELECT SIZE=5 class=form-control NAME=user_group[] multiple>\n";
...
echo "</SELECT></div></div>";
echo "</TD><TD class='no-border' valign=top><div class='col-md-12'><div class='col-lg-12 size'>";
echo _QXZ("Display as").":</div><div class='col-lg-6'>";
echo "<select name='report_display_type' class=form-control>";
if ($report_display_type) {echo "<option value='$report_display_type' selected>$report_display_type</option>";}
echo "<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>HTML</option></select></div>";
echo "</div><div class='col-md-12'><div class='col-lg-12 size'>"._QXZ("Shift").":</div><div class='col-lg-6 no-border'>";
...
echo "</TD><TD class='no-border' style='width:20%;'> ";

echo "";
echo " <a href=\"$LINKbase&stage=$stage&file_download=1\">"._QXZ("DOWNLOAD")."</a> | \n";
echo " <a href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a> </FONT>\n";
echo "</FONT>\n";
echo "</TD></TR><tr style='text-align: center;' class='no-border'><td colspan=5 class='no-border'><div class='col-lg-12'><input class='btn btn-bdr-sucess' type=button value="._QXZ("SUBMIT")." align=center  name=smt id=smt onClick='submit_form()'></div></td></tr></TABLE>";
