...
$MAIN.="<CENTER>\n";
$MAIN.="<TABLE WIDTH=750  cellpadding=2 cellspacing=0 class='block-flat'><TR><TD ALIGN=right >\n";

$MAIN.="<a href=\"./timeclock_report.php\"><B>"._QXZ("TIMECLOCK REPORT")."</a> | ";
$MAIN.="<a href=\"./admin.php?ADD=311111&user_group=$user_group\"><B>"._QXZ("USER GROUP")."</a>\n";
$MAIN.="</TD></TR>\n";


$MAIN.="<TR><TD ALIGN=LEFT COLSPAN=2 style='border-bottom:0px'> &nbsp; \n";

$MAIN.="<form action=$PHP_SELF method=GET>\n";
$MAIN.="<input type=hidden name=DB value=\"$DB\">\n<div class='col-lg-2'>";
$MAIN.="<select size=1 name=user_group class=form-control>$FORMuser_groups</select></div><div class='col-lg-2'>";
...
$MAIN.="<TABLE width=700 cellspacing=0 cellpadding=1 class='hover centerline'>\n";
$MAIN.="<tr><td><b># </b></td><td><b>"._QXZ("USER")."</b> </td><td><b>"._QXZ("NAME")."</b> </td><td><b> "._QXZ("IP ADDRESS")."</b></td><td ><b> "._QXZ("TC TIME")."</b></td><td ><b>"._QXZ("TC LOGIN")."</b></td><td><b> "._QXZ("VICI LAST LOG")."</b></td><td><b> "._QXZ("VICI CAMPAIGN")."</b></td></tr>\n";
	...
	if ( ($Tlogin_sec[$o] > 0) or (strlen($Vevent_time[$o]) > 0) )
		...
		if ( ($Tstatus[$o]=='START') or ($Tstatus[$o]=='LOGIN') )
			...
			if ( ($Tlogin_sec[$o] > 0) and (strlen($Vevent_time[$o]) > 0) )
				{$bgcolor[$o]='bgcolor="#39EE4B"'; $CSV_status=_QXZ("TC Logged in and VICI active");} # green
			}
		else
			{
			if ($Tlogin_sec[$o] > 0)
			...
			if (strlen($Vevent_time[$o]) > 0)
				{$bgcolor[$o]='bgcolor="#FF8B8B"'; $CSV_status=_QXZ("VICI active only");} # red
			if ( ($Tlogin_sec[$o] > 0) and (strlen($Vevent_time[$o]) > 0) )
				{$bgcolor[$o]='bgcolor="#2BA637"'; $CSV_status=_QXZ("TC Logged out and VICI active");} # green
			}

		$s++;
		$MAIN.="<tr $bgcolor[$o] style='color:#000;'>";
		$MAIN.="<td><font size=2>$s</td>";
		$MAIN.="<td><font size=2><a href=\"./user_status.php?user=$users[$o]\"><b>$users[$o]</b></a></td>";
