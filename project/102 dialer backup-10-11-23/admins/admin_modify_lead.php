...
<div id="pcont1" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat" style="margin-bottom:0;"><div class="col-md-12"><div class="content">
<?php 
echo "<a href=\"./admin.php?ADD=100\">"._QXZ("ADMINISTRATION")."</a>: "._QXZ("Lead record modification")."\n";
...
if ($end_call > 0)
	...
	echo "<form><input class='btn btn-bdr-sucess' type=button value=\""._QXZ("Close This Window")."\" onClick=\"javascript:window.close();\"></form>\n";
	...
	if ($lead_count > 0)
		...
		while ($alts_to_print > $c) 
			...
			$alts_output .= "<td><font size=2>$c</td>";
...
#		echo "<a href=\"$PHP_SELF\">Close this window</a>\n<BR><BR>\n";
	...
	while ($Clogs_to_print > $y) 
		...
		$closer_log .= "<td><font size=2>$y</td>";
	...
	if ($lead_id == 'NEW')
		...
		$Lc=0;
		$select_list = "<select class='form-control' size=1 name=list_id>";
...
<?php
	if ($lead_id == 'NEW')
		{echo ""._QXZ("Add A New Lead")."\n";}
	else
		{echo _QXZ("Call information").": $first_name $last_name - $phone_number\n";}
?>
</h3> </div>
...
<?php
	...
	echo "<table cellpadding=1 cellspacing=0 class='col_table table1' style='width: 100%;'>\n";
	echo "<tr><td class='col-lg-3'>"._QXZ("Lead ID").": </td><td class='col-lg-3'>$lead_id </td>&nbsp; &nbsp; <td class='col-lg-3'>"._QXZ("List ID").":</td><td class='col-lg-3'>  $list_id </td>&nbsp; &nbsp; </tr><tr><td class='col-lg-3'>"._QXZ("GMT offset").":</td><td class='col-lg-3'> $gmt_offset_now </td>&nbsp; &nbsp;<td class='col-lg-3'> "._QXZ("CSLR").":</td> <td class='col-lg-3'>$called_since_last_reset</td></tr>\n";
	
 	echo "<tr><td class='col-lg-3'>"._QXZ("Fronter").":</td><td class='col-lg-3'> <A HREF=\"user_stats.php?user=$tsr\">$tsr</A> &nbsp; &nbsp;</td><td class='col-lg-3'> "._QXZ("Called Count").":</td><td class='col-lg-3'> $called_count </td>&nbsp; &nbsp;<td></tr>";
 	
 	echo "<tr><td class='col-lg-3'>"._QXZ("Last Local Call").": </td><td class='col-lg-3'>$last_local_call_time</td></tr>\n";
	...
	if ($LOGadmin_hide_lead_data != '0')
		...
		echo "<tr><td class='col-lg-3 size'>"._QXZ("Title").": </td><td class='col-lg-5'><div class='col-lg-5'>$title &nbsp; \n";
		echo _QXZ("First").": $first_name </div></td></tr>\n";
		echo "<tr><td  align=right>"._QXZ("MI").":  </td><td align=left>$middle_initial &nbsp; \n";
		echo _QXZ("Last").": $last_name </td></tr>\n";
		echo "<tr><td  align=right>"._QXZ("Address1")." : </td><td  align=left>$address1</td></tr>\n";
		echo "<tr><td  align=right>"._QXZ("Address2")." : </td><td  align=left>$address2</td></tr>\n";
		echo "<tr><td  align=right>"._QXZ("Address3")." : </td><td  align=left>$address3</td></tr>\n";
		echo "<tr><td  align=right>"._QXZ("City")." : </td><td  align=left>$city</td></tr>\n";
		echo "<tr><td  align=right>"._QXZ("State").": </td><td  align=left>$state &nbsp; \n";
		echo _QXZ("Postal Code").": $postal_code </td></tr>\n";
		
		
		echo "<tr><td  align=right>"._QXZ("Province")." : </td><td  align=left>$province</td></tr>\n";
		echo "<tr><td  align=right>"._QXZ("Country")." : </td><td  align=left>$country_code</td></tr>\n";
		echo "<tr><td  align=right> "._QXZ("Date of Birth").":  </td><td  align=left> $date_of_birth </td></tr>\n";
		echo "<tr><td  align=right>"._QXZ("Phone")." : </td><td  align=left>$phone_number</td></tr>\n";
		echo "<tr><td  align=right>"._QXZ("DialCode")." : </td><td  align=left>$phone_code</td></tr>\n";
		echo "<tr><td  align=right>"._QXZ("Alt. Phone")." : </td><td  align=left>$alt_phone</td></tr>\n";
		echo "<tr><td  align=right>"._QXZ("Email")." : </td><td  align=left>$email</td></tr>\n";
		echo "<tr><td  align=right>"._QXZ("Show")." : </td><td  align=left>$security</td></tr>\n";
		echo "<tr><td  align=right>"._QXZ("Vendor ID")." : </td><td  align=left>$vendor_id></td></tr>\n";
		...
		echo "<tr><td  align=right>"._QXZ("Comments")." : </td><td  align=left>$comments</td></tr>\n";
		}
		...
		echo "<tr><td class='col-lg-3'>"._QXZ("Title").": </td><td class='col-lg-3'><input type=text name=title class='form-control' size=4 maxlength=4 value=\"$title\"></td><td class='col-lg-3'>";
		echo _QXZ("First").":</td><td class='col-lg-3'><input type=text class='form-control' name=first_name size=15 maxlength=30 value=\"".htmlentities($first_name)."\"> </div></td></tr>\n";
		echo "<tr><td class='col-lg-3'>"._QXZ("MI").":  </td><td class='col-lg-3 '><input type=text name=middle_initial size=4 class='form-control' maxlength=1 value=\"".htmlentities($middle_initial)."\"></td><td class='col-md-3'>";
		echo _QXZ("Last").": </td><td class='col-lg-3'><input type=text name=last_name class='form-control' size=15 maxlength=30 value=\"".htmlentities($last_name)."\"></td></tr>\n";
		echo "<tr><td class='col-lg-3'>"._QXZ("Address1")." : </td><td class='col-lg-3'><input type=text  class='form-control' name=address1 size=30 maxlength=30 value=\"".htmlentities($address1)."\"></td>";
		echo "<td class='col-lg-3'>"._QXZ("Address2")." : </td><td class='col-lg-3'><input type=text class='form-control' name=address2 size=30 maxlength=30 value=\"".htmlentities($address2)."\"></td></tr>\n";
		echo "<tr><td class='col-lg-3'>"._QXZ("Address3")." : </td><td class='col-lg-3'><input type=text class='form-control' name=address3 size=30 maxlength=30 value=\"".htmlentities($address3)."\"></td>";
		echo "<td class='col-lg-3'>"._QXZ("City")." : </td><td class='col-lg-3'><input type=text name=city class='form-control' size=30 maxlength=30 value=\"".htmlentities($city)."\"></td></tr>\n";
		echo "<tr><td class='col-lg-3'>"._QXZ("State")." </td><td class='col-lg-3'><input type=text class='form-control' name=state size=2 maxlength=2 value=\"".htmlentities($state)."\"><td class='col-md-3'>";
		echo _QXZ("Postal Code").":</td><td class='col-lg-3'><input type=text name=postal_code size=10 maxlength=10 class='form-control' value=\"".htmlentities($postal_code)."\"></td></tr>\n";


		echo "<tr><td class='col-lg-3'>"._QXZ("Province")." : </td><td class='col-lg-3'><input type=text name=province class='form-control' size=30 maxlength=30 value=\"".htmlentities($province)."\"></td>\n";
		echo "<td class='col-lg-3  '>"._QXZ("Country")." : </td><td class='col-lg-3'><input type=text name=country_code size=3 class='form-control' maxlength=3 value=\"".htmlentities($country_code)."\"></td></tr>\n";
		echo "<tr><td class='col-lg-3  '> "._QXZ("Date of Birth").": </td><td class='col-lg-3'><input class='form-control' type=text name=date_of_birth size=12 maxlength=10 value=\"".htmlentities($date_of_birth)."\"></td>\n";
		echo "<td class='col-lg-3  '>"._QXZ("Phone")." : </td><td class='col-lg-3'><input type=text name=phone_number size=20 class='form-control' maxlength=20 value=\"".htmlentities($phone_number)."\"></td></tr>\n";
		echo "<tr><td class='col-lg-3  '>"._QXZ("DialCode")." : </td><td class='col-lg-3'><input type=text name=phone_code size=10 class='form-control' maxlength=10 value=\"".htmlentities($phone_code)."\"></td>\n";
		echo "<td class='col-lg-3  '>"._QXZ("Alt. Phone")." : </td><td class='col-lg-3'><input type=text name=alt_phone size=20 class='form-control' maxlength=20 value=\"".htmlentities($alt_phone)."\"></td></tr>\n";
		echo "<tr><td class='col-lg-3  '>"._QXZ("Email")." : </td><td class='col-lg-3'><input type=text name=email size=30 class='form-control' maxlength=50 value=\"".htmlentities($email)."\"></td>\n";
		echo "<td class='col-lg-3  '>"._QXZ("Show")." : </td><td class='col-lg-3'><input type=text name=security size=30 class='form-control' maxlength=100 value=\"".htmlentities($security)."\"></td></tr>\n";
		echo "<tr><td class='col-lg-3  '>"._QXZ("Vendor ID")." : </td><td class='col-lg-3'><input type=text name=vendor_id size=30 class='form-control' maxlength=100 value=\"".htmlentities($vendor_id)."\"></td>\n";
		echo "<td class='col-lg-3  '>Rank : </td><td class='col-lg-3'><input type=text name=rank size=7 class='form-control' maxlength=5 value=\"".htmlentities($rank)."\"></td></tr>\n";
		echo "<tr><td class='col-lg-3  '>Owner : </td><td class='col-lg-3'><input type=text name=owner size=22 maxlength=20 class='form-control' value=\"".htmlentities($owner)."\"></td>\n";
		echo "<td class='col-lg-3  '>"._QXZ("Comments")." : </td><td class='col-lg-3'><TEXTAREA name=comments ROWS=2 COLS=65 class='form-control' >".htmlentities($comments)."</TEXTAREA></td></tr>\n";
		}
	...
	if ($lead_id != 'NEW') 
		{
		echo "<tr><td class='col-lg-3' >"._QXZ("Disposition").": </td><td colspan='3' class='col-lg-12 no-padding' align=left><div class='col-lg-4'><select class='form-control' size=1 name=status>\n";
		...
		echo "$statuses_list";
		echo "</select></div><div class='col-lg-5 spacer'> ("._QXZ("with")." $list_campaign "._QXZ("statuses").")</div></td></tr>\n";


		echo "<tr ><td class='col-lg-2' align=left>"._QXZ("Modify vicidial log")." </td><td colspan='3' align=left><div class='col-md-12'><div class='col-lg-5'><input class='ace' type=checkbox name=modify_logs value=\"1\" CHECKED><label class='lbl'></label></div></div></td></tr>\n";
		echo "<tr><td class='col-lg-2' align=left>"._QXZ("Modify agent log")." </td><td colspan='3' align=left><div class='col-md-12'><div class='col-lg-5'><input class='ace' type=checkbox name=modify_agent_logs value=\"1\" CHECKED><label class='lbl'></label></div></div></td></tr>\n";
		echo "<tr><td class='col-lg-2' align=left>"._QXZ("Modify closer log")." </td><td colspan='3' align=left><div class='col-md-12'><div class='col-lg-5'><input class='ace' type=checkbox name=modify_closer_logs value=\"1\"><label class='lbl'></label></div></div></td></tr>\n";
		echo "<tr ><td class='col-lg-2' align=left>"._QXZ("Add closer log record")." </td><td colspan='3' align=left><div class='col-md-12'><div class='col-lg-5'><input class='ace' type=checkbox name=add_closer_record value=\"1\"><label class='lbl'></label></div></div></td></tr>\n";
		}
	else
		{
	...
	if ( ($LOGadmin_hide_lead_data == '0') or ($lead_id == 'NEW') )
		{
		echo "<tr><td colspan=4 align='center'><p style='text-align:center'><input class='btn btn-bdr-sucess' type=submit name=submit value=\""._QXZ("SUBMIT")."\"></p></td></tr>\n";
		}
	echo "</table></form></div>\n";
	echo "<BR>\n";
	...
	if ($lead_id != 'NEW') 
		...
		echo "<TABLE  WIDTH=750 class='block-flat'><TR><TD>\n";
		echo "<div class=\"col-md-12\"><div class=\"content\">";	
		echo "<B style='color:#000;'>"._QXZ("CALLBACK DETAILS").":</B><br/>";
		//echo "<TABLE  WIDTH=750 class='block-flat'><TR><TD><CENTER>\n";
		...
		if ( ($dispo == 'CALLBK') or ($dispo == 'CBHOLD') or ($scheduled_callback == 'Y') )
			...
			if ($CB_to_print>0)
				...
				if ($rowx[9] == 'USERONLY')
					...
					echo "<center><input type=submit class='btn btn-info' name=submit value=\""._QXZ("CHANGE TO ANYONE CALLBACK")."\"></center></form>\n";
					echo "<form action=$PHP_SELF method=POST>\n";
					echo "<input type=hidden name=CBchangeUSERtoUSER value=\"YES\">\n";
					echo "<input type=hidden name=DB value=\"$DB\">\n";
					echo "<input type=hidden name=lead_id value=\"$lead_id\">\n";
					echo "<input type=hidden name=callback_id value=\"$rowx[0]\">\n";
					echo "<div class='col-lg-12' style='border:1px solid #cdcdc0;padding:10px;'>";
					echo "<div class='col-lg-5 size spacer' style='text-align: right;padding-top:8px;'>"._QXZ("New Callback Owner UserID").":</div><div class='col-lg-4 spacer'> <input type=text name=CBuser class='form-control' size=18 maxlength=20 value=\"$rowx[8]\"></div>";
					echo "<div class='col-lg-12 spacer'><center><input type=submit name=submit class='btn btn-info'value=\""._QXZ("CHANGE USERONLY CALLBACK USER")."\"></center></div></div></form><BR>\n";
					}
				else
					{
					...
					echo "<input type=hidden name=lead_id value=\"$lead_id\">\n";
					echo "<input type=hidden name=callback_id value=\"$rowx[0]\">\n";
					echo "<div class='col-lg-3 size spacer'>"._QXZ("New Callback Owner UserID").":</div><div class='col-lg-2 spacer'> <input type=text class='form-control' name=CBuser size=18 maxlength=20 value=\"$rowx[8]\"></div>";
					echo "<div class='col-lg-3 spacer'><input type=submit class='btn btn-bdr-sucess' name=submit value=\""._QXZ("CHANGE TO USERONLY CALLBACK")."\"></div></form><BR>\n";
					}
				$callback_id = $rowx[0];
				$CBcomments = $rowx[10];
				$lead_status = $rowx[12];
				...
				<BR><div class='col-lg-12 spacer size' align='left' style='font-weight:bold;padding-left:0;color:#000;'><?php echo _QXZ("Change Scheduled Callback Date"); ?>:</div><BR>

				<TABLE class='col-lg-12 spacer' BORDER=0 CELLPADDING=0 CELLSPACING=2 WIDTH=700>
				...
				<TR >
				<TD class='col-lg-2' ALIGN=RIGHT colspan=2><FONT FACE="ARIAL,HELVETICA"><?php echo _QXZ("CallBack Date/Time"); ?>: </TD><TD ALIGN=LEFT class='col-lg-12'><div class='col-lg-2'><input type=text name=appointment_date id=appointment_date size=10 class='form-control' maxlength=10 value="<?php echo $appointment_date ?>"></div><div class='col-sm-1 no-padding'>
				...
				<SELECT name=appointment_hour id=appointment_hour class='form-control'>
				<option>00</option>
				<option>01</option>
				<option>02</option>
				<option>03</option>
				...
				<div class='col-sm-2'>
				<SELECT name=appointment_min id=appointment_min class='form-control'>
				<option>00</option>
				<option>05</option>
				<option>10</option>
				<option>15</option>
				...
				<TR BGCOLOR="">
				<TD align=right class='col-lg-2' colspan=2>
				<FONT FACE="ARIAL,HELVETICA"><?php echo _QXZ("Callback Disposition"); ?>:</td><td class='col-lg-12'><div class='col-lg-3'> <select class='form-control' size=1 name=CBstatus>\n";
				...
				</td><td class='col-lg-12 '> 
                                <div class='col-lg-3'> 
				<TEXTAREA class='form-control' name=comments ROWS=3 COLS=65><?php echo $CBcomments ?></TEXTAREA>
				</div></TD>
				</TR>
				...
				<input type=button value="SUBMIT" class='btn btn-bdr-sucess' name=smt id=smt onClick="submit_form()">
				</TD>
				</TR>
		...
		if ($c > 0)
			...
			echo "<tr><td><font size=2># </td><td><font size=2>"._QXZ("ALT PHONE")." </td><td align=left><font size=2>"._QXZ("ALT NOTE")."</td><td align=left><font size=2> "._QXZ("ALT COUNT")."</td><td align=left><font size=2> "._QXZ("ACTIVE")."</td></tr>\n";
		...
		echo "<TABLE class='hover' width=750 cellspacing=0 cellpadding=1>\n";
		echo "<tr><td><font size=2><b>#</b></td><td><font size=2><b>"._QXZ("DATE/TIME")." </b></td><td align=left><font size=2><b>"._QXZ("LENGTH")."</b></td><td align=left><font size=2><b>"._QXZ("STATUS")."</b></td><td align=left><font size=2><b>"._QXZ("TSR")."</b></td><td align=right><font size=2><b>"._QXZ("CAMPAIGN")."</b></td><td align=right><font size=2><b>"._QXZ("LIST")."</b></td><td align=right><font size=2><b>"._QXZ("LEAD")."</b></td><td align=right><font size=2><b>"._QXZ("HANGUP REASON")."</b></td><td align=right><font size=2><b>"._QXZ("PHONE")."</b></td></tr>\n";
		...
		echo "<TABLE class='hover' width=750 cellspacing=0 cellpadding=1>\n";
		echo "<tr><td><font size=2><b>#</b></td><td><font size=2><b>"._QXZ("DATE/TIME")."</b></td><td align=left><font size=2><b>"._QXZ("LENGTH")."</b></td><td align=left><font size=2><b>"._QXZ("STATUS")."</b></td><td align=left><font size=2><b>"._QXZ("TSR")."</b></td><td align=right><font size=2><<b>"._QXZ("CAMPAIGN")."</b></td><td align=right><font size=2><b>"._QXZ("LIST")."</b></td><td align=right><font size=2><b>"._QXZ("LEAD")."</b></td><td align=right><font size=2><b>"._QXZ("WAIT")."</b></td><td align=right><font size=2><b>"._QXZ("HANGUP REASON")."</b></td></tr>\n";
		...
		echo "<TABLE class='hover' width=750 cellspacing=0 cellpadding=1>\n";
		echo "<tr><td><font size=2><b>#</b></td><td><font size=2><b>"._QXZ("DATE/TIME")."</b></td><td align=left><font size=2><b>"._QXZ("CAMPAIGN")."</b></td><td align=left><font size=2><b>"._QXZ("TSR")."</b></td><td align=left><font size=2><b>"._QXZ("PAUSE")."</b></td><td align=right><font size=2><b>"._QXZ("WAIT")."</b></td><td align=right><font size=2><b>"._QXZ("TALK")."</b></td><td align=right><font size=2><b>"._QXZ("DISPO")."</b></td><td align=right><font size=2><b>"._QXZ("STATUS")."</b></td><td align=right><font size=2><b>"._QXZ("GROUP")."</b></td><td align=right><font size=2><b>"._QXZ("SUB")."</b></td></tr>\n";
		...
		echo "<TABLE class='hover' width=750 cellspacing=1 cellpadding=1>\n";
		echo "<tr><td><font size=2><b>#</b></td><td align=left><font size=2><b>"._QXZ("CAMPAIGN")."</b></td><td><font size=2><b>"._QXZ("DATE/TIME")."</b></td><td align=left><font size=2><b>"._QXZ("CALL MENU")."</b></td><td align=left><font size=2> &nbsp <b>"._QXZ("ACTION")."</b></td></tr>\n";
	...
	##### vicidial agent outbound calls for this time period #####
		...
		if ($allow_emails>0) 
			...
			echo "<TABLE class='hover' width=750 cellspacing=1 cellpadding=1>\n";
			echo "<tr><td><font size=2><b>#</b></td><td><font size=2><b>"._QXZ("DATE/TIME")."</b></td><td align=right><font size=2><b>"._QXZ("USER")."</b></td><td align=right><font size=2><b>"._QXZ("CAMPAIGN")."</b></td><td align=left><font size=2><b>"._QXZ("EMAIL TO")."</b></td><td align=left><font size=2><b>"._QXZ("MESSAGE")."</b></td><td align=right><font size=2><b>"._QXZ("ATTACHMENTS")."</b></td></tr>\n";
		...
		echo "<TABLE class='hover' width=750 cellspacing=1 cellpadding=1>\n";
		echo "<tr><td><font size=2><b>#</b></td><td align=left><font size=2><b>"._QXZ("LEAD")."</b></td><td><font size=2><b>"._QXZ("DATE/TIME")." </b></td><td align=left><font size=2><b>"._QXZ("SECONDS")."</b></td><td align=left><font size=2> &nbsp; <b>"._QXZ("RECID")."</b></td><td align=center><font size=2><b>"._QXZ("FILENAME")."</b></td><td align=left><font size=2><b>"._QXZ("LOCATION")."</b></td><td align=left><font size=2><b>"._QXZ("TSR")."</b></td></tr>\n";
		...
		if ($admin_display > 0)
			{
			echo "<a href=\"./admin.php?ADD=720000000000000&stage=$lead_id&category=LEADS\"><p style='text-align:center'>"._QXZ("Click here to see Lead Modify changes to this lead")."</p></a>\n";
			}
...
//echo "<font size=0>"._QXZ("script runtime").": $RUNtime "._QXZ("seconds")."</font>";
