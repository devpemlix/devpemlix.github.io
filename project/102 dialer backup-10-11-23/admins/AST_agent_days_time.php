...
<html>
<head>
<META charset='utf-8'><META http-equiv='Content-Type' content='text/html; charset=UTF-8'><META NAME="ROBOTS" CONTENT="NONE">
<META NAME="COPYRIGHT" CONTENT="&copy; 2015 ViciDial Group">
<META NAME="AUTHOR" CONTENT="ViciDial Group">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name='description' content=''><meta name='author' content=''><link href="css/style.css" rel="stylesheet" />
<link rel='stylesheet' href='http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.min.css'><link rel='shortcut icon' href='images/icon.png'><script language="JavaScript" src="calendar_db.js"></script>
...
echo "<div class='col-lg-9'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"></div><div class='col-lg-1 no-padding'>";
...
echo "</div><BR><div class='col-lg-12 size'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"._QXZ("to")." </div><BR><div class='col-lg-9'><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div><div class='col-lg-1 no-padding'>";
...
<?php
echo "</div>";
echo "</TD><TD style='border-left:0px' VALIGN=TOP> <div class='col-lg-12 size'>"._QXZ("Campaigns").":</div><BR>";
echo "<div class='col-lg-10 '><SELECT class='form-control' SIZE=5 NAME=group[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
//echo "</TD>";
echo "<TD style='border-left:0px' VALIGN=TOP><div class='col-lg-12 size'>"._QXZ("User").":</div><BR>";
echo "<div class='col-lg-8 '><INPUT class='form-control' TYPE=TEXT SIZE=10 NAME=user value=\"$user\"></div>\n";
echo "<div class='col-lg-12 size'>"._QXZ("Shift").":</div><BR>";
echo "<div class='col-lg-8 '><SELECT class='form-control' SIZE=1 NAME=shift>\n";
echo "<option selected value=\"$shift\">$shift</option>\n";
echo "<option value=\"\">--</option>\n";
echo "<option value=\"AM\">"._QXZ("AM")."</option>\n";
echo "<option value=\"PM\">"._QXZ("PM")."</option>\n";
echo "<option value=\"ALL\">"._QXZ("ALL")."</option>\n";
echo "</SELECT></div><BR><BR></TD><TD style='border-left:0px' VALIGN=center> \n";
echo "<INPUT class='btn btn-bdr-sucess' TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n";
echo "</TD><TD style='border-left:0px' VALIGN=center> &nbsp; &nbsp; &nbsp; &nbsp; ";
