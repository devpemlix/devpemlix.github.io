...
<div class='block-flat'><div class='header'><h3>";
$MAIN.=""._QXZ("$report_name")." <!--$NWB#CLOSERstats_v2$NWE-->\n
</h3></div><div class='col-md-12'><div class='content'><TABLE CELLPADDING=3 CELLSPACING=0><TR><TD>";
...
$MAIN.="<TABLE BORDER=0 CELLPADDING=3 CELLSPACING=0 BGCOLOR=\"#e3e3ff\"><TR><TD VALIGN=TOP class='no-border col-lg-5'>\n";
...
$MAIN.= '<div class="col-lg-12 size no-padding">'._QXZ("Date Range").'</div>';
$MAIN .= "<div class='col-lg-12 no-padding'><div class='col-lg-4 no-padding'>";
$MAIN.="<INPUT TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\" class='form-control'>";
$MAIN.= "</div><div class='col-lg-2' style='padding-right:0;'>";
...
$MAIN.="</script>"._QXZ(" to")."</div>";

$MAIN .= "<div class='col-lg-4 no-padding'>";
$MAIN .= "<INPUT TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\" class='form-control'>";
$MAIB .= "</div>";

$MAIN.= "</div><div class='col-lg-2'>";
$MAIN.="<script language=\"JavaScript\">\n";
$MAIN.="var o_cal = new tcal ({\n";
$MAIN.="	// form name\n";
$MAIN.="	'formname': 'vicidial_report',\n";
...
$MAIN.="</TD><TD ROWSPAN=2 VALIGN=TOP class='no-border col-lg-3'><div class='col-lg-12 no-border no-padding'><div class='col-lg-12 size'>";
if ($CHAT=='Y')
...
$MAIN.="</div><div class='col-lg-12 no-border'>";
$MAIN.="<SELECT SIZE=5 NAME=group[] multiple class='form-control'>\n";
$o=0;
...
$MAIN.="</SELECT></div></div>\n";
$MAIN.="</TD><TD ROWSPAN=2 class='no-border'><div class='col-lg-12 no-padding'>";
...
$MAIN.="</TD></TR>\n";
$MAIN.="<TR><TD class='col-lg-5 no-border'><div class='col-lg-4 no-padding'>\n";
...
#	}
#$MAIN.="</SELECT>\n";
$MAIN.= "<div class='col-lg-12 size no-padding'>"._QXZ("Shift/Call time").":</div><div class='col-lg-12 no-padding'><SELECT SIZE=1 NAME=shift class='form-control'>\n";
...
$MAIN.="</SELECT></div></div><div class='col-md-7'>\n";
$MAIN.="<div class='col-lg-12 size'>"._QXZ("Display as").":&nbsp;</div>";
$MAIN.="<div class='col-lg-10'><select name='report_display_type' class='form-control'>";
if ($report_display_type) {$MAIN.="<option value='$report_display_type' selected>$report_display_type</option>";}
$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select></div></div>\n<BR>";
if ($archives_available=="Y") 
	{
	$MAIN.="<div class='col-md-12'><input type='checkbox' name='search_archived_data' value='checked' $search_archived_data>"._QXZ("Search archived data")."<BR><BR></div></td></tr>\n";
	}

$MAIN.=" &nbsp;<tr><td class='no-border' align='center' style='border:none !important;' colspan='3'><INPUT class='btn btn-bdr-sucess' TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n";
$MAIN.="</TD></TR></TABLE></div></div></div></div></div></div></div>\n";
$MAIN.="</FORM>\n\n";
