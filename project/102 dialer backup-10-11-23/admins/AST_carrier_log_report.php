...
$MAIN.="<div id=\"pcont\" class=\"container-fluid\"><div class=\"cl-mcont\"><div class=\"row\"><div class=\"col-md-12 no-padding\"><div class=\"block-flat\"><div class=\"header\"><h3>"._QXZ("Carrier Log Report")."</h3></div><div class=\"col-md-12\"><div class=\"content\"><TABLE CELLPADDING=4 CELLSPACING=0><TR><TD>";
...
$MAIN.="<INPUT class=\"form-control\" TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"></div>";
...
$MAIN.="<BR><BR><br><div class=\"col-lg-4 no-padding\"><INPUT class=\"form-control\" TYPE=TEXT NAME=query_date_D SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_D\"></div>";

$MAIN.="<div class=\"col-lg-1 no-padding\"> "._QXZ("to")."</div><div class=\"col-lg-4 no-padding\"><INPUT class=\"form-control\" TYPE=TEXT NAME=query_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_T\"></div>";

$MAIN.="</TD><TD ROWSPAN=2 VALIGN=TOP><div class=\"col-md-12 size no-padding\"><div class=\"col-lg-4 size no-padding\">"._QXZ("Server IP").":</div></div><BR/>\n";
$MAIN.="<div class=\"col-lg-10 size no-padding\"><SELECT class=\"form-control\" SIZE=5 NAME=server_ip[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$server_ip_string))
...
$MAIN.="</SELECT></div></TD><TD ROWSPAN=2 VALIGN=middle align=center>\n";
$MAIN.="<INPUT class=\"btn btn-bdr-sucess\" TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'><BR/><BR/>\n";
$MAIN.="</TD></TR></TABLE>\n";
