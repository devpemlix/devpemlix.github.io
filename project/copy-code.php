...
##### NOT INBOUND ONLY ###
	...
	echo "<table class='hover' cellpadding=0 cellspacing=0 class=\"table1 no-border\"><TR>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("DIAL LEVEL").":</B></TD><TD ALIGN=LEFT>&nbsp; $DIALlev&nbsp; &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("TRUNK SHORT/FILL").":</B></TD><TD ALIGN=LEFT>&nbsp; $balanceSHORT / $balanceFILL &nbsp; &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("FILTER").":</B></TD><TD ALIGN=LEFT>&nbsp; $DIALfilter &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT><B> "._QXZ("TIME").":</B> &nbsp; </TD><TD ALIGN=LEFT> $NOW_TIME </TD>";
	echo "";
	echo "</TR>";
	...
	echo "<TR>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("DIALABLE LEADS").":</B></TD><TD ALIGN=LEFT>&nbsp; $DAleads &nbsp; &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("CALLS TODAY").":</B></TD><TD ALIGN=LEFT>&nbsp; $callsTODAY &nbsp; &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("AVG AGENTS").":</B></TD><TD ALIGN=LEFT>&nbsp; $agentsONEMIN &nbsp; &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("DIAL METHOD").":</B></TD><TD ALIGN=LEFT>&nbsp; $DIALmethod &nbsp; &nbsp; </TD>";
	echo "</TR>";
...
### Run through the loop to display agents
	...
	while ($j < $talking_to_print)
		...
		$Luser =			$Auser[$i];
		$user =				sprintf("%-35s", $Auser[$i]);
		$Lsessionid =		$Asessionid[$i];
		$sessionid =		sprintf("%-22s", $Asessionid[$i]);
		$Lstatus =			$Astatus[$i];
