...
if ( ($stage == 'login') or ($stage == 'logout') )
	...
	if ($valid_user < 1)
		...
		$VDdisplayMESSAGE = "</br>"._QXZ("The user and password you entered are not active in the system<BR>Please try again:");
		...
		echo "<IMG SRC=\"./images/"._QXZ("vtc_tab_vicidial.gif")."\" BORDER=0>\n";
		echo "</h3>";
		echo "</div>";
		echo "<div>";
		...
		echo "<CENTER><BR><B>$VDdisplayMESSAGE</B>";
		...
		echo "<div class=\"col-sm-12 no-padding\"><h4 class=\"title\"><B> "._QXZ("Timeclock")." </B></h4></div>";
		//echo "</TR>\n";
...
//		echo "<TR><TD ALIGN=LEFT COLSPAN=2><font size=1><BR>"._QXZ("VERSION:")." $version &nbsp; &nbsp; &nbsp; "._QXZ("BUILD:")." $build</TD></TR>\n";
		...
		if ( ($last_action_sec < 30) and ($status != 'START') )
			...
			echo"<META HTTP-EQUIV=\"Content-Type\" CONTENT=\"text/html; charset=utf-8\">\n";
			echo"</HEAD>\n";
			echo "<BODY class=\"texture\" BGCOLOR=WHITE MARGINHEIGHT=0 MARGINWIDTH=0>\n";
			echo "<div class=\"login-container\">\n";
			echo "<div class=\"middle-login\">\n";
			echo "<div class=\"block-flat\">\n";
			echo "<div class=\"header\">\n";
			...
			echo "<INPUT TYPE=HIDDEN NAME=VD_login VALUE=\"$VD_login\">\n";
			echo "<INPUT TYPE=HIDDEN NAME=VD_pass VALUE=\"$VD_pass\">\n";
			echo "<div class=\"col-md-12\"><B><br/>$VDdisplayMESSAGE</B></div>";
			//echo "<TABLE WIDTH=460 CELLPADDING=0 CELLSPACING=0 BGCOLOR=\"#CCFFCC\"><TR BGCOLOR=WHITE>";
			//echo "<TD ALIGN=LEFT VALIGN=BOTTOM><IMG SRC=\"./images/"._QXZ("vtc_tab_vicidial.gif")."\" BORDER=0></TD>";
			echo "<div class=\"content \">\n";
			echo "<h4 class=\"title color-primary\"><B> "._QXZ("Timeclock")." </B></h4>";
			//echo "</TR>\n";
			//echo "<TR><TD ALIGN=LEFT COLSPAN=2><font size=1> &nbsp; </TD></TR>\n";
		...
		if ($commit == 'YES')
			...
			if ($referrer=='agent') 
				{$BACKlink = "<A HREF=\"./vicidial.php?pl=$phone_login&pp=$phone_pass&VD_login=$user\">"._QXZ("BACK to Agent Login Screen")."</A>";}
			if ($referrer=='admin') 
			...
			echo "</div>\n";
			echo "<div>";
			echo "<div class=\"col-md-12\"><B>$VDdisplayMESSAGE</B></div>";
			//echo "<TABLE WIDTH=460 CELLPADDING=0 CELLSPACING=0 BGCOLOR=\"#CCFFCC\"><TR BGCOLOR=WHITE>";
			//echo "<TD ALIGN=LEFT VALIGN=BOTTOM><IMG SRC=\"./images/"._QXZ("vtc_tab_vicidial.gif")."\" BORDER=0></TD>";
			//echo "<TD ALIGN=CENTER VALIGN=MIDDLE><B> "._QXZ("Timeclock")." </B></TD>";
			echo "<div class=\"content col-md-12\">";
			echo "<h4 class=\"title color-primary\"><strong> "._QXZ("Timeclock")." </strong></h4>";
			//echo "</TR>\n";
			//echo "<TR><TD ALIGN=LEFT COLSPAN=2><font size=1> &nbsp; </TD></TR>\n";
			echo "<div class=\"form-group\"><div class=\"col-sm-12 no-padding\"><B> $LOGtimeMESSAGE<BR>&nbsp; </B></div></div>\n";
			echo "<div class=\"form-group\"><div class=\"col-sm-12\"><B> $BACKlink <BR>&nbsp; </B></div></div>\n";
			//echo "<TR><TD ALIGN=LEFT COLSPAN=2><font size=1><BR>"._QXZ("VERSION:")." $version &nbsp; &nbsp; &nbsp; "._QXZ("BUILD:")." $build</TD></TR>\n";
			//echo "</TABLE>\n";
			echo "</div>";
			echo "</body>\n\n";
		...
		echo "<div class=\"col-md-12 space\"><B>$VDdisplayMESSAGE</B></div>";
		//echo "<TABLE WIDTH=460 CELLPADDING=0 CELLSPACING=0 BGCOLOR=\"#CCFFCC\"><TR BGCOLOR=WHITE>";
		//echo "<TD ALIGN=LEFT VALIGN=BOTTOM><IMG SRC=\"./images/"._QXZ("vtc_tab_vicidial.gif")."\" BORDER=0></TD>";
		echo "<div class=\"content col-md-12\">";
		echo "<h4 class=\"title color-primary\"><strong> "._QXZ("Timeclock")." </strong></h4>";
		//echo "</TR>\n";
		//echo "<TR><TD ALIGN=LEFT COLSPAN=2><font size=1> &nbsp; </TD></TR>\n";
		echo "<div class=\"form-group\"><div class=\"col-sm-12\"><B> $LOGtimeMESSAGE<BR>&nbsp; </B></div></div>\n";
		echo "<INPUT class=\"btn btn-default\" TYPE=SUBMIT NAME=\"$button_name\" VALUE=\"$button_name\"> &nbsp;\n";
		//echo "<TR><TD ALIGN=LEFT COLSPAN=2><font size=1><BR>"._QXZ("VERSION:")." $version &nbsp; &nbsp; &nbsp; "._QXZ("BUILD:")." $build</TD></TR>\n";
		//echo "</TABLE>\n";
		echo "</div>";
		echo "</FORM>\n\n";
...
echo"<link href='css/style.css' rel='stylesheet' />";
	...
	echo "<div class=\"header\">\n";
	echo "<h3 class=\"text-center\">\n";
	echo "<IMG SRC=\"./images/"._QXZ("vtc_tab_vicidial.gif
