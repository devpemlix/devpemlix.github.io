...
echo "<img class=\"logo-img\" src=\"./images/"._QXZ("vtc_tab_vicidial.gif")."\" border=\"0\" alt=\"VICIdial\" />\n";
echo "</h3>";
echo "</div>\n";
echo "<div>\n";
...
echo "<h4 class=\"title\"> "._QXZ("Phone-Only Login")." </h4>";
echo "</div>\n\n";

echo "<div class=\"form-group\">\n";
    	echo "<div class=\"col-sm-6\">\n";
    	echo "<div class=\"input-group\">\n";
    	echo "<input class=\"form-control\" placeholder=\"Phone Login\" type=\"text\" name=\"phone_login\" size=\"10\" maxlength=\"20\"
 value=\"$phone_login\" />\n";
	echo "</div>\n";
	echo "</div>\n";
...
echo "<div class=\"col-sm-6\">\n";
    	echo "<div class=\"input-group\">\n";
	echo "<input class=\"form-control\" placeholder=\"Phone Password\" type=\"password\" name=\"phone_pass\" size=\"10\" maxlength=\"20\" 
value=\"$phone_pass\" />\n";
    	echo "</div>\n";
    	echo "</div>\n";
    	echo "</div>\n";
...
echo "<div class=\"col-sm-6\">\n";
    	echo "<div class=\"input-group\">\n";
	echo "<input class=\"form-control\" placeholder=\"User Login\" type=\"text\" name=\"VD_login\" size=\"10\" maxlength=\"20\" 
value=\"$VD_login\" />\n";
    	echo "</div>\n";
    	echo "</div>\n";
...
echo "<div class=\"col-sm-6\">\n";
    	echo "<div class=\"input-group\">\n";
	echo "<input class=\"form-control\" placeholder=\"User Password\" type=\"password\" name=\"VD_pass\" size=\"10\" maxlength=\"20\" 
value=\"$VD_pass\" />\n";
    	echo "</div>\n";
    	echo "</div>\n";
    	echo "</div>\n";
...
echo "<div class=\"foot no-padding\">\n";
	echo "<div class=\"form-group\">\n";
	echo "<div class=\"col-sm-12\" style=\"margin-left:13px;\">\n";
...
echo "<meta name='viewport' content='width=device-width'>";
		...
		echo "<meta http-equiv='X-UA-Compatible' content='IE=edge'>";
	echo "</head>\n";
	echo "<body class=\"texture\" onload=\"browser_dimensions();\" onresize=\"browser_dimensions();\">\n";
	if ($hide_timeclock_link < 1)
		{echo "<a href=\"./timeclock.php?referrer=agent&amp;pl=$phone_login&amp;pp=$phone_pass&amp;VD_login=$VD_login&amp;VD_pass=$VD_pass\"> Timeclock</a><br />\n";}
	/*echo "<table width=100%><tr><td></td>\n";
	echo "<!-- INTERNATIONALIZATION-LINKS-PLACEHOLDER-VICIDIAL -->\n";
...
echo "<meta name='viewport' content='width=device-width'>";
	...
	echo "<div class=\"content\">\n";
        ...
        echo "<center><br /><b>$VDdisplayMESSAGE</b><br />";
...
echo "<meta name='viewport' content='width=device-width'>";
	...
	echo "<div class=\"col-sm-12 no-padding\">\n"; 
    	echo "<h4 class=\"title\"> "._QXZ("Phone-Only Login Error")." </h4>";
    	echo "</div>\n\n";
	
	echo "<div class=\"col-sm-12 no-padding\" style=\"margin-left:13px;\">\n"; 
	echo "<p>Sorry, your phone login and password are not active in this system, please try again: <br /></p>";
	echo "</div>\n\n";
...
value=\"$phone_pass\" />\n";
	...
	echo "<div class=\"col-sm-12\" >\n";
        ...
        echo "<input class=\"btn btn-default\" type=\"submit\" name=\"SUBMIT\" value=\""._QXZ("Submit")."\" /></td></tr>\n";
	echo "</div>\n";
	echo "</div>\n";
	echo "</div>\n";
       // echo "<tr><td align=\"left\" colspan=\"2\"><font size=\"1\"><br />"._QXZ("VERSION:")." $version &nbsp; &nbsp; &nbsp; "._QXZ("BUILD:")." $build</font></td></tr>\n";
	...
	### logged in and use that phone login account
		...
		if ($webphone_location == 'bar')
			{
			$webphone_content = "<iframe src=\"$WebPhonEurl\" style=\"width:1355px;height:500px;background-color:transparent;z-index:17;\" scrolling=\"no\" frameborder=\"0\" allowtransparency=\"true\" id=\"webphone\" name=\"webphone\" width=\"" . $webphone_width . "px\" height=\"" . $webphone_height . "px\"> </iframe>";
			}
		else
			{
			$webphone_content = "<iframe src=\"$WebPhonEurl\" style=\"width:1355px;height:500px;background-color:transparent;z-index:17;\" scrolling=\"auto\" frameborder=\"0\" allowtransparency=\"true\" id=\"webphone\" name=\"webphone\" width=\"" . $webphone_width . "px\" height=\"" . $webphone_height . "px\"> </iframe>";
			}
...
if ($webphone_location == 'bar')
	...
	{
    echo "<span id=\"webphoneSpanDEFAULT\"><center>Web Phone: </center><center><span id=\"webphonecontent\">$webphone_content</span></center></span>\n";
	}
?>
