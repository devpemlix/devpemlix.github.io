...
print_r($_REQUEST);exit;*/
	...
	elseif ($enable_move_count == "enabled")
		...
		/*echo "$move_parm<br>";
	echo "WHERE list_id = '$move_from_list' $sql_where";exit;*/
	...
	if ( $to_list_lead_count + $move_lead_count > $list_lead_limit )
		...
		echo "<input class='btn btn-bdr-sucess' type=submit name=confirm_move value='"._QXZ("confirm")."'>\n";
		echo "</form></center>\n";
		echo "<p><a href='$PHP_SELF'>"._QXZ("Click here to start over").".</a></p>\n";
		echo "</body>\n</html>\n";
		}
...
if ($confirm_move == "confirm")
	...
	echo $move_lead_stmt = "UPDATE vicidial_list SET list_id = '$move_to_list' WHERE list_id = '$move_from_list' $sql_where";exit;
...
if ($update_submit == "update" )
	...
	echo "<input type=hidden name=DB value='$DB'>\n";
	echo "<input class='btn btn-bdr-sucess' type=submit name=confirm_update value='"._QXZ("confirm")."'>\n";
	echo "</form></center>\n";
	echo "<p><a href='$PHP_SELF'>"._QXZ("Click here to start over").".</a></p>\n";
	echo "</body>\n</html>\n";
...
if (
	...
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='move_entry_date' id='move_entry_date' value='' disabled=true></div> <div>(YYYY-MM-DD)</div></div>\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Modify Date")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace'  type='checkbox' name='enable_move_modify_date' id='enable_move_modify_date' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='move_modify_date' id='move_modify_date' value='' disabled=true></div><div> (YYYY-MM-DD)</div></div>\n";
	echo "</td></tr>\n";
	...
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Entry Date")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_update_entry_date' id='enable_update_entry_date' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='update_entry_date' id='update_entry_date' value='' disabled=true> </div><div>(YYYY-MM-DD)</div></div>\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Modify Date")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_update_modify_date' id='enable_update_modify_date' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='update_modify_date' id='update_modify_date' value='' disabled=true></div><div> (YYYY-MM-DD)</div></div>\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Security Phrase")."</td></td><td align=left>\n";
	...
	if ( $delete_lists > 0 )
		...
		echo "</td></tr>\n";
		echo "<tr ><td class='col-sm-3'>"._QXZ("Entry Date")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_delete_entry_date' id='enable_delete_entry_date' value='enabled'><label class=\"lbl\"></label></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='delete_entry_date' id='delete_entry_date' value='' disabled=true></div><div>(YYYY-MM-DD)</div></div>\n";
		echo "</td></tr>\n";
		echo "<tr ><td class='col-sm-3'>"._QXZ("Modify Date")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_delete_modify_date' id='enable_delete_modify_date' value='enabled'><label class=\"lbl\"></label></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='delete_modify_date' id='delete_modify_date' value='' disabled=true></div><div>(YYYY-MM-DD)</div></div>\n";
		echo "</td></tr>\n";
		echo "<tr ><td class='col-sm-3'>"._QXZ("Security Phrase")."</td></td><td align=left>\n";
