...
$HTML_text.='<div id="pcont" class="container-fluid">
		...
		<div class="col-md-12"><div class="content"><div class="block-flat">';
$HTML_text.="<div class='header'><h3>"._QXZ("$report_name")."</h3></div>";
$HTML_text.="<TABLE CELLPADDING=3 CELLSPACING=0 class='spacer no-padding col-md-12'><TR><TD>";
...
$HTML_text.="<TABLE CELLSPACING=3 class=''><TR style=''><TD class='no-border col-lg-4'><div class='col-lg-12 size no-padding'>"._QXZ("Dates").":</div>";
...
$HTML_text.="<div class='col-md-12 size'><div class='col-md-4 no-padding'><INPUT TYPE=TEXT NAME=query_date_D SIZE=11 class=form-control MAXLENGTH=10 VALUE=\"$query_date_D\"></div>";

$HTML_text.="<div class='col-md-1 no-padding'><script language=\"JavaScript\">\n";
...
$HTML_text.="<div class='col-md-4 no-padding'><INPUT TYPE=TEXT NAME=query_date_T SIZE=9 class=form-control MAXLENGTH=8 VALUE=\"$query_date_T\"></div>";
//name:ruchita,date:4-dec,change:resize to text//
$HTML_text.="</div><div class='col-lg-12 no-padding size'><div class='col-sm-3' align='center'>"._QXZ("to")." </div> </div><div class='col-md-12'><div class='col-md-4 no-padding'><INPUT TYPE=TEXT NAME=end_date_D SIZE=11 class=form-control MAXLENGTH=10 VALUE=\"$end_date_D\"></div>";
...
$HTML_text.="</div> <div class='col-md-4 no-padding'> <INPUT TYPE=TEXT NAME=end_date_T SIZE=9 class=form-control MAXLENGTH=8 VALUE=\"$end_date_T\"></div></div>";

$HTML_text.="</TD><TD  class='no-border'>"._QXZ("Campaigns").":<BR>";
...
$HTML_text.="\n";
$HTML_text.="</TD><TD class='no-border'> &nbsp; &nbsp; &nbsp; &nbsp; ";
...
$HTML_text.=" <a href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a></TD></TR>";
$HTML_text.="<tr><td class='no-border' colspan=4 align=center><INPUT TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'  align=center class='btn btn-bdr-sucess'>";
...
$HTML_text.="</PRE></div></div></div></div></div></div></div></BODY></HTML>";
