...
$HTML_text.="<TABLE CELLPADDING=4 CELLSPACING=0 class=block-flat><TR><TD class='col-lg-12 spacer2'>";
...
$HTML_text.="<div class='col-lg-2 no-padding spacer'><INPUT TYPE=TEXT NAME=query_date class=form-control SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"></div><div class='col-sm-11 no-padding spacer'>";
...
$HTML_text.="</script></div><div class='col-lg-2 spacer no-padding'>\n";


$HTML_text.="<SELECT SIZE=1 NAME=group class=form-control>\n";
	$o=0;
...
$HTML_text.="<div class='col-lg-2 spacer'><select name='report_display_type' class=form-control>";
if ($report_display_type) {$MAIN.="<option value='$report_display_type' selected>$report_display_type</option>";}
$HTML_text.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select>\n</div><div class='col-lg-1 spacer'>";
$HTML_text.="<SELECT SIZE=1 NAME=shift class=form-control>\n";
...
$HTML_text.="</SELECT>\n</div><div class='col-lg-4 spacer'>";
$HTML_text.="<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";

$HTML_text.=" <a href=\"$PHP_SELF?query_date=$query_date&group=$group&shift=$shift&file_download=1\">"._QXZ("DOWNLOAD")."</a> | <a href=\"./admin.php?ADD=3111&group_id=$group\">"._QXZ("MODIFY")."</a> | <a href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a>";
$HTML_text.="<INPUT TYPE=submit NAME=SUBMIT VALUE=SUBMIT class='btn btn-bdr-sucess'></div>\n";
$HTML_text.="</FORM></div>";
