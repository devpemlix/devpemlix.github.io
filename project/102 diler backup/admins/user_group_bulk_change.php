...
echo "<div class=\"col-lg-3 \">"._QXZ("Change Users in this group").":</div><div class=\"col-lg-3\"> <SELECT class='form-control' SIZE=1 NAME=old_group>\n";
$o=0;
...
echo "</SELECT></div>\n";
echo " &nbsp;<div class=\"col-lg-2 \"> "._QXZ("to this group").":</div> <div class=\"col-lg-3\"><SELECT class='form-control' SIZE=1 NAME=group>\n";
$o=0;
while ($groups_to_print > $o)
	{
	echo "<option value=\"$groups[$o]\">$groups[$o] - $group_names[$o]</option>\n";
...
echo "</SELECT></div>\n";
echo "<BR><br><br><CENTER><input class=\"btn btn-bdr-sucess\" type=submit name=submit value='"._QXZ("SUBMIT")."'></CENTER><BR></form>\n";
...
echo "<div class=\"col-lg-4 \">"._QXZ("Change ALL non-Admin Users to this group").":</div> <div class=\"col-lg-3\"><SELECT class=\"form-control\" SIZE=1 NAME=group>\n";
$o=0;
while ($groups_to_print > $o)
	{
	echo "<option value=\"$groups[$o]\">$groups[$o] - $group_names[$o]</option>\n";
