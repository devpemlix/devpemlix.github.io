...
<div class="col-md-12">
	<div class="fd-tile detail">
		<div class="page-head">
			<a href="<?php echo "$PHP_SELF" ?>"><?php echo _QXZ("List Territories"); ?></a>
			  |  
			<a href="<?php echo "$PHP_SELF" ?>?action=ADD_TERRITORY"><?php echo _QXZ("Add Territory"); ?></a>
			  |  
			<a href="<?php echo "$PHP_SELF" ?>?action=ADD_USER_TERRITORY"><?php echo _QXZ("Add User Territory"); ?></a>
		</div>
	</div>
</div>
<?php
	...
	//echo "<TABLE  height=\"15\" width=\"770\" cellspacing=\"0\" cellpadding=\"2\"><TR style='background:transparent;'><TD>\n";
	//echo "<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2>";
	echo "<div id=\"pcont\" class=\"container-fluid\">
		...
		?>
		<!--<TABLE WIDTH=<?php echo $page_width ?>  class='no-padding' cellpadding=2 cellspacing=0>-->
<?php
if ($enable_vtiger_integration > 0)
	{ ?>
...
if ($action == "ADD_USER_TERRITORY")
	{		
		echo "<div class=\"header\"><h3>"._QXZ("Add User Territory")." </h3> </div>";
		echo "<br><form action=$PHP_SELF method=POST><div class='col-md-12 spacer'><div class='content'>\n";
		echo "<TABLE class='col_table'><TR><TD>\n";
		echo "<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2>";
		echo "<input class='form-control' type=hidden name=action value=PROCESS_ADD_USER_TERRITORY>\n";
		echo "<center><TABLE width=$section_width cellspacing=3 class='no-border'>\n";
		echo "<tr><td align=right>"._QXZ("Agent").": </td><td align=left><div class='col-lg-6'><select class='form-control' size=1 name=user>\n";
	...
	echo "<tr><td align=right>"._QXZ("Territory").": </td><td align=left><div class='col-lg-6'><select class='form-control' size=1 name=territory>\n";
	...
	echo "$territories_list";
	echo "</select></div></td></tr>\n";
	echo "<tr><td align=right>"._QXZ("Level").": </td><td align=left><div class='col-lg-6'><select class='form-control' size=1 name=level><option value='TOP_AGENT'>"._QXZ("TOP_AGENT")."</option><option value='STANDARD_AGENT'>"._QXZ("STANDARD_AGENT")."</option><option value='BOTTOM_AGENT'>"._QXZ("BOTTOM_AGENT")."</option></select></div></td></tr>\n";
	echo "<tr><td align=center colspan=2><input type=submit class='btn btn-bdr-sucess' name=SUBMIT value='"._QXZ("SUBMIT")."'></td></tr>\n";
	echo "</TABLE></center>\n";
	}
...
if ($action == "PROCESS_MODIFY_USER_TERRITORY")
	...
	if ( (strlen($territory)<1) or (strlen($user)<1) or (strlen($level)<1) )
		...
		if ($row[0] < 0)
			...
			echo _QXZ("User Territory Modifiedfff").": $user $territory<BR>\n";
...
if ($action == "ADD_TERRITORY")
	{
		echo "<div class=\"header\"><h3>"._QXZ("Add Territory")." </h3> </div>";
		echo "<br><form action=$PHP_SELF method=POST><div class='col-md-12 spacer'><div class='content'>\n";
		echo "<TABLE class='col_table'><TR><TD>\n";
		echo "<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2>";
		echo "<input type=hidden name=action value=PROCESS_ADD_TERRITORY>\n";
		echo "<center><TABLE width=$section_width cellspacing=3 class='no-border'>\n";
		echo "<tr><td align=right>"._QXZ("Territory").": </td><td align=left><div class='col-lg-6'><input class='form-control' type=text name=territory size=30 maxlength=100></div></td></tr>\n";
		echo "<tr><td align=right>"._QXZ("Territory Description").": </td><td align=left><div class='col-lg-6'><input class='form-control' type=text name=territory_description size=50 maxlength=255></div></td></tr>\n";
		echo "<tr><td align=center colspan=2><input type=submit class='btn btn-bdr-sucess' name=SUBMIT value='"._QXZ("SUBMIT")."'></td></tr>\n";
...
if ($action == "MODIFY_TERRITORY")
	...
	if ($territories_to_print > 0) 
		...
		echo "<div class=\"header\"><h3>"._QXZ("Modify Territory")." </h3> </div>";
		echo "<br><form action=$PHP_SELF method=POST><div class='col-md-12 spacer'><div class='content'>\n";
		//echo "<TABLE class='hover' cellspacing='3'><TR><TD>\n";
		...
		echo "<center><TABLE class='hover' width=$section_width cellspacing=3>\n";
		echo "<tr><td align=right>"._QXZ("Territory").": </td><td align=left><div class='col-lg-5'>$rowx[0]</div></td></tr>\n";
		echo "<tr><td align=right>"._QXZ("Territory Description").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=territory_description size=50 maxlength=255 value=\"$rowx[1]\"></td></div></tr>\n";
		...
		echo "<tr><td align=right>"._QXZ("Agents").": </td><td align=left><div class='col-lg-5'>user_count</div></td></tr>";
		...
		echo "<tr><td align=right>"._QXZ("Accounts").": </td><td align=left><div class='col-lg-5'>$owner_count</div></td></tr>";
		...
		echo "<tr><td align=center colspan=2><input class='btn btn-bdr-sucess' type=submit name=SUBMIT value='"._QXZ("SUBMIT")."'></form></td></tr>\n";
		echo "</TABLE></center>\n";
		echo "<BR><BR>\n";

		echo "<TABLE CELLPADDING=3 CELLSPACING=1 WIDTH=600><TR><TD COLSPAN=5><FONT FACE=\"ARIAL,HELVETICA\">"._QXZ("Users in this Territory").":</TD></TR>\n";
		...
		#	echo "<TD>Accounts: $owner_count</TD>";
			...
			echo "<div class='col-lg-6'><select class='form-control' size=1 name=level><option SELECTED>$Tlevel[$o]</option><option value='TOP_AGENT'>"._QXZ("TOP_AGENT")."</option><option value='STANDARD_AGENT'>"._QXZ("STANDARD_AGENT")."</option><option value='BOTTOM_AGENT'>"._QXZ("BOTTOM_AGENT")."</option></select></div>";
...
if ($action == "LIST_ALL_TERRITORIES")
	{
		echo "<div class=\"header\"> <h3>"._QXZ("List All Territories")." </h3> </div><div class='col-md-12'>
<div class='content'>";
	//echo "<TABLE><TR><TD>\n";
	//echo "<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2>";
	...
	echo "<Th>#</Th>";
	echo "<Th>"._QXZ("ID")."</Th>";
	echo "<Th>"._QXZ("TERRITORY")."</Th>";
	echo "<Th>"._QXZ("DESCRIPTION")."</Th>\n";
	echo "<Th>"._QXZ("AGENTS")."</Th>\n";
	echo "<Th>"._QXZ("ACCOUNTS")."</Th></thead>\n";
