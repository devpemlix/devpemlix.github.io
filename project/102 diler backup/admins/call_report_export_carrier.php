...
if ($file_exported < 1)
	...
	echo "<div class='col-lg-12 no-padding'><B>"._QXZ("Date Range").":</B></font></div><BR><CENTER>\n";
	echo "<div class='col-md-9 no-padding'><INPUT TYPE=TEXT NAME=query_date class=form-control SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"></div><div class='col-md-2'>";
	...
	echo "<div class='col-lg-10 no-padding'><SELECT SIZE=6 class=form-control NAME=campaign[] multiple>\n";
		$o=0;
	...
	if ($ivr_export != 'YES')
		...
		echo "<div class='col-lg-12 no-padding'><SELECT class=form-control SIZE=6 NAME=group[] multiple>\n";
			$o=0;
	...
	echo "<div class='col-lg-10 no-padding'><SELECT class=form-control SIZE=6 NAME=list_id[] multiple>\n";
		$o=0;
	...
	echo "<div class='col-lg-14 no-padding'><SELECT class=form-control SIZE=6 NAME=status[] multiple>\n";
		$o=0;
	...
	if ($ivr_export != 'YES')
		{
		echo "</TD><TD ALIGN=LEFT VALIGN=TOP class='no-border col-sm-2'>\n";
	echo "<font class=\"select_bold\"><B>"._QXZ("User Groups").":</B></font><CENTER>\n";
		echo "<SELECT class=form-control SIZE=6 NAME=user_group[] multiple>\n";
			$o=0;
	...
	echo "<td class='no-border col-sm-2'><div class='col-lg-12 no-padding'><B><br/><br/>"._QXZ("Header Row").":</B></div>\n";
	echo "<div class='col-lg-6 no-padding'><select size=1 name=header_row class=form-control><option selected><br/><br/>"._QXZ("YES")."</option><option>"._QXZ("NO")."</option></select></div></td>\n";

	echo "<td class='no-border col-sm-2'><div class='col-lg-12 no-padding'><B><br/><br/>"._QXZ("Recording Fields").":</B></div>\n";
	echo "<div class='col-lg-9 no-padding'><select size=1 name=rec_fields class=form-control>";
...
if ($custom_fields_enabled > 0)
		...
		echo "<B><br/><br/>"._QXZ("Custom Fields").":</B></div>\n";
		echo "<div class='col-lg-6 no-padding'><select size=1 name=custom_fields class=form-control><option value='YES'>"._QXZ("YES")."</option><option value='NO' selected><br/><br/>"._QXZ("NO")."</option></select></div></td>\n";
		}

	echo "\n";

	echo "<td class='no-border col-sm-2'><div class='col-lg-12 no-padding'><B><br/><br/>"._QXZ("Per Call Notes").":</B></div>\n";
	echo "<div class='col-lg-6 no-padding'><select size=1 name=call_notes class=form-control><option>"._QXZ("YES")."</option><option selected>"._QXZ("NO")."</option></select></div></td>\n";


	echo "\n";

	echo "<td class='no-border col-sm-2'><div class='col-lg-9 no-padding'><B><br/><br/>"._QXZ("Export Fields").":</B></div>\n";
	echo "<div class='col-lg-9 no-padding'><select size=1 name=export_fields class=form-control><option selected><br/><br/>"._QXZ("STANDARD")."</option><option><br/><br/>"._QXZ("EXTENDED")."</option></select></div></td>\n";


	if (($outbound_to_print > 0) or ($inbound_to_print > 0)) {
		$rslt_msg="<a class='btn btn-bdr-sucess' href='$PHP_SELF?run_export=$run_export&ivr_export=$ivr_export&query_date=$query_date&end_date=$end_date&header_row=$header_row&rec_fields=$rec_fields&custom_fields=$custom_fields&call_notes=$call_notes&export_fields=$export_fields$campaignQS$groupQS$user_groupQS$listQS$statusQS&SUBMIT=SUBMIT&file_download=1'>Download file here</a>";
	}

	echo "</TD></TR><TR></TD><TD ALIGN=CENTER VALIGN=TOP COLSPAN=6 class='no-border'>\n";
