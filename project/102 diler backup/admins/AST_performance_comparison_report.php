...
//$HTML_text.="<TABLE class='' CELLPADDING=4 CELLSPACING=0><TR><TD>";
...
$HTML_text.="<TABLE CELLSPACING=3 class='block-flat spacer'>";
//$HTML_text.="<b>"._QXZ("$report_name")."</b> $NWB#performance_comparison_report$NWE\n";
$HTML_text.="<TR class='no-border' style=''><TD class='col-lg-3 no-border size' valign=top><div class='col-lg-12'>"._QXZ("Date").":</div> ";
...
$HTML_text.="</div><div class='col-lg-5 no-padding'></TD><TD class='no-border size'>"._QXZ("Campaigns").":<BR>";
...
$HTML_text.="</SELECT>\n";
$HTML_text.="</TD><TD class='col-lg-2  no-border size' valign=top>"._QXZ("Shift").":<BR>";
$HTML_text.="<div class='col-lg-9 no-padding'><SELECT SIZE=1 class=form-control NAME=shift>\n";
...
$HTML_text.="<div class=\"col-lg-12 no-padding\">"._QXZ("Display as").":<BR>";
$HTML_text.="<div class='col-lg-9 no-padding'><select name='report_display_type' class=form-control>";
if ($report_display_type) {$HTML_text.="<option value='$report_display_type' selected>$report_display_type</option>";}
$HTML_text.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select></div>\n";
$HTML_text.="</TD>";
$HTML_text.="<TD class='no-border'> &nbsp; &nbsp; &nbsp; &nbsp; ";
$HTML_text.=" <a href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a> </FONT>\n";
$HTML_text.="</TD></TR><tr><td class='no-border' align=center colspan=6><INPUT TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'><!--$NWB#agent_performance_detail$NWE-->";
...
if (!$group)
	...
	$GRAPH="</PRE><table cellspacing=\"1\" cellpadding=\"0\" bgcolor=\"white\" summary=\"LIST ID Summary\" class=\"horizontalgraph\" style='width:100%;'>\n";
