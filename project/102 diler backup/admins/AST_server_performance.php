...
//echo "<link href='fonts/font-awesome-4/css/font-awesome.min.css' rel='stylesheet'/>\n";
...
echo "<TABLE CELLPADDING=4 CELLSPACING=0 class='table1 col_table'><TR><TD>";

echo "<FORM ACTION=\"$PHP_SELF\" METHOD=GET>\n";
//echo "<div class='header' style='border-bottom:1px solid #5BC0DE;'><h4>Server Performance Report</h4></div>";
echo "<div class='col-lg-1 spacer no-padding'>"._QXZ("Date/Time Range").":</div><div class='col-lg-2 no-padding'> <INPUT TYPE=TEXT NAME=begin_query_time SIZE=22 class=form-control MAXLENGTH=19 VALUE=\"$begin_query_time\"></div><div class='col-xs-1  spacer'> \n";
echo _QXZ("to")." </div><div class='col-lg-2 no-padding'><INPUT TYPE=TEXT NAME=end_query_time SIZE=22 class=form-control MAXLENGTH=19 VALUE=\"$end_query_time\"></div><div class='col-lg-1  spacer'> \n";
echo _QXZ("Server").":</div><div class='col-lg-2 '> <SELECT SIZE=1 NAME=group class=form-control>\n";
$o=0;
...
echo "</SELECT></div><div class='col-lg-1 '> \n";
echo "<INPUT TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'>\n";
echo "</div><div class='col-lg-1 spacer'> <a href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a></div>\n";
echo "</FORM>\n\n";

echo "<PRE class='col-lg-12 spacer'><FONT SIZE=2>\n";
