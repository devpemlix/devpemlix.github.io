...
if ($RTajax > 0)
	...
	function hide_ingroup_info()
		...
		document.getElementById("agent_ingroup_display").innerHTML = '';
				...
				document.getElementById("chartContainer").addEventListener("mouseover", function(){
				document.getElementById("chartContainer").style.background = "yellow";
				});
	...
	<!--
		...
		.blue {color: black; background-color: blue}
	...
	echo "<TITLE>$report_name: $group</TITLE></HEAD><BODY  marginheight=0 marginwidth=0 leftmargin=0 topmargin=0 >\n";
...
if ($RTajax < 1)
	{
	echo "abcd<TABLE CELLPADDING=4 CELLSPACING=0><TR><TD>";
...
if ( ($ALLINGROUPstats > 0) or ( (preg_match('/O/',$with_inbound)) and ($adastats > 1) ) )
	...
	while ($ingroups_to_print > $r)
		...
		$ingroup_detail .= "<TR >";
		$ingroup_detail .= "<TD ALIGN=RIGHT > &nbsp; &nbsp; &nbsp; &nbsp; </TD>";
		$ingroup_detail .= "<TD ALIGN=RIGHT><B>$ingroupdetail &nbsp; </B></TD>";
		$ingroup_detail .= "<TD ALIGN=RIGHT><B>"._QXZ("CALLS TODAY").":</B></TD><TD ALIGN=LEFT>&nbsp; $callsTODAY&nbsp; &nbsp; </TD>";
		$ingroup_detail .= "<TD ALIGN=RIGHT><B>"._QXZ("TMA")." 1</B></TD><TD ALIGN=LEFT>&nbsp; $PCThold_sec_stat_one% &nbsp; &nbsp; </TD>";
		$ingroup_detail .= "<TD ALIGN=RIGHT><B>"._QXZ("Average Hold time for Answered Calls").":</B></TD><TD ALIGN=LEFT>&nbsp; $AVGhold_sec_answer_calls &nbsp; </TD>";
		$ingroup_detail .= "</TR>";
		$ingroup_detail .= "<TR >";
		$ingroup_detail .= "<TD ALIGN=RIGHT ></TD><TD ALIGN=LEFT></TD>";
		$ingroup_detail .= "<TD ALIGN=RIGHT><B>"._QXZ("DROPS TODAY").":</B></TD><TD ALIGN=LEFT>&nbsp; $dropsTODAY&nbsp; &nbsp; </TD>";
		$ingroup_detail .= "<TD ALIGN=RIGHT><B>"._QXZ("TMA")." 2:</B></TD><TD ALIGN=LEFT>&nbsp; $PCThold_sec_stat_two% &nbsp; &nbsp; </TD>";
		$ingroup_detail .= "<TD ALIGN=RIGHT><B>"._QXZ("Average Hold time for Dropped Calls").":</B></TD><TD ALIGN=LEFT>&nbsp; $AVGhold_sec_drop_calls &nbsp; </TD>";
		$ingroup_detail .= "</TR>";
		$ingroup_detail .= "<TR>";
		$ingroup_detail .= "<TD ALIGN=RIGHT ></TD><TD ALIGN=LEFT></TD>";
		$ingroup_detail .= "<TD ALIGN=RIGHT><B>"._QXZ("ANSWERS TODAY").":</B></TD><TD ALIGN=LEFT>&nbsp; $answersTODAY&nbsp; &nbsp; </TD>";
		$ingroup_detail .= "<TD ALIGN=RIGHT><B>"._QXZ("DROP PERCENT").":</B></TD><TD ALIGN=LEFT>&nbsp; $drpctTODAY%&nbsp; &nbsp; </TD>";
		$ingroup_detail .= "<TD ALIGN=RIGHT><B>"._QXZ("Average Hold time for All Calls").":</B></TD><TD ALIGN=LEFT>&nbsp; $AVGhold_sec_queue_calls &nbsp; </TD>";
		$ingroup_detail .= "</TR>";
...
if ( ($DROPINGROUPstats > 0) and (!preg_match("/ALL-ACTIVE/",$group_string)) )
	...
	$DROPINGROUPstatsHTML .= "<TD ALIGN=RIGHT COLSPAN=2><B>"._QXZ("DROP IN-GROUP STATS")." -</B></TD>";
	$DROPINGROUPstatsHTML .= "<TD ALIGN=RIGHT><B>"._QXZ("DROP PERCENT").":</B></TD><TD ALIGN=LEFT>&nbsp; $drpctTODAY% &nbsp; &nbsp; </TD>";
	$DROPINGROUPstatsHTML .= "<TD ALIGN=RIGHT><B>"._QXZ("CALLS").":</B></TD><TD ALIGN=LEFT>&nbsp; $callsTODAY &nbsp; &nbsp; </TD>";
	$DROPINGROUPstatsHTML .= "<TD ALIGN=RIGHT><B>"._QXZ("DROPS/ANSWERS").":</B></TD><TD ALIGN=LEFT>&nbsp; $dropsTODAY / $answersTODAY &nbsp; &nbsp; </TD>";
	$DROPINGROUPstatsHTML .= "</TR>";
	}
...
if ($CARRIERstats > 0)
	...
	$CARRIERstatsHTML .= "<TR ><TD ALIGN=left COLSPAN=8>";
	$CARRIERstatsHTML .= "<TABLE CELLPADDING=1 CELLSPACING=1 BORDER=0 >";
	$CARRIERstatsHTML .= "<TR>";
	$CARRIERstatsHTML .= "<TD ALIGN=LEFT><B>"._QXZ("CARRIER STATS").": &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </B></TD>";
	$CARRIERstatsHTML .= "<TD ALIGN=LEFT><B>&nbsp; "._QXZ("HANGUP STATUS")." &nbsp; </B></TD>";
	$CARRIERstatsHTML .= "<TD ALIGN=CENTER><B>&nbsp; "._QXZ("24 HOURS")." &nbsp; </B></TD>";
	$CARRIERstatsHTML .= "<TD ALIGN=CENTER><B>&nbsp; "._QXZ("6 HOURS")." &nbsp; </B></TD>";
	$CARRIERstatsHTML .= "<TD ALIGN=CENTER><B>&nbsp; "._QXZ("1 HOUR")." &nbsp; </B></TD>";
	$CARRIERstatsHTML .= "<TD ALIGN=CENTER><B>&nbsp; "._QXZ("15 MIN")." &nbsp; </B></TD>";
	$CARRIERstatsHTML .= "<TD ALIGN=CENTER><B>&nbsp; "._QXZ("5 MIN")." &nbsp; </B></TD>";
	$CARRIERstatsHTML .= "<TD ALIGN=CENTER><B>&nbsp; "._QXZ("1 MIN")." &nbsp; </B></TD>";
	$CARRIERstatsHTML .= "</TR>";
	...
	if (strlen($dialstatuses) > 1)
		...
		while ($print_ctp < $ctp)
			...
			$CARRIERstatsHTML .= "<TD  ALIGN=LEFT>&nbsp; &nbsp; $TFhour_status[$print_ctp] </TD>";
			$CARRIERstatsHTML .= "<TD  ALIGN=CENTER> $TFhour_count[$print_ctp] </font>&nbsp;<font size=1 color='#990000'>".sprintf("%01.1f", $TFhour_pct)."%</font></TD>";
			$CARRIERstatsHTML .= "<TD  ALIGN=CENTER> $SIXhour_count[$print_ctp] </font>&nbsp;<font size=1 color='#990000'>".sprintf("%01.1f", $SIXhour_pct)."%</font></TD>";
			$CARRIERstatsHTML .= "<TD  ALIGN=CENTER> $ONEhour_count[$print_ctp] </font>&nbsp;<font size=1 color='#990000'>".sprintf("%01.1f", $ONEhour_pct)."%</font></TD>";
			$CARRIERstatsHTML .= "<TD  ALIGN=CENTER> $FTminute_count[$print_ctp] </font>&nbsp;<font size=1 color='#990000'>".sprintf("%01.1f", $TFminute_pct)."%</font></TD>";
			$CARRIERstatsHTML .= "<TD  ALIGN=CENTER> $FIVEminute_count[$print_ctp] </font>&nbsp;<font size=1 color='#990000'>".sprintf("%01.1f", $FIVEminute_pct)."%</font></TD>";
			$CARRIERstatsHTML .= "<TD  ALIGN=CENTER> $ONEminute_count[$print_ctp] </font>&nbsp;<font size=1 color='#990000'>".sprintf("%01.1f", $ONEminute_pct)."%</font></TD>";
			$CARRIERstatsHTML .= "</TR>";
			$print_ctp++;
			}
		$CARRIERstatsHTML .= "<TR>";
		$CARRIERstatsHTML .= "<TD >&nbsp;</TD>";
		$CARRIERstatsHTML .= "<TD  ALIGN=LEFT><B>&nbsp; &nbsp; "._QXZ("TOTALS")."</B></TD>";
		$CARRIERstatsHTML .= "<TD  ALIGN=CENTER><B> ".($TFhour_total+0)."</B> </TD>";
		$CARRIERstatsHTML .= "<TD  ALIGN=CENTER><B> ".($SIXhour_total+0)."</B> </TD>";
		$CARRIERstatsHTML .= "<TD  ALIGN=CENTER><B> ".($ONEhour_total+0)."</B> </TD>";
		$CARRIERstatsHTML .= "<TD  ALIGN=CENTER><B> ".($FTminute_total+0)."</B> </TD>";
		$CARRIERstatsHTML .= "<TD  ALIGN=CENTER><B> ".($FIVEminute_total+0)."</B> </TD>";
		$CARRIERstatsHTML .= "<TD  ALIGN=CENTER><B> ".($ONEminute_total+0)."</B> </TD>";
		$CARRIERstatsHTML .= "</TR>";

		}
	else
		{
		$CARRIERstatsHTML .= "<TR><TD  colspan=7>"._QXZ("no log entries")."</TD></TR>";
		}
...
if ($PRESETstats > 0)
	{
	$PRESETstatsHTML .= "<TR ><TD ALIGN=left COLSPAN=8>";
	$PRESETstatsHTML .= "<TABLE CELLPADDING=1 CELLSPACING=1 BORDER=0 >";
	$PRESETstatsHTML .= "<TR >";
	$PRESETstatsHTML .= "<TD ALIGN=LEFT><B> &nbsp; "._QXZ("AGENT DIAL PRESETS").": &nbsp; </B></TD>";
	$PRESETstatsHTML .= "<TD ALIGN=LEFT><B> &nbsp; "._QXZ("PRESET NAMES")." &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </B></TD>";
	$PRESETstatsHTML .= "<TD ALIGN=LEFT><B> &nbsp; "._QXZ("CALLS")." &nbsp; </B></TD>";
	$PRESETstatsHTML .= "</TR>";
	...
	while ($pre_to_print > $ctp)
		...
		$PRESETstatsHTML .= "<TD ALIGN=LEFT ><B> &nbsp; $row[0] &nbsp; </B></TD>";
		$PRESETstatsHTML .= "<TD ALIGN=RIGHT > &nbsp; $row[1] &nbsp; </TD>";
		$PRESETstatsHTML .= "</TR>";
		$ctp++;
		}
	if ($ctp < 1)
		{
		$PRESETstatsHTML .= "<TR><TD  colspan=2>"._QXZ("no log entries")."</TD></TR>";
		}
...
if (preg_match('/O/',$with_inbound))
	...
	echo "<TD ALIGN=RIGHT><B>"._QXZ("CALLS TODAY").":</B></TD><TD ALIGN=LEFT>&nbsp; $callsTODAY&nbsp; &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("TMA")." 1:</B></TD><TD ALIGN=LEFT>&nbsp; $PCThold_sec_stat_one% &nbsp; &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("Average Hold time for Answered Calls").":</B></TD><TD ALIGN=LEFT>&nbsp; $AVGhold_sec_answer_calls &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT><B> "._QXZ("TIME").":</B> &nbsp; </TD><TD ALIGN=LEFT> $NOW_TIME </TD>";
	echo "";
	echo "</TR>";
	echo "<TR>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("DROPS TODAY").":</B></TD><TD ALIGN=LEFT>&nbsp; $dropsTODAY&nbsp; &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("TMA")." 2:</B></TD><TD ALIGN=LEFT>&nbsp; $PCThold_sec_stat_two% &nbsp; &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("Average Hold time for Dropped Calls").":</B></TD><TD ALIGN=LEFT>&nbsp; $AVGhold_sec_drop_calls &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT> </TD><TD ALIGN=LEFT> </TD>";
	echo "";
	echo "</TR>";
	echo "<TR>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("ANSWERS TODAY").":</B></TD><TD ALIGN=LEFT>&nbsp; $answersTODAY&nbsp; &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT COLSPAN=2><B>("._QXZ("Agent non-pause time / Answers").")</B></TD>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("Average Hold time for All Calls").":</B></TD><TD ALIGN=LEFT>&nbsp; $AVGhold_sec_queue_calls &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT> </TD><TD ALIGN=LEFT> </TD>";
	echo "";
	echo "</TR>";
	echo "<TR>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("DROP PERCENT").":</B></TD><TD ALIGN=LEFT>&nbsp; $drpctTODAY%&nbsp; &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT><B>"._QXZ("PRODUCTIVITY").":</B></TD><TD ALIGN=LEFT>&nbsp; $AVG_ANSWERagent_non_pause_sec &nbsp; &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT></TD><TD ALIGN=LEFT></TD>";
	echo "<TD ALIGN=RIGHT></TD><TD ALIGN=LEFT></TD>";
	echo "";
	echo "</TR>";
...
//	echo "<div class='table_name' >"._QXZ("Hopper")." :<TD class='table_data'>&nbsp;&nbsp; $HOPlev / $AHOPlev &nbsp; &nbsp; </div>";
	...
	/*if ($adastats>1)
		...
		echo "<TR >";
		echo "<TD ALIGN=RIGHT>$min_link&nbsp; <B>"._QXZ("MAX LEVEL").":</B></TD><TD ALIGN=LEFT>&nbsp; $maxDIALlev &nbsp; </TD>";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("DROPPED MAX").":</B></TD><TD ALIGN=LEFT>&nbsp; $DROPmax% &nbsp; &nbsp;</TD>";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("TARGET DIFF").":</B></TD><TD ALIGN=LEFT>&nbsp; $targetDIFF &nbsp; &nbsp; </TD>";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("INTENSITY").":</B></TD><TD ALIGN=LEFT>&nbsp; $ADAintense &nbsp; &nbsp; </TD>";
		echo "</TR>";

		echo "<TR BGCOLOR=\"#CCCCCC\">";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("DIAL TIMEOUT").":</B></TD><TD ALIGN=LEFT>&nbsp; $DIALtimeout &nbsp;</TD>";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("TAPER TIME").":</B></TD><TD ALIGN=LEFT>&nbsp; $TAPERtime &nbsp;</TD>";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("LOCAL TIME").":</B></TD><TD ALIGN=LEFT>&nbsp; $CALLtime &nbsp;</TD>";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("AVAIL ONLY").":</B></TD><TD ALIGN=LEFT>&nbsp; $ADAavailonly &nbsp;</TD>";
		echo "</TR>";
		}*/
	...
	if ($AGENTtimeSTATS>0)
		...
		echo "<TR>";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("AGENT AVG WAIT").":</B></TD><TD ALIGN=LEFT>&nbsp; $avgwaitTODAY &nbsp;</TD>";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("AVG CUSTTIME").":</B></TD><TD ALIGN=LEFT>&nbsp; $avgcustTODAY &nbsp;</TD>";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("AVG ACW").":</B></TD><TD ALIGN=LEFT>&nbsp; $avgacwTODAY &nbsp;</TD>";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("AVG PAUSE").":</B></TD><TD ALIGN=LEFT>&nbsp; $avgpauseTODAY &nbsp;</TD>";
		echo "</TR>";
		}
...
echo "</TD></TR>";
echo "<TR>";
echo "<TD class='' ALIGN=LEFT COLSPAN=8>";
...
if ($parked_to_print > 0)
	...
	#		}
		...
		if ($out_live > 0) {$F='<FONT class="r1"><B>'; $FG='</B></FONT>';}
		if ($out_live > 4) {$F='<FONT class="r2"><B>'; $FG='</B></FONT>';}
		if ($out_live > 9) {$F='<FONT class="r3"><B>'; $FG='</B></FONT>';}
		if ($out_live > 14) {$F='<FONT class="r4"><B>'; $FG='</B></FONT>';}

	/*	if ($campaign_allow_inbound > 0)
		    {echo "$NFB$out_total$NFE "._QXZ("current active calls")."&nbsp; &nbsp; &nbsp; \n";}
		
		   // {echo "<div class='agent_detail_1'><div class='agent_detail_1_data'>$NFB$out_total$NFE</div><div class='agent_detail_1_text'>current active calls</div></div>";}
		else
		   // {echo "<div class='agent_detail_1'><div class='agent_detail_1_data'>$NFB$out_total$NFE</div><div class='agent_detail_1_text'>calls being placed</div></div>";}
		    {echo "$NFB$out_total$NFE "._QXZ("calls being placed")." &nbsp; &nbsp; &nbsp; \n";}
		
		//echo "<div class='agent_detail_1'><div class='agent_detail_1_data'>$NFB$out_ring$NFE</div><div class='agent_detail_1_text'>calls ringing</div></div>";
		    echo "$NFB$out_ring$NFE "._QXZ("calls ringing")." &nbsp; &nbsp; &nbsp; &nbsp; \n";
		//echo "<div class='agent_detail_1'><div class='agent_detail_1_data'>$NFB$F &nbsp;$out_live $FG$NFE</div><div class='agent_detail_1_text'>calls waiting for agents</div></div>";
	     echo "$NFB$F &nbsp;$out_live $FG$NFE "._QXZ("calls waiting for agents")." &nbsp; &nbsp; &nbsp; \n";
		//echo "<div class='agent_detail_1'><div class='agent_detail_1_data'>$NFB &nbsp;$in_ivr$NFE</div><div class='agent_detail_1_text'>calls in IVR</div></div>";
	...
	{
		/*echo "<TR>";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("HOPPER")." <font size=1>( "._QXZ("min/auto")." )</font>:</B></TD><TD ALIGN=LEFT>&nbsp; $HOPlev / $AHOPlev &nbsp; &nbsp; </TD>";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("DROPPED")." / $answers_text:</B></TD><TD ALIGN=LEFT>&nbsp; $dropsTODAY / $answersTODAY &nbsp; </TD>";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("DL DIFF").":</B></TD><TD ALIGN=LEFT>&nbsp; $diffONEMIN &nbsp; &nbsp; </TD>";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("STATUSES").":</B></TD><TD ALIGN=LEFT>&nbsp; $DIALstatuses &nbsp; &nbsp; </TD>";
		echo "</TR>";
	
		echo "<TR>";
		if( 1 == count(explode(',' , $group_SQL)))
			{ 
			echo "<TD ALIGN=RIGHT><B><a href=\"./AST_VICIDIAL_hopperlist.php?group=".str_replace("'","",$group_SQL)."\">"._QXZ("LEADS IN HOPPER")."</a>:</B></TD><TD ALIGN=LEFT>&nbsp; $VDhop &nbsp; &nbsp; </TD>";
			}
		else 
			{
			echo "<TD ALIGN=RIGHT><B>"._QXZ("LEADS IN HOPPER").":</B></TD><TD ALIGN=LEFT>&nbsp; $VDhop &nbsp; &nbsp; </TD>";
			}
		echo "<TD ALIGN=RIGHT><B>"._QXZ("DROPPED PERCENT").":</B></TD><TD ALIGN=LEFT>&nbsp; ";
		...
		echo "<TD ALIGN=RIGHT><B>"._QXZ("DIFF").":</B></TD><TD ALIGN=LEFT>&nbsp; $diffpctONEMIN% &nbsp; &nbsp; </TD>";
		echo "<TD ALIGN=RIGHT><B>"._QXZ("ORDER").":</B></TD><TD ALIGN=LEFT>&nbsp; $DIALorder &nbsp; &nbsp; </TD>";
		echo "</TR>";*/
...
$Aecho = '';
/*$Aecho .= "Protalk: "._QXZ("Agents Time On Calls Campaign").": $group_string            $NOW_TIME\n";*/


$HDbegin =			"+";
$HTbegin =			"";
$HDstation =		"----------------+";
$HTstation =		" "._QXZ("STATION")."";
$HDphone =		"-------------+";
...
if ($RTajax > 0)
	{$HTphone =		" <a href=\"#\" onclick=\"update_variables('orderby','phone');\">"._QXZ("PHONE")."</a>";}
$HDuser =			"------------------------+";
...
if ($RTajax > 0)
	{$HTuser =	" <a style='font-size:14px;color:white;' href=\"#\" onclick=\"update_variables('orderby','user');\">"._QXZ("USER")."</a> ";}
if ($UidORname>0)
	{
	if ($RTajax > 0)
		{$HTuser .=	"<a style='font-size:14px;color:white;' href=\"#\" onclick=\"update_variables('UidORname','');\">"._QXZ("&nbsp;SHOW ID")."</a> ";}
	else
		{
		$HTuser .= "<a style='font-size:14px;color:white;' href=\"$PHP_SELF?$usergroupQS$groupQS&RR=$RR&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=0&orderby=$orderby&SERVdisplay=$SERVdisplay&CALLSdisplay=$CALLSdisplay&PHONEdisplay=$PHONEdisplay&CUSTPHONEdisplay=$CUSTPHONEdisplay&with_inbound=$with_inbound&monitor_active=$monitor_active&monitor_phone=$monitor_phone&ALLINGROUPstats=$ALLINGROUPstats&DROPINGROUPstats=$DROPINGROUPstats&NOLEADSalert=$NOLEADSalert&CARRIERstats=$CARRIERstats&PRESETstats=$PRESETstats&AGENTtimeSTATS=$AGENTtimeSTATS&INGROUPcolorOVERRIDE=$INGROUPcolorOVERRIDE&droppedOFtotal=$droppedOFtotal\">"._QXZ("&nbsp;SHOW ID")."</a> ";
		}
	}
else
	{
	if (isset($RTajax) and $RTajax > 0)
		{$HTuser .=	"<a style='font-size:14px;color:white;' href=\"#\" onclick=\"update_variables('UidORname','');\">"._QXZ("SHOW NAME")."</a>";}
	else
		{
		$HTuser .= "<a style='font-size:14px;color:white;' href=\"$PHP_SELF?$usergroupQS$groupQS&RR=$RR&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=1&orderby=$orderby&SERVdisplay=$SERVdisplay&CALLSdisplay=$CALLSdisplay&PHONEdisplay=$PHONEdisplay&CUSTPHONEdisplay=$CUSTPHONEdisplay&with_inbound=$with_inbound&monitor_active=$monitor_active&monitor_phone=$monitor_phone&ALLINGROUPstats=$ALLINGROUPstats&DROPINGROUPstats=$DROPINGROUPstats&NOLEADSalert=$NOLEADSalert&CARRIERstats=$CARRIERstats&PRESETstats=$PRESETstats&AGENTtimeSTATS=$AGENTtimeSTATS&INGROUPcolorOVERRIDE=$INGROUPcolorOVERRIDE&droppedOFtotal=$droppedOFtotal\">"._QXZ("SHOW NAME")."</a>";
		}
	}
...
if ($RTajax > 0)
	{$HTusergroup =	" <a href=\"#\" onclick=\"update_variables('orderby','group');\">"._QXZ("USER GROUP")."</a>";}
$HDsessionid =		"------------------+";
$HTsessionid =		" "._QXZ("SESSIONID")."";
$HDbarge =			"-------+";
$HTbarge =			" "._QXZ("BARGE")."";
$HDstatus =			"----------+";
$HTstatus =			" "._QXZ("STATUS")."";
$HDcustphone =		"-------------+";
$HTcustphone =		" "._QXZ("CUST PHONE")."";
$HDserver_ip =		"-----------------+";
$HTserver_ip =		" "._QXZ("SERVER IP")."";
$HDcall_server_ip =	"-----------------+";
$HTcall_server_ip =	" "._QXZ("CALL SERVER IP")."";
$HDtime =			"---------+";
...
if ($RTajax > 0)
	{$HTtime =	" <a style='font-size:14px;color:white;' href=\"#\" onclick=\"update_variables('orderby','time');\">"._QXZ("MM:SS")."</a>";}
$HDcampaign =		"------------+";
$HTcampaign =		" <a  style='font-size:14px;color:white;' href=\"$PHP_SELF?$usergroupQS$groupQS&RR=$RR&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=$UidORname&orderby=$campaignord&SERVdisplay=$SERVdisplay&CALLSdisplay=$CALLSdisplay&PHONEdisplay=$PHONEdisplay&CUSTPHONEdisplay=$CUSTPHONEdisplay&with_inbound=$with_inbound&monitor_active=$monitor_active&monitor_phone=$monitor_phone&ALLINGROUPstats=$ALLINGROUPstats&DROPINGROUPstats=$DROPINGROUPstats&NOLEADSalert=$NOLEADSalert&CARRIERstats=$CARRIERstats&PRESETstats=$PRESETstats&AGENTtimeSTATS=$AGENTtimeSTATS&INGROUPcolorOVERRIDE=$INGROUPcolorOVERRIDE&droppedOFtotal=$droppedOFtotal\">"._QXZ("CAMPAIGN")."</a>";
if ($RTajax > 0)
	{$HTcampaign =	" <a  style='font-size:14px;color:white;' href=\"#\" onclick=\"update_variables('orderby','campaign');\">"._QXZ("CAMPAIGN")."</a>";}
$HDcalls =			"-------+";
$HTcalls =			" "._QXZ("CALLS")."";
$HDpause =	'';
$HTpause =	'';
$HDigcall =			"------+------------------";
$HTigcall =			""._QXZ("HOLD").""._QXZ("IN-GROUP")."";
...
if ($realtime_block_user_info > 0)
    ...
    <div class='head-data'>PAUSE</div>
    <div class='head-data'>MM:SS</div>
	<div class='head-data'>CAMPAIGN</div>
	<div class='head-data-speaker'>MONITOR</div>
...
### Run through the loop to display agents
	...
	while ($j < $talking_to_print)
		...
		if ( ($Lstatus=='INCALL') or ($Lstatus=='PARK') )
			{
			if ($call_time_S <= 9) {$G='<SPAN><B>'; $EG='</B></SPAN>';}
			if ($call_time_S >= 10) {$G='<SPAN><B>'; $EG='</B></SPAN>';}
			if ($call_time_S >= 60) {$G='<SPAN><B>'; $EG='</B></SPAN>';}
			if ($call_time_S >= 300) {$G='<SPAN><B>'; $EG='</B></SPAN>';}
		#	if ($call_time_S >= 600) {$G='<SPAN  ><B>'; $EG='</B></SPAN>';}
			}
		if ($Lstatus=='3-WAY')
			{
			if ($call_time_S <= 9) {$G='<SPAN><B>'; $EG='</B></SPAN>';}
		...
		if ($Lstatus=='PAUSED') 
			...
			if ($agent_pause_codes_active > 0)
				...
				$pausecode = "<SPAN><B>$pausecode</B></SPAN>";
				}
			else
				{$pausecode='';}
...
#				{$G='<SPAN class="orange"><B>'; $EG='</B></SPAN>';}
		...
		if ( (preg_match("/READY/i",$status)) or (preg_match("/CLOSER/i",$status)) or (preg_match("/QUEUE/i",$status))) 
			{
			$G='<SPAN ><B>'; $EG='</B></SPAN>';
			if ($call_time_S <= 59) {$G='<SPAN ><B>'; $EG='</B></SPAN>';}
			if ($call_time_S >= 60) {$G='<SPAN ><B>'; $EG='</B></SPAN>';}
			if ($call_time_S >= 300) {$G='<SPAN ><B>'; $EG='</B></SPAN>';}
			}
		...
		if ($Astatus[$i] == 'RING')
			...
			$agent_total++;
			$G=''; $EG='';
			if ($call_time_S >= 0) {$G='<SPAN><B>'; $EG='</B></SPAN>';}
			}
		...
		if ($SIPmonitorLINK>1) {$W="|<a href=\"sip:47378218$Lsessionid@$server_ip\">WHISPER</a>";}
		if ($IAXmonitorLINK>1) {$W="|<a href=\"iax:47378218$Lsessionid@$server_ip\">WHISPER</a>";} 
		if ( (strlen($monitor_phone)>1 ) )
		   {$W="|<a href=\"javascript:send_monitor('$Lsessionid','$Lserver_ip','WHISPER');\">WHISPER</a>";}
	...
	/*	$Aecho .= "  <SPAN class=\"orange\"><B>          </SPAN> - "._QXZ("Balanced call")."</B>\n";
		$Aecho .= "  <SPAN class=\"lightblue\"><B>          </SPAN> - "._QXZ("Agents waiting for call")."</B>\n";
		...
		if ($ring_agents > 0)
			{
			$Aecho .= "  <SPAN><B>- "._QXZ("Agent phone ringing")."</B> </SPAN>\n";
			$Aecho .= "  <SPAN><B>* "._QXZ("Denotes on-hook agent")."</B></SPAN>\n";
			}

		if ($agent_ready > 0) {$B='<SPAN ><B>'; $BG='</B></SPAN>';}
		if ($agent_ready > 4) {$B='<SPAN ><B>'; $BG='</B></SPAN>';}
		if ($agent_ready > 9) {$B='<SPAN ><B>'; $BG='</B></SPAN>';}
		if ($agent_ready > 14) {$B='<SPAN ><B>'; $BG='</B></SPAN>';}
		...
		echo "$NFB$agent_incall$NFE ";
		echo "</div>";
		echo "<div class='agent_detail_2_text'>";
		echo "Agents In Calls";
		echo "</div>";
		echo "</div>";
		...
		echo "<div class='agent_detail_6'>";
		echo "<div class='agent_detail_6_data'>";
		echo "$NFB$agent_dispo$NFE";
		echo "</div>";
        echo "<div class='agent_detail_6_text'>";
		echo "Agents In Dispo";
		echo "</div>";
		echo "</div>";
	...
	/*	echo "<div class='agent_detail_5'>";
		...
		echo "<div class='agent-list' style='width:78%;padding-right:55px'>";
		echo "$Aecho";
		echo "</div>";
    	//echo "$Cecho";
		if($agent_total>0){
			echo "<div class='agent-list-chart'   style='width:20%;height:250px; margin-left:10px; background-color:#E4F2E7' onmouseover='chart_report()'><canvas style='height:250px;width:250px' id='myChart' ></canvas></div>";   
	    }
		echo "</div>";
...
$_SESSION["Agents_Logged_In"] = $agent_total;
$_SESSION["Agents_In_Calls"] = $agent_incall;
$_SESSION["Agents_waiting"] = $agent_ready;
$_SESSION["Paused_Agents"] = $agent_paused;
$_SESSION["Agents_In_Dead_Calls"] = $agent_dead;
$_SESSION["Agents_In_Dispo"] = $agent_dispo;
